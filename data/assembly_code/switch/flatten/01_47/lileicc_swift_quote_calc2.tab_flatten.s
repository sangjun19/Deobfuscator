	...
	.globl	_TIG_IZ_kStP_argc
	.bss
	.align 4
	.type	_TIG_IZ_kStP_argc, @object
	.size	_TIG_IZ_kStP_argc, 4
_TIG_IZ_kStP_argc:
	.zero	4
...
base:
	.zero	4
	.globl	_TIG_IZ_kStP_argv
	.align 8
	.type	_TIG_IZ_kStP_argv, @object
	.size	_TIG_IZ_kStP_argv, 8
_TIG_IZ_kStP_argv:
	.zero	8
...
quote_calc2_lval:
	...
	.globl	_TIG_IZ_kStP_envp
	.align 8
	.type	_TIG_IZ_kStP_envp, @object
	.size	_TIG_IZ_kStP_envp, 8
_TIG_IZ_kStP_envp:
	.zero	8
	.local	yystack
	.comm	yystack,48,32
...
.L87:
	...
	nop
.L88:
	movq	$0, _TIG_IZ_kStP_envp(%rip)
	nop
.L89:
	movq	$0, _TIG_IZ_kStP_argv(%rip)
	nop
.L90:
	movl	$0, _TIG_IZ_kStP_argc(%rip)
	nop
	nop
.L91:
.L92:
#APP
# 970 "quote_calc2.y" 1
	##_ANNOTATION_INITIALREGION_-TIG-IZ-kStP--0
# 0 "" 2
#NO_APP
	movl	-20(%rbp), %eax
	movl	%eax, _TIG_IZ_kStP_argc(%rip)
	movq	-32(%rbp), %rax
	movq	%rax, _TIG_IZ_kStP_argv(%rip)
	movq	-40(%rbp), %rax
	movq	%rax, _TIG_IZ_kStP_envp(%rip)
	nop
	movq	$5, -8(%rbp)
.L104:
	cmpq	$5, -8(%rbp)
