	.file	"kwanghoon_c11parser_calculator_flatten.c"
	.text
	.globl	bufp
	.bss
	.align 4
...
buf:
	.zero	100
	.globl	_TIG_IZ_CCbm_envp
	.align 8
	.type	_TIG_IZ_CCbm_envp, @object
	.size	_TIG_IZ_CCbm_envp, 8
_TIG_IZ_CCbm_envp:
	.zero	8
	.globl	sp
	.align 4
...
sp:
	.zero	4
	.globl	_TIG_IZ_CCbm_argc
	.align 4
	.type	_TIG_IZ_CCbm_argc, @object
	.size	_TIG_IZ_CCbm_argc, 4
_TIG_IZ_CCbm_argc:
	.zero	4
	.globl	_TIG_IZ_CCbm_argv
	.align 8
	.type	_TIG_IZ_CCbm_argv, @object
	.size	_TIG_IZ_CCbm_argv, 8
_TIG_IZ_CCbm_argv:
	.zero	8
	.section	.rodata
	.align 8
...
.L103:
	...
	nop
.L104:
	movq	$0, _TIG_IZ_CCbm_envp(%rip)
	nop
.L105:
	movq	$0, _TIG_IZ_CCbm_argv(%rip)
	nop
.L106:
	movl	$0, _TIG_IZ_CCbm_argc(%rip)
	nop
	nop
.L107:
.L108:
#APP
# 305 "kwanghoon_c11parser_calculator.c" 1
	##_ANNOTATION_INITIALREGION_-TIG-IZ-CCbm--0
# 0 "" 2
#NO_APP
	movl	-212(%rbp), %eax
	movl	%eax, _TIG_IZ_CCbm_argc(%rip)
	movq	-224(%rbp), %rax
	movq	%rax, _TIG_IZ_CCbm_argv(%rip)
	movq	-232(%rbp), %rax
	movq	%rax, _TIG_IZ_CCbm_envp(%rip)
	nop
	movq	$29, -192(%rbp)
.L150:
	cmpq	$33, -192(%rbp)
