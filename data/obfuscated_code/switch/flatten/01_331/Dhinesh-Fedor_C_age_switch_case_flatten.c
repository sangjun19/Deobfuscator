    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_WHp1_envp": "FUN: '_TIG_IZ_WHp1_envp__INIT'",
          "_TIG_IZ_WHp1_argv": "FUN: '_TIG_IZ_WHp1_argv__INIT'",
          "_TIG_IZ_WHp1_argc": "FUN: '_TIG_IZ_WHp1_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_WHp1_argv LOC=UNKNOWN */
char **_TIG_IZ_WHp1_argv  ;
/* END VARIABLE-DEF _TIG_IZ_WHp1_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_WHp1_envp LOC=UNKNOWN */
char **_TIG_IZ_WHp1_envp  ;
/* END VARIABLE-DEF _TIG_IZ_WHp1_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_WHp1_argc LOC=UNKNOWN */
int _TIG_IZ_WHp1_argc ;
/* END VARIABLE-DECL _TIG_IZ_WHp1_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_WHp1_argc LOC=UNKNOWN */
int _TIG_IZ_WHp1_argc  ;
/* END VARIABLE-DEF _TIG_IZ_WHp1_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_WHp1_envp LOC=UNKNOWN */
char **_TIG_IZ_WHp1_envp ;
/* END VARIABLE-DECL _TIG_IZ_WHp1_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_WHp1_argv LOC=UNKNOWN */
char **_TIG_IZ_WHp1_argv ;
/* END VARIABLE-DECL _TIG_IZ_WHp1_argv LOC=UNKNOWN */
...
int main(int _TIG_IZ_WHp1_formal_argc , char **_TIG_IZ_WHp1_formal_argv , char **_TIG_IZ_WHp1_formal_envp ) ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_WHp1_1___uint32_identity_next ;

  {
  {
  _TIG_FN_WHp1_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_WHp1_1___bswap_64_next ;

  {
  {
  _TIG_FN_WHp1_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_WHp1_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_WHp1_1___bswap_32_next ;

  {
  {
  _TIG_FN_WHp1_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___bswap_32_next) {
    case 1UL: ;
...
#line 52
    ...
    {
    _TIG_FN_WHp1_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_WHp1_1___uint16_identity_next ;

  {
  {
  _TIG_FN_WHp1_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_WHp1_1___bswap_16_next ;

  {
  {
  _TIG_FN_WHp1_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___bswap_16_next) {
    case 1UL: ;
...
#line 37
    ...
    {
    _TIG_FN_WHp1_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_WHp1_1___uint64_identity_next ;

  {
  {
  _TIG_FN_WHp1_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int age ;
  int marks ;
  unsigned long _TIG_FN_WHp1_1_main_next ;
  ...
  {
  {
  _TIG_IZ_WHp1_envp = (char **)0;
  goto _TIG_IZ_WHp1_envp__INITINLINE__TIG_IZ_WHp1_envp__INIT;
  }
  _TIG_IZ_WHp1_envp__INITINLINE__TIG_IZ_WHp1_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_WHp1_argv = (char **)0;
  goto _TIG_IZ_WHp1_argv__INITINLINE__TIG_IZ_WHp1_argv__INIT;
  }
  _TIG_IZ_WHp1_argv__INITINLINE__TIG_IZ_WHp1_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_WHp1_argc = 0;
  goto _TIG_IZ_WHp1_argc__INITINLINE__TIG_IZ_WHp1_argc__INIT;
  }
  _TIG_IZ_WHp1_argc__INITINLINE__TIG_IZ_WHp1_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-WHp1--0":);
    _TIG_IZ_WHp1_argc = _TIG_IZ_WHp1_formal_argc;
    _TIG_IZ_WHp1_argv = _TIG_IZ_WHp1_formal_argv;
    _TIG_IZ_WHp1_envp = _TIG_IZ_WHp1_formal_envp;
    break;
  }
  {
  _TIG_FN_WHp1_1_main_next = 9UL;
  }
  while (1) {
    switch (_TIG_FN_WHp1_1_main_next) {
    case 4UL: ;
    switch (age) {
    case 23: 
    {
    _TIG_FN_WHp1_1_main_next = 11UL;
    }
    break;
    case 13: 
    {
    _TIG_FN_WHp1_1_main_next = 7UL;
    }
    break;
    case 3: 
    {
    _TIG_FN_WHp1_1_main_next = 13UL;
    }
    break;
    default: 
    {
    _TIG_FN_WHp1_1_main_next = 0UL;
    }
    break;
    }
    break;
    ...
    case 45: 
    {
    _TIG_FN_WHp1_1_main_next = 2UL;
    }
    break;
    default: 
    {
    _TIG_FN_WHp1_1_main_next = 10UL;
    }
    break;
    }
    break;
...
#line 33
    ...
    {
    _TIG_FN_WHp1_1_main_next = 1UL;
    }
    break;
    case 9UL: ;
    {
    _TIG_FN_WHp1_1_main_next = 8UL;
    }
    break;
    case 13UL: 
#line 16
