    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_LlLn_envp": "FUN: '_TIG_IZ_LlLn_envp__INIT'",
          "_TIG_IZ_LlLn_argv": "FUN: '_TIG_IZ_LlLn_argv__INIT'",
          "_TIG_IZ_LlLn_argc": "FUN: '_TIG_IZ_LlLn_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_LlLn_argv LOC=UNKNOWN */
char **_TIG_IZ_LlLn_argv ;
/* END VARIABLE-DECL _TIG_IZ_LlLn_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_LlLn_argc LOC=UNKNOWN */
int _TIG_IZ_LlLn_argc ;
/* END VARIABLE-DECL _TIG_IZ_LlLn_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_LlLn_envp LOC=UNKNOWN */
char **_TIG_IZ_LlLn_envp ;
/* END VARIABLE-DECL _TIG_IZ_LlLn_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_LlLn_argv LOC=UNKNOWN */
char **_TIG_IZ_LlLn_argv  ;
/* END VARIABLE-DEF _TIG_IZ_LlLn_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_LlLn_envp LOC=UNKNOWN */
char **_TIG_IZ_LlLn_envp  ;
/* END VARIABLE-DEF _TIG_IZ_LlLn_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_LlLn_argc LOC=UNKNOWN */
int _TIG_IZ_LlLn_argc  ;
/* END VARIABLE-DEF _TIG_IZ_LlLn_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_LlLn_formal_argc , char **_TIG_IZ_LlLn_formal_argv , char **_TIG_IZ_LlLn_formal_envp ) ;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_LlLn_1___uint16_identity_next ;

  {
  {
  _TIG_FN_LlLn_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_LlLn_1___bswap_64_next ;

  {
  {
  _TIG_FN_LlLn_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_LlLn_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_LlLn_1___uint64_identity_next ;

  {
  {
  _TIG_FN_LlLn_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_LlLn_1___uint32_identity_next ;

  {
  {
  _TIG_FN_LlLn_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
void enqueue(int element ) 
{ 
  unsigned long _TIG_FN_LlLn_1_enqueue_next ;

  {
  {
  _TIG_FN_LlLn_1_enqueue_next = 6UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1_enqueue_next) {
    case 8UL: 
#line 16 "harsh-narayan-nishad_practice_6.c"
    front = 0;
#line 17
    rear = 0;
#line 18
    queue[rear] = element;
    {
    _TIG_FN_LlLn_1_enqueue_next = 3UL;
    }
    break;
    case 3UL: ;
    return;
    ...
    if (rear == -1) {
      {
      _TIG_FN_LlLn_1_enqueue_next = 8UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_enqueue_next = 7UL;
      }
    }
    break;
    case 6UL: ;
    if (front == -1) {
      {
      _TIG_FN_LlLn_1_enqueue_next = 9UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_enqueue_next = 7UL;
...
#line 27
    ...
    if ((rear + 1) % 6 == front) {
      {
      _TIG_FN_LlLn_1_enqueue_next = 2UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_enqueue_next = 0UL;
      }
    }
    break;
    case 2UL: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_LlLn_1___bswap_32_next ;

  {
  {
  _TIG_FN_LlLn_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_LlLn_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
int dequeue(void) 
{ 
  unsigned long _TIG_FN_LlLn_1_dequeue_next ;

  {
  {
  _TIG_FN_LlLn_1_dequeue_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1_dequeue_next) {
    case 4UL: 
#line 40 "harsh-narayan-nishad_practice_6.c"
...
#line 42
    rear = -1;
    {
    _TIG_FN_LlLn_1_dequeue_next = 3UL;
    }
    break;
    case 8UL: ;
    if (rear == -1) {
      {
      _TIG_FN_LlLn_1_dequeue_next = 9UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_dequeue_next = 1UL;
      }
    }
    break;
    case 1UL: 
    ...
    if (front == rear) {
      {
      _TIG_FN_LlLn_1_dequeue_next = 4UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_dequeue_next = 0UL;
      }
    }
    break;
    case 3UL: ;
...
#line 47
    ...
    if (front == -1) {
      {
      _TIG_FN_LlLn_1_dequeue_next = 8UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_dequeue_next = 1UL;
...
{ 
  ...
  int choice ;
  int x ;
  unsigned long _TIG_FN_LlLn_1_main_next ;
  ...
  {
  {
  _TIG_IZ_LlLn_envp = (char **)0;
  goto _TIG_IZ_LlLn_envp__INITINLINE__TIG_IZ_LlLn_envp__INIT;
  }
  _TIG_IZ_LlLn_envp__INITINLINE__TIG_IZ_LlLn_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_LlLn_argv = (char **)0;
  goto _TIG_IZ_LlLn_argv__INITINLINE__TIG_IZ_LlLn_argv__INIT;
  }
  _TIG_IZ_LlLn_argv__INITINLINE__TIG_IZ_LlLn_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_LlLn_argc = 0;
  goto _TIG_IZ_LlLn_argc__INITINLINE__TIG_IZ_LlLn_argc__INIT;
  }
  _TIG_IZ_LlLn_argc__INITINLINE__TIG_IZ_LlLn_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-LlLn--0":);
    _TIG_IZ_LlLn_argc = _TIG_IZ_LlLn_formal_argc;
    _TIG_IZ_LlLn_argv = _TIG_IZ_LlLn_formal_argv;
    _TIG_IZ_LlLn_envp = _TIG_IZ_LlLn_formal_envp;
    break;
  }
  {
  _TIG_FN_LlLn_1_main_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1_main_next) {
    case 4UL: 
#line 90
    dequeue();
    {
    _TIG_FN_LlLn_1_main_next = 3UL;
    }
    break;
    case 14UL: ;
    {
...
#line 93
    display();
    {
    _TIG_FN_LlLn_1_main_next = 14UL;
    }
    break;
    case 3UL: ;
    if (choice < 4) {
      {
      _TIG_FN_LlLn_1_main_next = 9UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_main_next = 6UL;
      }
    }
    break;
    case 9UL: ;
...
#line 78
    ...
    case 3: 
    {
    _TIG_FN_LlLn_1_main_next = 1UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_LlLn_1_main_next = 4UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_LlLn_1_main_next = 2UL;
    }
    break;
    default: 
    {
...
{ 
  int i ;
  unsigned long _TIG_FN_LlLn_1_display_next ;

  {
  {
  _TIG_FN_LlLn_1_display_next = 8UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1_display_next) {
    case 4UL: ;
    if (rear == -1) {
      {
      _TIG_FN_LlLn_1_display_next = 7UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_display_next = 5UL;
      }
    }
    break;
    case 8UL: 
#line 53
    i = front;
    {
    _TIG_FN_LlLn_1_display_next = 0UL;
    }
    break;
    case 1UL: ;
    if (i <= rear) {
      {
      _TIG_FN_LlLn_1_display_next = 2UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_display_next = 9UL;
      }
    }
    break;
    case 9UL: ;
...
#line 60
    ...
    {
    _TIG_FN_LlLn_1_display_next = 1UL;
    }
    break;
    case 0UL: ;
    if (front == -1) {
      {
      _TIG_FN_LlLn_1_display_next = 4UL;
      }
    } else {
      {
      _TIG_FN_LlLn_1_display_next = 5UL;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_LlLn_1___bswap_16_next ;

  {
  {
  _TIG_FN_LlLn_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_LlLn_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_LlLn_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
