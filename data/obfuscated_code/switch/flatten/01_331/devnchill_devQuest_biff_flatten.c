    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_T88X_envp": "FUN: '_TIG_IZ_T88X_envp__INIT'",
          "_TIG_IZ_T88X_argv": "FUN: '_TIG_IZ_T88X_argv__INIT'",
          "_TIG_IZ_T88X_argc": "FUN: '_TIG_IZ_T88X_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_T88X_envp LOC=UNKNOWN */
char **_TIG_IZ_T88X_envp ;
/* END VARIABLE-DECL _TIG_IZ_T88X_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_T88X_envp LOC=UNKNOWN */
char **_TIG_IZ_T88X_envp  ;
/* END VARIABLE-DEF _TIG_IZ_T88X_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_T88X_argc LOC=UNKNOWN */
int _TIG_IZ_T88X_argc ;
/* END VARIABLE-DECL _TIG_IZ_T88X_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_T88X_argc LOC=UNKNOWN */
int _TIG_IZ_T88X_argc  ;
/* END VARIABLE-DEF _TIG_IZ_T88X_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_T88X_argv LOC=UNKNOWN */
char **_TIG_IZ_T88X_argv  ;
/* END VARIABLE-DEF _TIG_IZ_T88X_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_T88X_argv LOC=UNKNOWN */
char **_TIG_IZ_T88X_argv ;
/* END VARIABLE-DECL _TIG_IZ_T88X_argv LOC=UNKNOWN */
...
int main(int _TIG_IZ_T88X_formal_argc , char **_TIG_IZ_T88X_formal_argv , char **_TIG_IZ_T88X_formal_envp ) ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_T88X_1___uint64_identity_next ;

  {
  {
  _TIG_FN_T88X_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_T88X_1___uint32_identity_next ;

  {
  {
  _TIG_FN_T88X_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_T88X_1___bswap_64_next ;

  {
  {
  _TIG_FN_T88X_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_T88X_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int tmp___0 ;
  int i___0 ;
  unsigned long _TIG_FN_T88X_1_main_next ;
  ...
  {
  {
  _TIG_IZ_T88X_envp = (char **)0;
  goto _TIG_IZ_T88X_envp__INITINLINE__TIG_IZ_T88X_envp__INIT;
  }
  _TIG_IZ_T88X_envp__INITINLINE__TIG_IZ_T88X_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_T88X_argv = (char **)0;
  goto _TIG_IZ_T88X_argv__INITINLINE__TIG_IZ_T88X_argv__INIT;
  }
  _TIG_IZ_T88X_argv__INITINLINE__TIG_IZ_T88X_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_T88X_argc = 0;
  goto _TIG_IZ_T88X_argc__INITINLINE__TIG_IZ_T88X_argc__INIT;
  }
  _TIG_IZ_T88X_argc__INITINLINE__TIG_IZ_T88X_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-T88X--0":);
    _TIG_IZ_T88X_argc = _TIG_IZ_T88X_formal_argc;
    _TIG_IZ_T88X_argv = _TIG_IZ_T88X_formal_argv;
    _TIG_IZ_T88X_envp = _TIG_IZ_T88X_formal_envp;
    break;
  }
  {
  _TIG_FN_T88X_1_main_next = 13UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1_main_next) {
    case 18UL: 
...
#line 17
    ...
    if (i < 50) {
      {
      _TIG_FN_T88X_1_main_next = 9UL;
      }
    } else {
      {
      _TIG_FN_T88X_1_main_next = 32UL;
      }
    }
    break;
    case 8UL: 
...
#line 11
    ch = (char )tmp;
    {
    _TIG_FN_T88X_1_main_next = 19UL;
    }
    break;
    case 13UL: ;
    {
    _TIG_FN_T88X_1_main_next = 18UL;
    }
    break;
    case 19UL: ;
    if ((int )ch == 10) {
...
#line 48
    ...
    case 83: 
    {
    _TIG_FN_T88X_1_main_next = 23UL;
    }
    break;
    case 41: 
    {
    _TIG_FN_T88X_1_main_next = 25UL;
    }
    break;
    case 73: 
    {
    _TIG_FN_T88X_1_main_next = 8UL;
    }
    break;
    case 69: 
    {
    _TIG_FN_T88X_1_main_next = 14UL;
    }
    break;
    case 66: 
    {
    _TIG_FN_T88X_1_main_next = 29UL;
    }
    break;
    case 65: 
    {
    _TIG_FN_T88X_1_main_next = 15UL;
    }
    break;
    default: 
    {
    _TIG_FN_T88X_1_main_next = 26UL;
    }
    break;
    }
    break;
    ...
    if (i___0 < length) {
      {
      _TIG_FN_T88X_1_main_next = 0UL;
      }
    } else {
      {
      _TIG_FN_T88X_1_main_next = 22UL;
      }
    }
    break;
    case 22UL: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_T88X_1___bswap_16_next ;

  {
  {
  _TIG_FN_T88X_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_T88X_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_T88X_1___uint16_identity_next ;

  {
  {
  _TIG_FN_T88X_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_T88X_1___bswap_32_next ;

  {
  {
  _TIG_FN_T88X_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_T88X_1___bswap_32_next) {
    case 1UL: 
#line 52
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_T88X_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
