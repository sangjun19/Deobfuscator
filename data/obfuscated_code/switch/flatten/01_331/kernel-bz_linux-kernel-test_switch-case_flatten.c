    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_QO4h_envp": "FUN: '_TIG_IZ_QO4h_envp__INIT'",
          "_TIG_IZ_QO4h_argv": "FUN: '_TIG_IZ_QO4h_argv__INIT'",
          "_TIG_IZ_QO4h_argc": "FUN: '_TIG_IZ_QO4h_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_QO4h_argc LOC=UNKNOWN */
int _TIG_IZ_QO4h_argc ;
/* END VARIABLE-DECL _TIG_IZ_QO4h_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_QO4h_argv LOC=UNKNOWN */
char **_TIG_IZ_QO4h_argv  ;
/* END VARIABLE-DEF _TIG_IZ_QO4h_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_QO4h_argv LOC=UNKNOWN */
char **_TIG_IZ_QO4h_argv ;
/* END VARIABLE-DECL _TIG_IZ_QO4h_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_QO4h_envp LOC=UNKNOWN */
char **_TIG_IZ_QO4h_envp  ;
/* END VARIABLE-DEF _TIG_IZ_QO4h_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_QO4h_argc LOC=UNKNOWN */
int _TIG_IZ_QO4h_argc  ;
/* END VARIABLE-DEF _TIG_IZ_QO4h_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_QO4h_formal_argc , char **_TIG_IZ_QO4h_formal_argv , char **_TIG_IZ_QO4h_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_QO4h_envp LOC=UNKNOWN */
char **_TIG_IZ_QO4h_envp ;
/* END VARIABLE-DECL _TIG_IZ_QO4h_envp LOC=UNKNOWN */
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_QO4h_1___uint64_identity_next ;

  {
  {
  _TIG_FN_QO4h_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_QO4h_1___bswap_16_next ;

  {
  {
  _TIG_FN_QO4h_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_QO4h_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_QO4h_1___bswap_64_next ;

  {
  {
  _TIG_FN_QO4h_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___bswap_64_next) {
    case 1UL: 
#line 73
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_QO4h_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static int scase2(int type ) 
{ 
  unsigned long _TIG_FN_QO4h_1_scase2_next ;

  {
  {
  _TIG_FN_QO4h_1_scase2_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1_scase2_next) {
    case 4UL: ;
    {
    _TIG_FN_QO4h_1_scase2_next = 2UL;
    }
    break;
    case 1UL: ;
    switch (type) {
    case 3: 
    {
    _TIG_FN_QO4h_1_scase2_next = 3UL;
    }
    break;
    case 2: 
    case 1: 
    {
    _TIG_FN_QO4h_1_scase2_next = 5UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_QO4h_1_scase2_next = 0UL;
    }
    break;
    default: 
    {
    _TIG_FN_QO4h_1_scase2_next = 4UL;
    }
    break;
    }
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_QO4h_1___uint16_identity_next ;

  {
  {
  _TIG_FN_QO4h_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
static int scase1(int type ) 
{ 
  unsigned long _TIG_FN_QO4h_1_scase1_next ;

  {
  {
  _TIG_FN_QO4h_1_scase1_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1_scase1_next) {
    case 4UL: ;
    return (0);
    break;
    case 1UL: ;
    ...
    case 1: 
    {
    _TIG_FN_QO4h_1_scase1_next = 3UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_QO4h_1_scase1_next = 4UL;
    }
    break;
    default: 
    {
    _TIG_FN_QO4h_1_scase1_next = 1UL;
    }
    break;
    }
    break;
...
{ 
  int ret ;
  unsigned long _TIG_FN_QO4h_1_main_next ;
  ...
  {
  {
  _TIG_IZ_QO4h_envp = (char **)0;
  goto _TIG_IZ_QO4h_envp__INITINLINE__TIG_IZ_QO4h_envp__INIT;
  }
  _TIG_IZ_QO4h_envp__INITINLINE__TIG_IZ_QO4h_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_QO4h_argv = (char **)0;
  goto _TIG_IZ_QO4h_argv__INITINLINE__TIG_IZ_QO4h_argv__INIT;
  }
  _TIG_IZ_QO4h_argv__INITINLINE__TIG_IZ_QO4h_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_QO4h_argc = 0;
  goto _TIG_IZ_QO4h_argc__INITINLINE__TIG_IZ_QO4h_argc__INIT;
  }
  _TIG_IZ_QO4h_argc__INITINLINE__TIG_IZ_QO4h_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-QO4h--0":);
    _TIG_IZ_QO4h_argc = _TIG_IZ_QO4h_formal_argc;
    _TIG_IZ_QO4h_argv = _TIG_IZ_QO4h_formal_argv;
    _TIG_IZ_QO4h_envp = _TIG_IZ_QO4h_formal_envp;
    break;
  }
  {
  _TIG_FN_QO4h_1_main_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1_main_next) {
    case 1UL: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_QO4h_1___uint32_identity_next ;

  {
  {
  _TIG_FN_QO4h_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_QO4h_1___bswap_32_next ;

  {
  {
  _TIG_FN_QO4h_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_QO4h_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_QO4h_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
