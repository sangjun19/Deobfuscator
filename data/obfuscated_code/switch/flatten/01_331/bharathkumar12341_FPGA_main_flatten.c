    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_i3df_envp": "FUN: '_TIG_IZ_i3df_envp__INIT'",
          "_TIG_IZ_i3df_argv": "FUN: '_TIG_IZ_i3df_argv__INIT'",
          "_TIG_IZ_i3df_argc": "FUN: '_TIG_IZ_i3df_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_i3df_argc LOC=UNKNOWN */
int _TIG_IZ_i3df_argc  ;
/* END VARIABLE-DEF _TIG_IZ_i3df_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_i3df_argc LOC=UNKNOWN */
int _TIG_IZ_i3df_argc ;
/* END VARIABLE-DECL _TIG_IZ_i3df_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_i3df_formal_argc , char **_TIG_IZ_i3df_formal_argv , char **_TIG_IZ_i3df_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_i3df_envp LOC=UNKNOWN */
char **_TIG_IZ_i3df_envp ;
/* END VARIABLE-DECL _TIG_IZ_i3df_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_i3df_argv LOC=UNKNOWN */
char **_TIG_IZ_i3df_argv ;
/* END VARIABLE-DECL _TIG_IZ_i3df_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_i3df_argv LOC=UNKNOWN */
char **_TIG_IZ_i3df_argv  ;
/* END VARIABLE-DEF _TIG_IZ_i3df_argv LOC=UNKNOWN */

/* BEGIN VARIABLE-DEF _TIG_IZ_i3df_envp LOC=UNKNOWN */
char **_TIG_IZ_i3df_envp  ;
/* END VARIABLE-DEF _TIG_IZ_i3df_envp LOC=UNKNOWN */
...
{ 
  ...
  unsigned long _TIG_FN_i3df_1_getNextToken_next ;

  {
  {
  _TIG_FN_i3df_1_getNextToken_next = 5UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1_getNextToken_next) {
    case 18UL: 
#line 37 "bharathkumar12341_FPGA_main.c"
    token->type = (TokenType )6;
    {
    _TIG_FN_i3df_1_getNextToken_next = 61UL;
    }
    break;
    case 50UL: 
#line 42
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 13UL;
    }
    break;
    case 25UL: 
#line 48
...
#line 50
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 60UL;
    }
    break;
    case 49UL: 
#line 56
...
#line 56
    token->text[0] = (char )'=';
    {
    _TIG_FN_i3df_1_getNextToken_next = 29UL;
    }
    break;
    case 52UL: ;
    if (len < 99) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 64UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 1UL;
      }
    }
    break;
    case 4UL: ;
    ...
    case 59: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 6UL;
    }
    break;
    case 41: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 68UL;
    }
    break;
    case 40: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 53UL;
    }
    break;
    case 45: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 22UL;
    }
    break;
    case 43: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 66UL;
    }
    break;
    case 61: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 49UL;
    }
    break;
    default: 
    {
    _TIG_FN_i3df_1_getNextToken_next = 37UL;
    }
    break;
    }
    break;
...
#line 38
    ...
    if (tmp___3 == 0) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 18UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 62UL;
      }
    }
    break;
    case 31UL: ;
    if (tmp___4 == 0) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 32UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 65UL;
      }
    }
    break;
    case 8UL: ;
...
#line 45
    c = fgetc(file);
    {
    _TIG_FN_i3df_1_getNextToken_next = 48UL;
    }
    break;
    case 1UL: 
#line 30
...
#line 30
    c = fgetc(file);
    {
    _TIG_FN_i3df_1_getNextToken_next = 26UL;
    }
    break;
    case 23UL: ;
    if ((int const   )*(*tmp___5 + c) & 1024) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 11UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 50UL;
      }
    }
    break;
    case 21UL: 
...
#line 44
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 54UL;
    }
    break;
    case 68UL: 
#line 60
...
#line 60
    ...
    if ((int const   )*(*tmp___2 + c) & 8) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 52UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 33UL;
      }
    }
    break;
    case 11UL: 
...
#line 29
    ...
    if ((int const   )*(*tmp___9 + c) & 2048) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 21UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 30UL;
      }
    }
    break;
    case 19UL: 
...
#line 24
    c = fgetc(file);
    {
    _TIG_FN_i3df_1_getNextToken_next = 38UL;
    }
    break;
    case 60UL: ;
    return;
...
#line 61
    ...
    if ((int const   )*(*tmp + c) & 8192) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 67UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 20UL;
      }
    }
    break;
    case 38UL: ;
    if (c != -1) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 35UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 46UL;
      }
    }
    break;
    case 61UL: ;
    ...
    if ((int const   )*(*tmp___8 + c) & 2048) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 42UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 25UL;
      }
    }
    break;
    case 22UL: 
...
#line 37
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 56UL;
    }
    break;
    case 5UL: ;
    {
...
#line 36
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 31UL;
    }
    break;
    case 37UL: 
#line 62
...
#line 31
    ...
    if (len___0 < 99) {
      {
      _TIG_FN_i3df_1_getNextToken_next = 19UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_getNextToken_next = 54UL;
...
#line 68
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 8UL;
    }
    break;
    case 66UL: 
#line 57
...
#line 25
    tmp = __ctype_b_loc();
    {
    _TIG_FN_i3df_1_getNextToken_next = 27UL;
    }
    break;
    case 29UL: 
#line 64
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 4UL;
    }
    break;
    case 20UL: 
#line 27
    ...
    {
    _TIG_FN_i3df_1_getNextToken_next = 23UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_i3df_1___uint16_identity_next ;

  {
  {
  _TIG_FN_i3df_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_i3df_1___uint32_identity_next ;

  {
  {
  _TIG_FN_i3df_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_i3df_1___bswap_32_next ;

  {
  {
  _TIG_FN_i3df_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_i3df_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_i3df_1___bswap_16_next ;

  {
  {
  _TIG_FN_i3df_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___bswap_16_next) {
    case 1UL: 
#line 37
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_i3df_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  FILE *tmp ;
  Token token ;
  unsigned long _TIG_FN_i3df_1_main_next ;
  ...
  {
  {
  _TIG_IZ_i3df_envp = (char **)0;
  goto _TIG_IZ_i3df_envp__INITINLINE__TIG_IZ_i3df_envp__INIT;
  }
  _TIG_IZ_i3df_envp__INITINLINE__TIG_IZ_i3df_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_i3df_argv = (char **)0;
  goto _TIG_IZ_i3df_argv__INITINLINE__TIG_IZ_i3df_argv__INIT;
  }
  _TIG_IZ_i3df_argv__INITINLINE__TIG_IZ_i3df_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_i3df_argc = 0;
  goto _TIG_IZ_i3df_argc__INITINLINE__TIG_IZ_i3df_argc__INIT;
  }
  _TIG_IZ_i3df_argc__INITINLINE__TIG_IZ_i3df_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-i3df--0":);
    _TIG_IZ_i3df_argc = _TIG_IZ_i3df_formal_argc;
    _TIG_IZ_i3df_argv = _TIG_IZ_i3df_formal_argv;
    _TIG_IZ_i3df_envp = _TIG_IZ_i3df_formal_envp;
    break;
  }
  {
  _TIG_FN_i3df_1_main_next = 11UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1_main_next) {
    case 4UL: ;
    if ((unsigned int )token.type != 11U) {
      {
      _TIG_FN_i3df_1_main_next = 1UL;
      }
    } else {
      {
      _TIG_FN_i3df_1_main_next = 8UL;
      }
    }
    break;
    case 8UL: 
#line 83 "bharathkumar12341_FPGA_main.c"
    fclose(file);
    {
    _TIG_FN_i3df_1_main_next = 0UL;
    }
    break;
    case 1UL: 
#line 80
...
#line 75
    ...
    {
    _TIG_FN_i3df_1_main_next = 9UL;
    }
    break;
    case 11UL: ;
    {
    _TIG_FN_i3df_1_main_next = 2UL;
    }
    break;
    case 9UL: ;
    return (1);
...
{ 
  long tmp ;
  unsigned long _TIG_FN_i3df_1___bswap_64_next ;

  {
  {
  _TIG_FN_i3df_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_i3df_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_i3df_1___uint64_identity_next ;

  {
  {
  _TIG_FN_i3df_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_i3df_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
