    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_yKIw_envp": "FUN: '_TIG_IZ_yKIw_envp__INIT'",
          "_TIG_IZ_yKIw_argv": "FUN: '_TIG_IZ_yKIw_argv__INIT'",
          "_TIG_IZ_yKIw_argc": "FUN: '_TIG_IZ_yKIw_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_yKIw_envp LOC=UNKNOWN */
char **_TIG_IZ_yKIw_envp  ;
/* END VARIABLE-DEF _TIG_IZ_yKIw_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_yKIw_argv LOC=UNKNOWN */
char **_TIG_IZ_yKIw_argv ;
/* END VARIABLE-DECL _TIG_IZ_yKIw_argv LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_yKIw_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_yKIw_argc LOC=UNKNOWN */
int _TIG_IZ_yKIw_argc ;
/* END VARIABLE-DECL _TIG_IZ_yKIw_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_yKIw_argv LOC=UNKNOWN */
char **_TIG_IZ_yKIw_argv  ;
/* END VARIABLE-DEF _TIG_IZ_yKIw_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_yKIw_envp LOC=UNKNOWN */
char **_TIG_IZ_yKIw_envp ;
/* END VARIABLE-DECL _TIG_IZ_yKIw_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_yKIw_argc LOC=UNKNOWN */
int _TIG_IZ_yKIw_argc  ;
/* END VARIABLE-DEF _TIG_IZ_yKIw_argc LOC=UNKNOWN */
...
{ 
  short tmp ;
  unsigned long _TIG_FN_yKIw_1___bswap_16_next ;

  {
  {
  _TIG_FN_yKIw_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_yKIw_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_yKIw_1___bswap_64_next ;

  {
  {
  _TIG_FN_yKIw_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___bswap_64_next) {
    case 1UL: 
#line 73
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_yKIw_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int counter ;
  unsigned long _TIG_FN_yKIw_1_next_f_next ;

  {
  {
  _TIG_FN_yKIw_1_next_f_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1_next_f_next) {
    case 1UL: ;
    {
    _TIG_FN_yKIw_1_next_f_next = 2UL;
    }
    break;
    case 0UL: ;
    ...
    break;
    case 2UL: 
#line 23 "lac-dcc_jotai-benchmarks_extr_linuxsoundcoreseqseq_midi_event.c_reset_encode_Final.c"
    counter = 0;
#line 24
    counter ++;
    {
    _TIG_FN_yKIw_1_next_f_next = 0UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_yKIw_1___bswap_32_next ;

  {
  {
  _TIG_FN_yKIw_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_yKIw_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int counter ;
  unsigned long _TIG_FN_yKIw_1_next_i_next ;

  {
  {
  _TIG_FN_yKIw_1_next_i_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1_next_i_next) {
    case 1UL: ;
    return ((int )rand_primes[counter % 25]);
    break;
    case 0UL: ;
    {
    _TIG_FN_yKIw_1_next_i_next = 2UL;
    }
    break;
    case 2UL: 
...
#line 19
    counter ++;
    {
    _TIG_FN_yKIw_1_next_i_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_yKIw_1___uint64_identity_next ;

  {
  {
  _TIG_FN_yKIw_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  unsigned long _TIG_FN_yKIw_1_reset_encode_next ;

  {
  {
  _TIG_FN_yKIw_1_reset_encode_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1_reset_encode_next) {
    case 1UL: ;
    {
    _TIG_FN_yKIw_1_reset_encode_next = 2UL;
    }
    break;
    case 0UL: ;
    return;
...
#line 65
    dev->type = ST_INVALID;
    {
    _TIG_FN_yKIw_1_reset_encode_next = 0UL;
    }
    break;
    default: 
    break;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_yKIw_1___uint32_identity_next ;

  {
  {
  _TIG_FN_yKIw_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_yKIw_1___uint16_identity_next ;

  {
  {
  _TIG_FN_yKIw_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
void usage(void) 
{ 
  unsigned long _TIG_FN_yKIw_1_usage_next ;

  {
  {
  _TIG_FN_yKIw_1_usage_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1_usage_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
...
{ 
  ...
  int tmp___19 ;
  int tmp___20 ;
  unsigned long _TIG_FN_yKIw_1_main_next ;
  ...
  {
  {
  _TIG_IZ_yKIw_envp = (char **)0;
  goto _TIG_IZ_yKIw_envp__INITINLINE__TIG_IZ_yKIw_envp__INIT;
  }
  _TIG_IZ_yKIw_envp__INITINLINE__TIG_IZ_yKIw_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_yKIw_argv = (char **)0;
  goto _TIG_IZ_yKIw_argv__INITINLINE__TIG_IZ_yKIw_argv__INIT;
  }
  _TIG_IZ_yKIw_argv__INITINLINE__TIG_IZ_yKIw_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_yKIw_argc = 0;
  goto _TIG_IZ_yKIw_argc__INITINLINE__TIG_IZ_yKIw_argc__INIT;
  }
  _TIG_IZ_yKIw_argc__INITINLINE__TIG_IZ_yKIw_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-yKIw--0":);
    _TIG_IZ_yKIw_argc = argc;
    _TIG_IZ_yKIw_argv = argv;
    _TIG_IZ_yKIw_envp = _TIG_IZ_yKIw_formal_envp;
    break;
  }
  {
  _TIG_FN_yKIw_1_main_next = 22UL;
  }
  while (1) {
    switch (_TIG_FN_yKIw_1_main_next) {
    case 30UL: ;
    if (_i0___0 < _len_dev0___0) {
      {
      _TIG_FN_yKIw_1_main_next = 14UL;
      }
    } else {
      {
      _TIG_FN_yKIw_1_main_next = 28UL;
      }
    }
    break;
    case 14UL: 
...
#line 73
    usage();
    {
    _TIG_FN_yKIw_1_main_next = 12UL;
    }
    break;
    case 26UL: ;
    if (_i0___1 < _len_dev0___1) {
      {
      _TIG_FN_yKIw_1_main_next = 15UL;
      }
    } else {
      {
      _TIG_FN_yKIw_1_main_next = 2UL;
      }
    }
    break;
    case 9UL: ;
    ...
    case 2: 
    {
    _TIG_FN_yKIw_1_main_next = 13UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_yKIw_1_main_next = 27UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_yKIw_1_main_next = 20UL;
    }
    break;
    default: 
    {
    _TIG_FN_yKIw_1_main_next = 10UL;
    }
    break;
    }
    break;
...
#line 102
    ...
    if (argc != 2) {
      {
      _TIG_FN_yKIw_1_main_next = 21UL;
      }
    } else {
      {
      _TIG_FN_yKIw_1_main_next = 24UL;
      }
    }
    break;
    case 28UL: 
...
#line 110
    free((void *)dev___0);
    {
    _TIG_FN_yKIw_1_main_next = 16UL;
    }
    break;
    case 33UL: ;
    if (_i0 < _len_dev0) {
      {
      _TIG_FN_yKIw_1_main_next = 1UL;
      }
    } else {
      {
      _TIG_FN_yKIw_1_main_next = 7UL;
      }
    }
    break;
    case 10UL: 
