    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_MtIt_envp": "FUN: '_TIG_IZ_MtIt_envp__INIT'",
          "_TIG_IZ_MtIt_argv": "FUN: '_TIG_IZ_MtIt_argv__INIT'",
          "_TIG_IZ_MtIt_argc": "FUN: '_TIG_IZ_MtIt_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MtIt_envp LOC=UNKNOWN */
char **_TIG_IZ_MtIt_envp ;
/* END VARIABLE-DECL _TIG_IZ_MtIt_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MtIt_argv LOC=UNKNOWN */
char **_TIG_IZ_MtIt_argv ;
/* END VARIABLE-DECL _TIG_IZ_MtIt_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MtIt_argc LOC=UNKNOWN */
int _TIG_IZ_MtIt_argc ;
/* END VARIABLE-DECL _TIG_IZ_MtIt_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MtIt_argv LOC=UNKNOWN */
char **_TIG_IZ_MtIt_argv  ;
/* END VARIABLE-DEF _TIG_IZ_MtIt_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MtIt_argc LOC=UNKNOWN */
int _TIG_IZ_MtIt_argc  ;
/* END VARIABLE-DEF _TIG_IZ_MtIt_argc LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_MtIt_formal_envp ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MtIt_envp LOC=UNKNOWN */
char **_TIG_IZ_MtIt_envp  ;
/* END VARIABLE-DEF _TIG_IZ_MtIt_envp LOC=UNKNOWN */
...
{ 
  long tmp ;
  unsigned long _TIG_FN_MtIt_1___bswap_64_next ;

  {
  {
  _TIG_FN_MtIt_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_MtIt_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  ...
  int res ;
  int control ;
  unsigned long _TIG_FN_MtIt_1_calculator_next ;

  {
  {
  _TIG_FN_MtIt_1_calculator_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1_calculator_next) {
    case 18UL: 
#line 40 "marcotessarotto_exOpSys_003.3calc-iter.c"
    printf((char const   */* __restrict  */)"%c %d %d => %d\n", (int )op, n1, n2,
           res);
    {
    _TIG_FN_MtIt_1_calculator_next = 19UL;
    }
    break;
    case 4UL: ;
    {
    _TIG_FN_MtIt_1_calculator_next = 5UL;
    }
    break;
    case 14UL: 
#line 46
    ...
    {
    _TIG_FN_MtIt_1_calculator_next = 2UL;
    }
    break;
    case 15UL: 
#line 23
    res = n1 + n2;
    {
    _TIG_FN_MtIt_1_calculator_next = 18UL;
    }
    break;
    case 12UL: ;
    switch ((int )op) {
    case 47: 
    {
    _TIG_FN_MtIt_1_calculator_next = 11UL;
    }
    break;
    case 42: 
    {
    _TIG_FN_MtIt_1_calculator_next = 10UL;
    }
    break;
    case 45: 
    {
    _TIG_FN_MtIt_1_calculator_next = 3UL;
    }
    break;
    case 43: 
    {
    _TIG_FN_MtIt_1_calculator_next = 15UL;
    }
    break;
    default: 
    {
    _TIG_FN_MtIt_1_calculator_next = 6UL;
    }
    break;
    }
    break;
    ...
    if (control == -1) {
      {
      _TIG_FN_MtIt_1_calculator_next = 14UL;
      }
    } else {
      {
      _TIG_FN_MtIt_1_calculator_next = 21UL;
      }
    }
    break;
    case 3UL: 
...
#line 52
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"wrong parameters, control=%d\n",
            control);
    {
    _TIG_FN_MtIt_1_calculator_next = 13UL;
    }
    break;
    case 11UL: 
#line 32
...
#line 35
    ...
    {
    _TIG_FN_MtIt_1_calculator_next = 17UL;
    }
    break;
    case 5UL: 
#line 11
...
#line 17
    ...
    {
    _TIG_FN_MtIt_1_calculator_next = 20UL;
    }
    break;
    case 10UL: 
#line 29
    ...
    if (control == 3) {
      {
      _TIG_FN_MtIt_1_calculator_next = 12UL;
      }
    } else {
      {
      _TIG_FN_MtIt_1_calculator_next = 8UL;
      }
    }
    break;
    default: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_MtIt_1___uint16_identity_next ;

  {
  {
  _TIG_FN_MtIt_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_MtIt_1___bswap_16_next ;

  {
  {
  _TIG_FN_MtIt_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_MtIt_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_MtIt_1___uint64_identity_next ;

  {
  {
  _TIG_FN_MtIt_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int res ;
  int tmp ;
  unsigned long _TIG_FN_MtIt_1_main_next ;
  ...
  {
  {
  _TIG_IZ_MtIt_envp = (char **)0;
  goto _TIG_IZ_MtIt_envp__INITINLINE__TIG_IZ_MtIt_envp__INIT;
  }
  _TIG_IZ_MtIt_envp__INITINLINE__TIG_IZ_MtIt_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MtIt_argv = (char **)0;
  goto _TIG_IZ_MtIt_argv__INITINLINE__TIG_IZ_MtIt_argv__INIT;
  }
  _TIG_IZ_MtIt_argv__INITINLINE__TIG_IZ_MtIt_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MtIt_argc = 0;
  goto _TIG_IZ_MtIt_argc__INITINLINE__TIG_IZ_MtIt_argc__INIT;
  }
  _TIG_IZ_MtIt_argc__INITINLINE__TIG_IZ_MtIt_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-MtIt--0":);
    _TIG_IZ_MtIt_argc = argc;
    _TIG_IZ_MtIt_argv = argv;
    _TIG_IZ_MtIt_envp = _TIG_IZ_MtIt_formal_envp;
    break;
  }
  {
  _TIG_FN_MtIt_1_main_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1_main_next) {
    case 4UL: ;
    if (res != 0) {
      {
      _TIG_FN_MtIt_1_main_next = 1UL;
      }
    } else {
      {
      _TIG_FN_MtIt_1_main_next = 3UL;
      }
    }
    break;
    case 1UL: ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_MtIt_1___uint32_identity_next ;

  {
  {
  _TIG_FN_MtIt_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_MtIt_1___bswap_32_next ;

  {
  {
  _TIG_FN_MtIt_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MtIt_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_MtIt_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
