...
[
  {
    ...
    "funs": [
      ...
      "empty", "enqueue", "freenode", "getnode", "init", "main"
    ],
    "options": {
      "common": {
        "prefix": "",
...
BEGIN-UNIVERSE
{
  ...
  "Transformations": [
    ...
    },
    {
      ...
      "TransformationKind": "Flatten",
      "TransformationUpdates": {
        "Modified Function Implementations": [ "empty" ]
      }
    },
    {
      "TransformationNumber": 1,
    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_0RSD_envp": "FUN: '_TIG_IZ_0RSD_envp__INIT'",
          "_TIG_IZ_0RSD_argv": "FUN: '_TIG_IZ_0RSD_argv__INIT'",
          "_TIG_IZ_0RSD_argc": "FUN: '_TIG_IZ_0RSD_argc__INIT'"
        }
      }
    },
    {
      ...
      "TransformationUpdates": {
        "New Functions": [
          "main", "display", "dequeue", "enqueue", "empty", "freenode",
          "getnode", "init", "__uint64_identity", "__uint32_identity",
...
/* BEGIN STRUCT-DECL node LOC=BrightonAnthony_DSA_assignment_queue_linkedlist.c:5 */
#line 5 "BrightonAnthony_DSA_assignment_queue_linkedlist.c"
struct node ;
/* END STRUCT-DECL node LOC=BrightonAnthony_DSA_assignment_queue_linkedlist.c:5 */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_0RSD_envp LOC=UNKNOWN */
char **_TIG_IZ_0RSD_envp ;
/* END VARIABLE-DECL _TIG_IZ_0RSD_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_0RSD_argv LOC=UNKNOWN */
char **_TIG_IZ_0RSD_argv  ;
/* END VARIABLE-DEF _TIG_IZ_0RSD_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_0RSD_argc LOC=UNKNOWN */
int _TIG_IZ_0RSD_argc ;
/* END VARIABLE-DECL _TIG_IZ_0RSD_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_0RSD_argc LOC=UNKNOWN */
int _TIG_IZ_0RSD_argc  ;
/* END VARIABLE-DEF _TIG_IZ_0RSD_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_0RSD_argv LOC=UNKNOWN */
char **_TIG_IZ_0RSD_argv ;
/* END VARIABLE-DECL _TIG_IZ_0RSD_argv LOC=UNKNOWN */
...
/* BEGIN STRUCT node LOC=BrightonAnthony_DSA_assignment_queue_linkedlist.c:5 */
#line 5 "BrightonAnthony_DSA_assignment_queue_linkedlist.c"
struct node {
   int info ;
   struct node *next ;
};
/* END STRUCT node LOC=BrightonAnthony_DSA_assignment_queue_linkedlist.c:5 */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_0RSD_envp LOC=UNKNOWN */
char **_TIG_IZ_0RSD_envp  ;
/* END VARIABLE-DEF _TIG_IZ_0RSD_envp LOC=UNKNOWN */
...
void main(int _TIG_IZ_0RSD_formal_argc , char **_TIG_IZ_0RSD_formal_argv , char **_TIG_IZ_0RSD_formal_envp ) ;
...
/* BEGIN FUNCTION-DECL empty LOC=UNKNOWN */
int empty(void) ;
/* END FUNCTION-DECL empty LOC=UNKNOWN */
...
{ 
  short tmp ;
  unsigned long _TIG_FN_0RSD_1___bswap_16_next ;

  {
  {
  _TIG_FN_0RSD_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_0RSD_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_0RSD_1___uint16_identity_next ;

  {
  {
  _TIG_FN_0RSD_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  void *tmp ;
  unsigned long _TIG_FN_0RSD_1_getnode_next ;

  {
  {
  _TIG_FN_0RSD_1_getnode_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_getnode_next) {
    case 1UL: 
#line 20 "BrightonAnthony_DSA_assignment_queue_linkedlist.c"
    tmp = malloc((size_t )sizeof(struct node ));
    {
    _TIG_FN_0RSD_1_getnode_next = 0UL;
    }
    break;
    case 0UL: ;
...
/* BEGIN FUNCTION-DEF empty LOC=UNKNOWN */
int empty(void) 
{ 
  unsigned long _TIG_FN_0RSD_1_empty_next ;

  {
  {
  _TIG_FN_0RSD_1_empty_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_empty_next) {
    case 1UL: ;
    if ((unsigned long )rear == (unsigned long )((void *)0)) {
      {
      _TIG_FN_0RSD_1_empty_next = 3UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_empty_next = 2UL;
      }
    }
    break;
    case 3UL: ;
...
/* END FUNCTION-DEF empty LOC=UNKNOWN */
...
{ 
  struct node *newnode ;
  int tmp ;
  unsigned long _TIG_FN_0RSD_1_enqueue_next ;

  {
  {
  _TIG_FN_0RSD_1_enqueue_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_enqueue_next) {
    case 4UL: ;
    {
    _TIG_FN_0RSD_1_enqueue_next = 1UL;
    }
    break;
    case 1UL: 
#line 39
...
#line 42
    tmp = empty();
    {
    _TIG_FN_0RSD_1_enqueue_next = 7UL;
    }
    break;
    case 3UL: 
#line 44
...
#line 46
    rear = newnode;
    {
    _TIG_FN_0RSD_1_enqueue_next = 5UL;
    }
    break;
    case 6UL: 
#line 50
...
#line 52
    ...
    if (tmp) {
      {
      _TIG_FN_0RSD_1_enqueue_next = 3UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_enqueue_next = 6UL;
      }
    }
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_0RSD_1___uint32_identity_next ;

  {
  {
  _TIG_FN_0RSD_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  ...
  int ans ;
  int tmp ;
  unsigned long _TIG_FN_0RSD_1_main_next ;
  ...
  {
  {
  _TIG_IZ_0RSD_envp = (char **)0;
  goto _TIG_IZ_0RSD_envp__INITINLINE__TIG_IZ_0RSD_envp__INIT;
  }
  _TIG_IZ_0RSD_envp__INITINLINE__TIG_IZ_0RSD_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_0RSD_argv = (char **)0;
  goto _TIG_IZ_0RSD_argv__INITINLINE__TIG_IZ_0RSD_argv__INIT;
  }
  _TIG_IZ_0RSD_argv__INITINLINE__TIG_IZ_0RSD_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_0RSD_argc = 0;
  goto _TIG_IZ_0RSD_argc__INITINLINE__TIG_IZ_0RSD_argc__INIT;
  }
  _TIG_IZ_0RSD_argc__INITINLINE__TIG_IZ_0RSD_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-0RSD--0":);
    _TIG_IZ_0RSD_argc = _TIG_IZ_0RSD_formal_argc;
    _TIG_IZ_0RSD_argv = _TIG_IZ_0RSD_formal_argv;
    _TIG_IZ_0RSD_envp = _TIG_IZ_0RSD_formal_envp;
    break;
  }
  {
  _TIG_FN_0RSD_1_main_next = 23UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_main_next) {
    case 4UL: 
#line 124
    exit(1);
...
#line 125
    ...
    case 4: 
    {
    _TIG_FN_0RSD_1_main_next = 4UL;
    }
    break;
    case 3: 
    {
    _TIG_FN_0RSD_1_main_next = 14UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_0RSD_1_main_next = 20UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_0RSD_1_main_next = 7UL;
    }
    break;
    default: 
    {
    _TIG_FN_0RSD_1_main_next = 15UL;
    }
    break;
    }
    break;
...
#line 95
    init();
    {
    _TIG_FN_0RSD_1_main_next = 10UL;
    }
    break;
    case 3UL: ;
    if (tmp) {
      {
      _TIG_FN_0RSD_1_main_next = 1UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_main_next = 6UL;
      }
    }
    break;
    case 21UL: 
...
#line 128
    scanf((char const   */* __restrict  */)"%d", & ans);
    {
    _TIG_FN_0RSD_1_main_next = 0UL;
    }
    break;
    case 6UL: 
#line 115
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_0RSD_1___uint64_identity_next ;

  {
  {
  _TIG_FN_0RSD_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
void freenode(struct node *p ) 
{ 
  unsigned long _TIG_FN_0RSD_1_freenode_next ;

  {
  {
  _TIG_FN_0RSD_1_freenode_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_freenode_next) {
    case 1UL: 
#line 25
    free((void *)p);
    {
    _TIG_FN_0RSD_1_freenode_next = 0UL;
    }
    break;
    case 0UL: ;
    return;
...
{ 
  int x ;
  struct node *temp ;
  unsigned long _TIG_FN_0RSD_1_dequeue_next ;

  {
  {
  _TIG_FN_0RSD_1_dequeue_next = 3UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_dequeue_next) {
    case 4UL: 
#line 64
    init();
    {
    _TIG_FN_0RSD_1_dequeue_next = 6UL;
    }
    break;
    case 1UL: ;
    if ((unsigned long )front == (unsigned long )rear) {
      {
      _TIG_FN_0RSD_1_dequeue_next = 4UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_dequeue_next = 5UL;
      }
    }
    break;
    case 3UL: ;
    {
    _TIG_FN_0RSD_1_dequeue_next = 0UL;
    }
    break;
    case 6UL: 
#line 70
    freenode(temp);
    {
    _TIG_FN_0RSD_1_dequeue_next = 2UL;
    }
    break;
    case 5UL: 
#line 68
...
#line 61
    x = front->info;
    {
    _TIG_FN_0RSD_1_dequeue_next = 1UL;
    }
    break;
    case 2UL: ;
    return (x);
...
{ 
  struct node *temp ;
  int tmp ;
  unsigned long _TIG_FN_0RSD_1_display_next ;

  {
  {
  _TIG_FN_0RSD_1_display_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_display_next) {
    case 4UL: 
#line 78
    tmp = empty();
    {
    _TIG_FN_0RSD_1_display_next = 8UL;
    }
    break;
    case 8UL: ;
    if (tmp) {
      {
      _TIG_FN_0RSD_1_display_next = 5UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_display_next = 9UL;
      }
    }
    break;
    case 3UL: 
...
#line 86
    temp = temp->next;
    {
    _TIG_FN_0RSD_1_display_next = 0UL;
    }
    break;
    case 9UL: 
#line 82
...
#line 79
    printf((char const   */* __restrict  */)"\n Queue is empty");
    {
    _TIG_FN_0RSD_1_display_next = 2UL;
    }
    break;
    case 0UL: ;
    if ((unsigned long )temp != (unsigned long )((void *)0)) {
      {
      _TIG_FN_0RSD_1_display_next = 3UL;
      }
    } else {
      {
      _TIG_FN_0RSD_1_display_next = 2UL;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_0RSD_1___bswap_32_next ;

  {
  {
  _TIG_FN_0RSD_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_0RSD_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_0RSD_1___bswap_64_next ;

  {
  {
  _TIG_FN_0RSD_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1___bswap_64_next) {
    case 1UL: ;
...
#line 73
    ...
    {
    _TIG_FN_0RSD_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
void init(void) 
{ 
  unsigned long _TIG_FN_0RSD_1_init_next ;

  {
  {
  _TIG_FN_0RSD_1_init_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_0RSD_1_init_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: ;
    {
    _TIG_FN_0RSD_1_init_next = 2UL;
    }
    break;
    case 2UL: 
#line 15 "BrightonAnthony_DSA_assignment_queue_linkedlist.c"
    rear = (struct node *)((void *)0);
#line 15
    front = rear;
    {
    _TIG_FN_0RSD_1_init_next = 1UL;
    }
    break;
    default: 
    break;
