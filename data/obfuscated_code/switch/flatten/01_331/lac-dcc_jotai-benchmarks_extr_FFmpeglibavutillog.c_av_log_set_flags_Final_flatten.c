    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_teBH_envp": "FUN: '_TIG_IZ_teBH_envp__INIT'",
          "_TIG_IZ_teBH_argv": "FUN: '_TIG_IZ_teBH_argv__INIT'",
          "_TIG_IZ_teBH_argc": "FUN: '_TIG_IZ_teBH_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_teBH_argc LOC=UNKNOWN */
int _TIG_IZ_teBH_argc  ;
/* END VARIABLE-DEF _TIG_IZ_teBH_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_teBH_envp LOC=UNKNOWN */
char **_TIG_IZ_teBH_envp  ;
/* END VARIABLE-DEF _TIG_IZ_teBH_envp LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_teBH_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_teBH_argc LOC=UNKNOWN */
int _TIG_IZ_teBH_argc ;
/* END VARIABLE-DECL _TIG_IZ_teBH_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_teBH_envp LOC=UNKNOWN */
char **_TIG_IZ_teBH_envp ;
/* END VARIABLE-DECL _TIG_IZ_teBH_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_teBH_argv LOC=UNKNOWN */
char **_TIG_IZ_teBH_argv  ;
/* END VARIABLE-DEF _TIG_IZ_teBH_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_teBH_argv LOC=UNKNOWN */
char **_TIG_IZ_teBH_argv ;
/* END VARIABLE-DECL _TIG_IZ_teBH_argv LOC=UNKNOWN */
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_teBH_1___uint32_identity_next ;

  {
  {
  _TIG_FN_teBH_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
void usage(void) 
{ 
  unsigned long _TIG_FN_teBH_1_usage_next ;

  {
  {
  _TIG_FN_teBH_1_usage_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1_usage_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
...
{ 
  int counter ;
  unsigned long _TIG_FN_teBH_1_next_i_next ;

  {
  {
  _TIG_FN_teBH_1_next_i_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1_next_i_next) {
    case 1UL: 
#line 18
    counter = 0;
#line 19
    counter ++;
    {
    _TIG_FN_teBH_1_next_i_next = 2UL;
    }
    break;
    case 0UL: ;
    {
    _TIG_FN_teBH_1_next_i_next = 1UL;
    }
    break;
    case 2UL: ;
...
void av_log_set_flags(int arg ) 
{ 
  unsigned long _TIG_FN_teBH_1_av_log_set_flags_next ;

  {
  {
  _TIG_FN_teBH_1_av_log_set_flags_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1_av_log_set_flags_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
#line 63
    flags = arg;
    {
    _TIG_FN_teBH_1_av_log_set_flags_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_teBH_1___uint64_identity_next ;

  {
  {
  _TIG_FN_teBH_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int counter ;
  unsigned long _TIG_FN_teBH_1_next_f_next ;

  {
  {
  _TIG_FN_teBH_1_next_f_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1_next_f_next) {
    case 1UL: ;
    return ((float )rand_primes[counter % 25] / 757751.0F);
    break;
    case 0UL: ;
    {
    _TIG_FN_teBH_1_next_f_next = 2UL;
    }
    break;
    case 2UL: 
#line 23
...
#line 24
    counter ++;
    {
    _TIG_FN_teBH_1_next_f_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_teBH_1___uint16_identity_next ;

  {
  {
  _TIG_FN_teBH_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_teBH_1___bswap_64_next ;

  {
  {
  _TIG_FN_teBH_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_teBH_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int tmp___0 ;
  int tmp___1 ;
  unsigned long _TIG_FN_teBH_1_main_next ;
  ...
  {
  {
  _TIG_IZ_teBH_envp = (char **)0;
  goto _TIG_IZ_teBH_envp__INITINLINE__TIG_IZ_teBH_envp__INIT;
  }
  _TIG_IZ_teBH_envp__INITINLINE__TIG_IZ_teBH_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_teBH_argv = (char **)0;
  goto _TIG_IZ_teBH_argv__INITINLINE__TIG_IZ_teBH_argv__INIT;
  }
  _TIG_IZ_teBH_argv__INITINLINE__TIG_IZ_teBH_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_teBH_argc = 0;
  goto _TIG_IZ_teBH_argc__INITINLINE__TIG_IZ_teBH_argc__INIT;
  }
  _TIG_IZ_teBH_argc__INITINLINE__TIG_IZ_teBH_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-teBH--0":);
    _TIG_IZ_teBH_argc = argc;
    _TIG_IZ_teBH_argv = argv;
    _TIG_IZ_teBH_envp = _TIG_IZ_teBH_formal_envp;
    break;
  }
  {
  _TIG_FN_teBH_1_main_next = 10UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1_main_next) {
    case 12UL: 
#line 81 "lac-dcc_jotai-benchmarks_extr_FFmpeglibavutillog.c_av_log_set_flags_Final.c"
    arg = 100;
#line 83
    av_log_set_flags(arg);
    {
    _TIG_FN_teBH_1_main_next = 1UL;
    }
    break;
    case 1UL: ;
    return (0);
...
#line 101
    ...
    case 3: 
    {
    _TIG_FN_teBH_1_main_next = 3UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_teBH_1_main_next = 13UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_teBH_1_main_next = 11UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_teBH_1_main_next = 12UL;
    }
    break;
    default: 
    {
    _TIG_FN_teBH_1_main_next = 17UL;
    }
    break;
    }
    break;
...
#line 115
    ...
    if (argc != 2) {
      {
      _TIG_FN_teBH_1_main_next = 0UL;
      }
    } else {
      {
      _TIG_FN_teBH_1_main_next = 16UL;
      }
    }
    break;
    case 0UL: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_teBH_1___bswap_16_next ;

  {
  {
  _TIG_FN_teBH_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_teBH_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_teBH_1___bswap_32_next ;

  {
  {
  _TIG_FN_teBH_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_teBH_1___bswap_32_next) {
    case 1UL: ;
...
#line 52
    ...
    {
    _TIG_FN_teBH_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
