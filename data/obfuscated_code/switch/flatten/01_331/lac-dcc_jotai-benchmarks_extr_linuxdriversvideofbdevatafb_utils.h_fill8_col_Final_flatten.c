    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_vfit_envp": "FUN: '_TIG_IZ_vfit_envp__INIT'",
          "_TIG_IZ_vfit_argv": "FUN: '_TIG_IZ_vfit_argv__INIT'",
          "_TIG_IZ_vfit_argc": "FUN: '_TIG_IZ_vfit_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_vfit_envp LOC=UNKNOWN */
char **_TIG_IZ_vfit_envp  ;
/* END VARIABLE-DEF _TIG_IZ_vfit_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_vfit_envp LOC=UNKNOWN */
char **_TIG_IZ_vfit_envp ;
/* END VARIABLE-DECL _TIG_IZ_vfit_envp LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_vfit_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_vfit_argv LOC=UNKNOWN */
char **_TIG_IZ_vfit_argv ;
/* END VARIABLE-DECL _TIG_IZ_vfit_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_vfit_argv LOC=UNKNOWN */
char **_TIG_IZ_vfit_argv  ;
/* END VARIABLE-DEF _TIG_IZ_vfit_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_vfit_argc LOC=UNKNOWN */
int _TIG_IZ_vfit_argc  ;
/* END VARIABLE-DEF _TIG_IZ_vfit_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_vfit_argc LOC=UNKNOWN */
int _TIG_IZ_vfit_argc ;
/* END VARIABLE-DECL _TIG_IZ_vfit_argc LOC=UNKNOWN */
...
void usage(void) 
{ 
  unsigned long _TIG_FN_vfit_1_usage_next ;

  {
  {
  _TIG_FN_vfit_1_usage_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1_usage_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
#line 30 "lac-dcc_jotai-benchmarks_extr_linuxdriversvideofbdevatafb_utils.h_fill8_col_Final.c"
    printf((char const   */* __restrict  */)"%s", "Usage:\n    prog [ARGS]\n\nARGS:\n       0            big-arr\n       1            big-arr-10x\n\n");
    {
    _TIG_FN_vfit_1_usage_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_vfit_1___uint64_identity_next ;

  {
  {
  _TIG_FN_vfit_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_vfit_1___bswap_32_next ;

  {
  {
  _TIG_FN_vfit_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_vfit_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int counter ;
  unsigned long _TIG_FN_vfit_1_next_i_next ;

  {
  {
  _TIG_FN_vfit_1_next_i_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1_next_i_next) {
    case 1UL: ;
    {
    _TIG_FN_vfit_1_next_i_next = 0UL;
    }
    break;
    case 0UL: 
#line 18 "lac-dcc_jotai-benchmarks_extr_linuxdriversvideofbdevatafb_utils.h_fill8_col_Final.c"
    counter = 0;
#line 19
    counter ++;
    {
    _TIG_FN_vfit_1_next_i_next = 2UL;
    }
    break;
    case 2UL: ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_vfit_1___uint32_identity_next ;

  {
  {
  _TIG_FN_vfit_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int counter ;
  unsigned long _TIG_FN_vfit_1_next_f_next ;

  {
  {
  _TIG_FN_vfit_1_next_f_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1_next_f_next) {
    case 1UL: ;
...
#line 24
    counter ++;
    {
    _TIG_FN_vfit_1_next_f_next = 1UL;
    }
    break;
    case 2UL: ;
    {
    _TIG_FN_vfit_1_next_f_next = 0UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_vfit_1___uint16_identity_next ;

  {
  {
  _TIG_FN_vfit_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_vfit_1___bswap_64_next ;

  {
  {
  _TIG_FN_vfit_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_vfit_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int tmp___10 ;
  int tmp___11 ;
  unsigned long _TIG_FN_vfit_1_main_next ;
  ...
  {
  {
  _TIG_IZ_vfit_envp = (char **)0;
  goto _TIG_IZ_vfit_envp__INITINLINE__TIG_IZ_vfit_envp__INIT;
  }
  _TIG_IZ_vfit_envp__INITINLINE__TIG_IZ_vfit_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_vfit_argv = (char **)0;
  goto _TIG_IZ_vfit_argv__INITINLINE__TIG_IZ_vfit_argv__INIT;
  }
  _TIG_IZ_vfit_argv__INITINLINE__TIG_IZ_vfit_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_vfit_argc = 0;
  goto _TIG_IZ_vfit_argc__INITINLINE__TIG_IZ_vfit_argc__INIT;
  }
  _TIG_IZ_vfit_argc__INITINLINE__TIG_IZ_vfit_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-vfit--0":);
    _TIG_IZ_vfit_argc = argc;
    _TIG_IZ_vfit_argv = argv;
    _TIG_IZ_vfit_envp = _TIG_IZ_vfit_formal_envp;
    break;
  }
  {
  _TIG_FN_vfit_1_main_next = 19UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1_main_next) {
    case 4UL: 
#line 87 "lac-dcc_jotai-benchmarks_extr_linuxdriversvideofbdevatafb_utils.h_fill8_col_Final.c"
    tmp = atoi((char const   *)*(argv + 1));
#line 87
    opt = tmp;
    {
    _TIG_FN_vfit_1_main_next = 23UL;
    }
    break;
    case 15UL: 
#line 122
...
#line 118
    ...
    case 1: 
    {
    _TIG_FN_vfit_1_main_next = 11UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_vfit_1_main_next = 1UL;
    }
    break;
    default: 
    {
    _TIG_FN_vfit_1_main_next = 7UL;
    }
    break;
    }
    break;
...
#line 175
    free((void *)m___0);
    {
    _TIG_FN_vfit_1_main_next = 32UL;
    }
    break;
    case 16UL: ;
    if (_i0 < _len_dst0) {
      {
      _TIG_FN_vfit_1_main_next = 28UL;
      }
    } else {
      {
      _TIG_FN_vfit_1_main_next = 15UL;
      }
    }
    break;
    case 21UL: 
...
#line 163
    _i0___1 = 0;
    {
    _TIG_FN_vfit_1_main_next = 42UL;
    }
    break;
    case 19UL: ;
    if (argc != 2) {
      {
      _TIG_FN_vfit_1_main_next = 0UL;
      }
    } else {
      {
      _TIG_FN_vfit_1_main_next = 4UL;
      }
    }
    break;
    case 32UL: ;
    ...
    if (_i0___0 < _len_m0) {
      {
      _TIG_FN_vfit_1_main_next = 2UL;
      }
    } else {
      {
      _TIG_FN_vfit_1_main_next = 21UL;
      }
    }
    break;
    case 27UL: 
...
#line 118
    ...
    break;
    case 42UL: ;
    if (_i0___1 < _len_dst0___0) {
      {
      _TIG_FN_vfit_1_main_next = 27UL;
      }
    } else {
      {
      _TIG_FN_vfit_1_main_next = 34UL;
      }
    }
    break;
    case 0UL: 
...
#line 124
    ...
    break;
    case 20UL: ;
    if (_i0___2 < _len_m0___0) {
      {
      _TIG_FN_vfit_1_main_next = 8UL;
      }
    } else {
      {
      _TIG_FN_vfit_1_main_next = 3UL;
      }
    }
    break;
    default: 
...
{ 
  u32 tmp ;
  unsigned long _TIG_FN_vfit_1_fill8_col_next ;

  {
  {
  _TIG_FN_vfit_1_fill8_col_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1_fill8_col_next) {
    case 1UL: 
#line 62
    tmp = *(m + 0);
#line 63
...
#line 64
    *(dst + 2) = tmp;
    {
    _TIG_FN_vfit_1_fill8_col_next = 2UL;
    }
    break;
    case 0UL: ;
    {
    _TIG_FN_vfit_1_fill8_col_next = 1UL;
    }
    break;
    case 2UL: ;
    return;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_vfit_1___bswap_16_next ;

  {
  {
  _TIG_FN_vfit_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_vfit_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_vfit_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
