    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_MwM7_envp": "FUN: '_TIG_IZ_MwM7_envp__INIT'",
          "_TIG_IZ_MwM7_argv": "FUN: '_TIG_IZ_MwM7_argv__INIT'",
          "_TIG_IZ_MwM7_argc": "FUN: '_TIG_IZ_MwM7_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MwM7_envp LOC=UNKNOWN */
char **_TIG_IZ_MwM7_envp ;
/* END VARIABLE-DECL _TIG_IZ_MwM7_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MwM7_argv LOC=UNKNOWN */
char **_TIG_IZ_MwM7_argv ;
/* END VARIABLE-DECL _TIG_IZ_MwM7_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MwM7_argc LOC=UNKNOWN */
int _TIG_IZ_MwM7_argc  ;
/* END VARIABLE-DEF _TIG_IZ_MwM7_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MwM7_argc LOC=UNKNOWN */
int _TIG_IZ_MwM7_argc ;
/* END VARIABLE-DECL _TIG_IZ_MwM7_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MwM7_argv LOC=UNKNOWN */
char **_TIG_IZ_MwM7_argv  ;
/* END VARIABLE-DEF _TIG_IZ_MwM7_argv LOC=UNKNOWN */
...
int main(int _TIG_IZ_MwM7_formal_argc , char **_TIG_IZ_MwM7_formal_argv , char **_TIG_IZ_MwM7_formal_envp ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MwM7_envp LOC=UNKNOWN */
char **_TIG_IZ_MwM7_envp  ;
/* END VARIABLE-DEF _TIG_IZ_MwM7_envp LOC=UNKNOWN */
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_MwM7_1___uint16_identity_next ;

  {
  {
  _TIG_FN_MwM7_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_MwM7_1___bswap_32_next ;

  {
  {
  _TIG_FN_MwM7_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_MwM7_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_MwM7_1___bswap_16_next ;

  {
  {
  _TIG_FN_MwM7_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___bswap_16_next) {
    case 1UL: ;
...
#line 37
    ...
    {
    _TIG_FN_MwM7_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_MwM7_1___uint32_identity_next ;

  {
  {
  _TIG_FN_MwM7_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_MwM7_1_pop_next ;

  {
  {
  _TIG_FN_MwM7_1_pop_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1_pop_next) {
    case 4UL: ;
    if (top == -1) {
      {
      _TIG_FN_MwM7_1_pop_next = 0UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_pop_next = 1UL;
      }
    }
    break;
    case 1UL: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_MwM7_1___bswap_64_next ;

  {
  {
  _TIG_FN_MwM7_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_MwM7_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int data ;
  unsigned long _TIG_FN_MwM7_1_push_next ;

  {
  {
  _TIG_FN_MwM7_1_push_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1_push_next) {
    case 4UL: ;
    if (top == 4) {
      {
      _TIG_FN_MwM7_1_push_next = 1UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_push_next = 0UL;
      }
    }
    break;
    case 1UL: 
#line 12 "vaibhavkrishna-bhosle_DSA_3.c"
    printf((char const   */* __restrict  */)"----------------------------------Stack is full\n");
    {
    _TIG_FN_MwM7_1_push_next = 3UL;
    }
    break;
    case 3UL: ;
    return;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_MwM7_1___uint64_identity_next ;

  {
  {
  _TIG_FN_MwM7_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int i ;
  int j ;
  unsigned long _TIG_FN_MwM7_1_palindrome_next ;

  {
  {
  _TIG_FN_MwM7_1_palindrome_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1_palindrome_next) {
    case 8UL: ;
    if (stack[i] != stack[j]) {
      {
      _TIG_FN_MwM7_1_palindrome_next = 6UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_palindrome_next = 0UL;
      }
    }
    break;
    case 3UL: 
#line 46
    ...
    {
    _TIG_FN_MwM7_1_palindrome_next = 7UL;
    }
    break;
    case 9UL: ;
    return;
...
#line 42
    ...
    {
    _TIG_FN_MwM7_1_palindrome_next = 9UL;
    }
    break;
    case 5UL: ;
    if (i < j) {
      {
      _TIG_FN_MwM7_1_palindrome_next = 8UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_palindrome_next = 3UL;
      }
    }
    break;
    case 10UL: 
...
#line 40
    j = top;
    {
    _TIG_FN_MwM7_1_palindrome_next = 5UL;
    }
    break;
    case 0UL: 
#line 40
...
#line 40
    ...
    case 2UL: ;
    {
    _TIG_FN_MwM7_1_palindrome_next = 10UL;
    }
    break;
    default: 
    break;
...
{ 
  int i ;
  unsigned long _TIG_FN_MwM7_1_display_next ;

  {
  {
  _TIG_FN_MwM7_1_display_next = 8UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1_display_next) {
    case 4UL: ;
    return;
    break;
    case 8UL: ;
    if (top == -1) {
      {
      _TIG_FN_MwM7_1_display_next = 5UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_display_next = 6UL;
      }
    }
    break;
    case 1UL: ;
    if (i >= 0) {
      {
      _TIG_FN_MwM7_1_display_next = 2UL;
      }
    } else {
      {
      _TIG_FN_MwM7_1_display_next = 4UL;
      }
    }
    break;
    case 6UL: 
#line 32
    i = top;
    {
    _TIG_FN_MwM7_1_display_next = 1UL;
    }
    break;
    case 5UL: 
#line 30
...
{ 
  ...
  int ch ;
  unsigned long _TIG_FN_MwM7_1_main_next ;
  ...
  {
  {
  _TIG_IZ_MwM7_envp = (char **)0;
  goto _TIG_IZ_MwM7_envp__INITINLINE__TIG_IZ_MwM7_envp__INIT;
  }
  _TIG_IZ_MwM7_envp__INITINLINE__TIG_IZ_MwM7_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MwM7_argv = (char **)0;
  goto _TIG_IZ_MwM7_argv__INITINLINE__TIG_IZ_MwM7_argv__INIT;
  }
  _TIG_IZ_MwM7_argv__INITINLINE__TIG_IZ_MwM7_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MwM7_argc = 0;
  goto _TIG_IZ_MwM7_argc__INITINLINE__TIG_IZ_MwM7_argc__INIT;
  }
  _TIG_IZ_MwM7_argc__INITINLINE__TIG_IZ_MwM7_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-MwM7--0":);
    _TIG_IZ_MwM7_argc = _TIG_IZ_MwM7_formal_argc;
    _TIG_IZ_MwM7_argv = _TIG_IZ_MwM7_formal_argv;
    _TIG_IZ_MwM7_envp = _TIG_IZ_MwM7_formal_envp;
    break;
  }
  {
  _TIG_FN_MwM7_1_main_next = 10UL;
  }
  while (1) {
    switch (_TIG_FN_MwM7_1_main_next) {
    case 1UL: 
#line 64
    printf((char const   */* __restrict  */)"Invalid choice\n");
    {
    _TIG_FN_MwM7_1_main_next = 6UL;
    }
    break;
    case 3UL: 
#line 59
    ...
    case 5: 
    {
    _TIG_FN_MwM7_1_main_next = 2UL;
    }
    break;
    case 4: 
    {
    _TIG_FN_MwM7_1_main_next = 5UL;
    }
    break;
    case 3: 
    {
    _TIG_FN_MwM7_1_main_next = 3UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_MwM7_1_main_next = 9UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_MwM7_1_main_next = 7UL;
    }
    break;
    default: 
    {
    _TIG_FN_MwM7_1_main_next = 1UL;
    }
    break;
    }
    break;
