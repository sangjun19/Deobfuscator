    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_pj3m_envp": "FUN: '_TIG_IZ_pj3m_envp__INIT'",
          "_TIG_IZ_pj3m_argv": "FUN: '_TIG_IZ_pj3m_argv__INIT'",
          "_TIG_IZ_pj3m_argc": "FUN: '_TIG_IZ_pj3m_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_pj3m_envp LOC=UNKNOWN */
char **_TIG_IZ_pj3m_envp  ;
/* END VARIABLE-DEF _TIG_IZ_pj3m_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_pj3m_argv LOC=UNKNOWN */
char **_TIG_IZ_pj3m_argv ;
/* END VARIABLE-DECL _TIG_IZ_pj3m_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_pj3m_argc LOC=UNKNOWN */
int _TIG_IZ_pj3m_argc  ;
/* END VARIABLE-DEF _TIG_IZ_pj3m_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_pj3m_argc LOC=UNKNOWN */
int _TIG_IZ_pj3m_argc ;
/* END VARIABLE-DECL _TIG_IZ_pj3m_argc LOC=UNKNOWN */

/* BEGIN VARIABLE-DECL _TIG_IZ_pj3m_envp LOC=UNKNOWN */
char **_TIG_IZ_pj3m_envp ;
/* END VARIABLE-DECL _TIG_IZ_pj3m_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_pj3m_argv LOC=UNKNOWN */
char **_TIG_IZ_pj3m_argv  ;
/* END VARIABLE-DEF _TIG_IZ_pj3m_argv LOC=UNKNOWN */
...
void main(int _TIG_IZ_pj3m_formal_argc , char **_TIG_IZ_pj3m_formal_argv , char **_TIG_IZ_pj3m_formal_envp ) ;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_pj3m_1___bswap_32_next ;

  {
  {
  _TIG_FN_pj3m_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_pj3m_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_pj3m_1___bswap_64_next ;

  {
  {
  _TIG_FN_pj3m_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___bswap_64_next) {
    case 1UL: 
#line 73
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_pj3m_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_pj3m_1___uint16_identity_next ;

  {
  {
  _TIG_FN_pj3m_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_pj3m_1___uint64_identity_next ;

  {
  {
  _TIG_FN_pj3m_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  char buf[0x100] ;
  unsigned int tmp ;
  unsigned long _TIG_FN_pj3m_1_read_motd_next ;

  {
  {
  _TIG_FN_pj3m_1_read_motd_next = 9UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1_read_motd_next) {
    case 8UL: 
#line 29 "alxbl_montrehack-rop101_1.c"
    buf[tmp] = (char)0;
#line 29
    tmp ++;
    {
    _TIG_FN_pj3m_1_read_motd_next = 5UL;
    }
    break;
    case 1UL: ;
    return;
    ...
    case 9UL: ;
    {
    _TIG_FN_pj3m_1_read_motd_next = 7UL;
    }
    break;
    case 6UL: 
#line 30
...
#line 31
    memcpy((void */* __restrict  */)motd___0, (void const   */* __restrict  */)(buf),
           (size_t )0x100);
    {
    _TIG_FN_pj3m_1_read_motd_next = 1UL;
    }
    break;
    case 5UL: ;
    if (tmp >= 256U) {
      {
      _TIG_FN_pj3m_1_read_motd_next = 6UL;
      }
    } else {
      {
      _TIG_FN_pj3m_1_read_motd_next = 8UL;
      }
    }
    break;
    case 7UL: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_pj3m_1___bswap_16_next ;

  {
  {
  _TIG_FN_pj3m_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_pj3m_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int choice ;
  unsigned long _TIG_FN_pj3m_1_getnum_next ;

  {
  {
  _TIG_FN_pj3m_1_getnum_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1_getnum_next) {
    case 1UL: ;
    {
    _TIG_FN_pj3m_1_getnum_next = 2UL;
    }
    break;
    case 0UL: ;
    return (choice);
...
#line 23
    clean_stdin();
    {
    _TIG_FN_pj3m_1_getnum_next = 0UL;
    }
    break;
    default: 
    break;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_pj3m_1___uint32_identity_next ;

  {
  {
  _TIG_FN_pj3m_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int choice ;
  int tmp ;
  unsigned long _TIG_FN_pj3m_1_main_next ;
  ...
  {
  {
  _TIG_IZ_pj3m_envp = (char **)0;
  goto _TIG_IZ_pj3m_envp__INITINLINE__TIG_IZ_pj3m_envp__INIT;
  }
  _TIG_IZ_pj3m_envp__INITINLINE__TIG_IZ_pj3m_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_pj3m_argv = (char **)0;
  goto _TIG_IZ_pj3m_argv__INITINLINE__TIG_IZ_pj3m_argv__INIT;
  }
  _TIG_IZ_pj3m_argv__INITINLINE__TIG_IZ_pj3m_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_pj3m_argc = 0;
  goto _TIG_IZ_pj3m_argc__INITINLINE__TIG_IZ_pj3m_argc__INIT;
  }
  _TIG_IZ_pj3m_argc__INITINLINE__TIG_IZ_pj3m_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-pj3m--0":);
    _TIG_IZ_pj3m_argc = _TIG_IZ_pj3m_formal_argc;
    _TIG_IZ_pj3m_argv = _TIG_IZ_pj3m_formal_argv;
    _TIG_IZ_pj3m_envp = _TIG_IZ_pj3m_formal_envp;
    break;
  }
  {
  _TIG_FN_pj3m_1_main_next = 6UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1_main_next) {
    case 14UL: 
#line 62
    read_motd(motd);
    {
    _TIG_FN_pj3m_1_main_next = 12UL;
    }
    break;
    case 15UL: ;
    return;
    ...
    if (! done) {
      {
      _TIG_FN_pj3m_1_main_next = 10UL;
      }
    } else {
      {
      _TIG_FN_pj3m_1_main_next = 2UL;
      }
    }
    break;
    case 1UL: 
...
#line 66
    ...
    case 3: 
    {
    _TIG_FN_pj3m_1_main_next = 3UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_pj3m_1_main_next = 14UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_pj3m_1_main_next = 7UL;
    }
    break;
    default: 
    {
    _TIG_FN_pj3m_1_main_next = 0UL;
    }
    break;
    }
    break;
...
{ 
  char c ;
  int tmp ;
  unsigned long _TIG_FN_pj3m_1_clean_stdin_next ;

  {
  {
  _TIG_FN_pj3m_1_clean_stdin_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_pj3m_1_clean_stdin_next) {
    case 4UL: ;
    return;
    break;
    case 1UL: ;
    if ((int )c == 10) {
      {
      _TIG_FN_pj3m_1_clean_stdin_next = 4UL;
      }
    } else {
      {
      _TIG_FN_pj3m_1_clean_stdin_next = 6UL;
      }
    }
    break;
    case 6UL: ;
    if ((int )c == -1) {
      {
      _TIG_FN_pj3m_1_clean_stdin_next = 2UL;
      }
    } else {
      {
      _TIG_FN_pj3m_1_clean_stdin_next = 0UL;
      }
    }
    break;
    case 0UL: 
...
#line 13
    c = (char )tmp;
    {
    _TIG_FN_pj3m_1_clean_stdin_next = 1UL;
    }
    break;
    case 7UL: ;
    {
