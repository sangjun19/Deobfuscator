    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_jvSF_envp": "FUN: '_TIG_IZ_jvSF_envp__INIT'",
          "_TIG_IZ_jvSF_argv": "FUN: '_TIG_IZ_jvSF_argv__INIT'",
          "_TIG_IZ_jvSF_argc": "FUN: '_TIG_IZ_jvSF_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jvSF_envp LOC=UNKNOWN */
char **_TIG_IZ_jvSF_envp ;
/* END VARIABLE-DECL _TIG_IZ_jvSF_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jvSF_argv LOC=UNKNOWN */
char **_TIG_IZ_jvSF_argv  ;
/* END VARIABLE-DEF _TIG_IZ_jvSF_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jvSF_argv LOC=UNKNOWN */
char **_TIG_IZ_jvSF_argv ;
/* END VARIABLE-DECL _TIG_IZ_jvSF_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jvSF_envp LOC=UNKNOWN */
char **_TIG_IZ_jvSF_envp  ;
/* END VARIABLE-DEF _TIG_IZ_jvSF_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jvSF_argc LOC=UNKNOWN */
int _TIG_IZ_jvSF_argc ;
/* END VARIABLE-DECL _TIG_IZ_jvSF_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jvSF_argc LOC=UNKNOWN */
int _TIG_IZ_jvSF_argc  ;
/* END VARIABLE-DEF _TIG_IZ_jvSF_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_jvSF_formal_argc , char **_TIG_IZ_jvSF_formal_argv , char **_TIG_IZ_jvSF_formal_envp ) ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_jvSF_1___uint32_identity_next ;

  {
  {
  _TIG_FN_jvSF_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_jvSF_1___bswap_64_next ;

  {
  {
  _TIG_FN_jvSF_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_jvSF_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_jvSF_1___bswap_32_next ;

  {
  {
  _TIG_FN_jvSF_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___bswap_32_next) {
    case 1UL: ;
...
#line 52
    ...
    {
    _TIG_FN_jvSF_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_jvSF_1___uint16_identity_next ;

  {
  {
  _TIG_FN_jvSF_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_jvSF_1___bswap_16_next ;

  {
  {
  _TIG_FN_jvSF_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___bswap_16_next) {
    case 1UL: 
#line 37
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_jvSF_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_jvSF_1___uint64_identity_next ;

  {
  {
  _TIG_FN_jvSF_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  char escolha ;
  unsigned long _TIG_FN_jvSF_1_main_next ;
  ...
  {
  {
  _TIG_IZ_jvSF_envp = (char **)0;
  goto _TIG_IZ_jvSF_envp__INITINLINE__TIG_IZ_jvSF_envp__INIT;
  }
  _TIG_IZ_jvSF_envp__INITINLINE__TIG_IZ_jvSF_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_jvSF_argv = (char **)0;
  goto _TIG_IZ_jvSF_argv__INITINLINE__TIG_IZ_jvSF_argv__INIT;
  }
  _TIG_IZ_jvSF_argv__INITINLINE__TIG_IZ_jvSF_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_jvSF_argc = 0;
  goto _TIG_IZ_jvSF_argc__INITINLINE__TIG_IZ_jvSF_argc__INIT;
  }
  _TIG_IZ_jvSF_argc__INITINLINE__TIG_IZ_jvSF_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-jvSF--0":);
    _TIG_IZ_jvSF_argc = _TIG_IZ_jvSF_formal_argc;
    _TIG_IZ_jvSF_argv = _TIG_IZ_jvSF_formal_argv;
    _TIG_IZ_jvSF_envp = _TIG_IZ_jvSF_formal_envp;
    break;
  }
  {
  _TIG_FN_jvSF_1_main_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_jvSF_1_main_next) {
    case 4UL: 
#line 42 "pedroricardo14_introducao-a-programacao_quest4.c"
    printf((char const   */* __restrict  */)"Opcao Invalida!");
    {
    _TIG_FN_jvSF_1_main_next = 2UL;
    }
    break;
    case 1UL: 
#line 24
...
#line 14
    ...
    case 82: 
    {
    _TIG_FN_jvSF_1_main_next = 10UL;
    }
    break;
    case 115: 
    case 83: 
    {
    _TIG_FN_jvSF_1_main_next = 7UL;
    }
    break;
    case 99: 
    case 67: 
    {
    _TIG_FN_jvSF_1_main_next = 1UL;
    }
    break;
    default: 
    {
    _TIG_FN_jvSF_1_main_next = 4UL;
    }
    break;
    }
    break;
