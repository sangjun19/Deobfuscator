...
[
  {
    ...
    "funs": [
      ...
      "__uint32_identity", "__uint64_identity", "main", "misterio"
    ],
    "options": {
      "common": {
        "prefix": "",
...
BEGIN-UNIVERSE
{
  ...
  "Transformations": [
    ...
    },
    {
      ...
      "TransformationUpdates": {
        "Modified Function Implementations": [ "misterio" ]
      }
    },
    {
      "TransformationNumber": 1,
    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_8Dbx_envp": "FUN: '_TIG_IZ_8Dbx_envp__INIT'",
          "_TIG_IZ_8Dbx_argv": "FUN: '_TIG_IZ_8Dbx_argv__INIT'",
          "_TIG_IZ_8Dbx_argc": "FUN: '_TIG_IZ_8Dbx_argc__INIT'"
        }
      }
    },
    {
      ...
      "TransformationUpdates": {
        "New Functions": [
          "main", "misterio", "__uint64_identity", "__uint32_identity",
...
/* BEGIN VARIABLE-DEF _TIG_IZ_8Dbx_argv LOC=UNKNOWN */
char **_TIG_IZ_8Dbx_argv  ;
/* END VARIABLE-DEF _TIG_IZ_8Dbx_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_8Dbx_argc LOC=UNKNOWN */
int _TIG_IZ_8Dbx_argc ;
/* END VARIABLE-DECL _TIG_IZ_8Dbx_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_8Dbx_envp LOC=UNKNOWN */
char **_TIG_IZ_8Dbx_envp ;
/* END VARIABLE-DECL _TIG_IZ_8Dbx_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_8Dbx_envp LOC=UNKNOWN */
char **_TIG_IZ_8Dbx_envp  ;
/* END VARIABLE-DEF _TIG_IZ_8Dbx_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_8Dbx_argv LOC=UNKNOWN */
char **_TIG_IZ_8Dbx_argv ;
/* END VARIABLE-DECL _TIG_IZ_8Dbx_argv LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL misterio LOC=UNKNOWN */
int misterio(int i ) ;
/* END FUNCTION-DECL misterio LOC=UNKNOWN */
...
int main(int _TIG_IZ_8Dbx_formal_argc , char **_TIG_IZ_8Dbx_formal_argv , char **_TIG_IZ_8Dbx_formal_envp ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_8Dbx_argc LOC=UNKNOWN */
int _TIG_IZ_8Dbx_argc  ;
/* END VARIABLE-DEF _TIG_IZ_8Dbx_argc LOC=UNKNOWN */
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_8Dbx_1___uint32_identity_next ;

  {
  {
  _TIG_FN_8Dbx_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_8Dbx_1___bswap_64_next ;

  {
  {
  _TIG_FN_8Dbx_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_8Dbx_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_8Dbx_1___uint16_identity_next ;

  {
  {
  _TIG_FN_8Dbx_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_8Dbx_1___uint64_identity_next ;

  {
  {
  _TIG_FN_8Dbx_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_8Dbx_1___bswap_16_next ;

  {
  {
  _TIG_FN_8Dbx_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___bswap_16_next) {
    case 1UL: ;
...
#line 37
    ...
    {
    _TIG_FN_8Dbx_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
/* BEGIN FUNCTION-DEF misterio LOC=UNKNOWN */
int misterio(int i ) 
{ 
  int tmp ;
  unsigned long _TIG_FN_8Dbx_1_misterio_next ;

  {
  {
  _TIG_FN_8Dbx_1_misterio_next = 8UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1_misterio_next) {
    case 4UL: ;
    return (i);
    break;
    case 8UL: ;
    ...
    case 3: 
    {
    _TIG_FN_8Dbx_1_misterio_next = 1UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_8Dbx_1_misterio_next = 9UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_8Dbx_1_misterio_next = 3UL;
    }
    break;
    case 0: 
    {
    _TIG_FN_8Dbx_1_misterio_next = 4UL;
    }
    break;
    default: 
    {
    _TIG_FN_8Dbx_1_misterio_next = 0UL;
    }
    break;
    }
    break;
    case 1UL: 
#line 15 "pieceofhell_UNI_ADA.c"
    i *= 3;
    {
    _TIG_FN_8Dbx_1_misterio_next = 5UL;
    }
    break;
    case 3UL: 
#line 9
...
#line 20
    tmp = misterio(i % 4);
    {
    _TIG_FN_8Dbx_1_misterio_next = 2UL;
    }
    break;
    case 0UL: 
#line 18
...
/* END FUNCTION-DEF misterio LOC=UNKNOWN */
...
{ 
  ...
  int i ;
  int tmp ;
  unsigned long _TIG_FN_8Dbx_1_main_next ;
  ...
  {
  {
  _TIG_IZ_8Dbx_envp = (char **)0;
  goto _TIG_IZ_8Dbx_envp__INITINLINE__TIG_IZ_8Dbx_envp__INIT;
  }
  _TIG_IZ_8Dbx_envp__INITINLINE__TIG_IZ_8Dbx_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_8Dbx_argv = (char **)0;
  goto _TIG_IZ_8Dbx_argv__INITINLINE__TIG_IZ_8Dbx_argv__INIT;
  }
  _TIG_IZ_8Dbx_argv__INITINLINE__TIG_IZ_8Dbx_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_8Dbx_argc = 0;
  goto _TIG_IZ_8Dbx_argc__INITINLINE__TIG_IZ_8Dbx_argc__INIT;
  }
  _TIG_IZ_8Dbx_argc__INITINLINE__TIG_IZ_8Dbx_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-8Dbx--0":);
    _TIG_IZ_8Dbx_argc = _TIG_IZ_8Dbx_formal_argc;
    _TIG_IZ_8Dbx_argv = _TIG_IZ_8Dbx_formal_argv;
    _TIG_IZ_8Dbx_envp = _TIG_IZ_8Dbx_formal_envp;
    break;
  }
  {
  _TIG_FN_8Dbx_1_main_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1_main_next) {
    case 4UL: 
#line 28
    printf((char const   */* __restrict  */)"Ol\303\241 Mundo!");
    {
    _TIG_FN_8Dbx_1_main_next = 5UL;
    }
    break;
    case 1UL: ;
    {
    _TIG_FN_8Dbx_1_main_next = 2UL;
    }
    break;
    case 6UL: ;
    return (0);
...
#line 31
    ...
    {
    _TIG_FN_8Dbx_1_main_next = 6UL;
    }
    break;
    case 0UL: ;
    if (! (x3 % 3 == 0)) {
      {
      _TIG_FN_8Dbx_1_main_next = 4UL;
      }
    } else {
      {
      _TIG_FN_8Dbx_1_main_next = 5UL;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_8Dbx_1___bswap_32_next ;

  {
  {
  _TIG_FN_8Dbx_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_8Dbx_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_8Dbx_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
