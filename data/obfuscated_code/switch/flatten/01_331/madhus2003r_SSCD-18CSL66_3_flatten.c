    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_gBAw_envp": "FUN: '_TIG_IZ_gBAw_envp__INIT'",
          "_TIG_IZ_gBAw_argv": "FUN: '_TIG_IZ_gBAw_argv__INIT'",
          "_TIG_IZ_gBAw_argc": "FUN: '_TIG_IZ_gBAw_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_gBAw_envp LOC=UNKNOWN */
char **_TIG_IZ_gBAw_envp ;
/* END VARIABLE-DECL _TIG_IZ_gBAw_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_gBAw_argv LOC=UNKNOWN */
char **_TIG_IZ_gBAw_argv ;
/* END VARIABLE-DECL _TIG_IZ_gBAw_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_gBAw_envp LOC=UNKNOWN */
char **_TIG_IZ_gBAw_envp  ;
/* END VARIABLE-DEF _TIG_IZ_gBAw_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_gBAw_argc LOC=UNKNOWN */
int _TIG_IZ_gBAw_argc  ;
/* END VARIABLE-DEF _TIG_IZ_gBAw_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_gBAw_argc LOC=UNKNOWN */
int _TIG_IZ_gBAw_argc ;
/* END VARIABLE-DECL _TIG_IZ_gBAw_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_gBAw_argv LOC=UNKNOWN */
char **_TIG_IZ_gBAw_argv  ;
/* END VARIABLE-DEF _TIG_IZ_gBAw_argv LOC=UNKNOWN */
...
int main(int _TIG_IZ_gBAw_formal_argc , char **_TIG_IZ_gBAw_formal_argv , char **_TIG_IZ_gBAw_formal_envp ) ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_gBAw_1___uint32_identity_next ;

  {
  {
  _TIG_FN_gBAw_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_gBAw_1___uint64_identity_next ;

  {
  {
  _TIG_FN_gBAw_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_gBAw_1___bswap_16_next ;

  {
  {
  _TIG_FN_gBAw_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_gBAw_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_gBAw_1___bswap_32_next ;

  {
  {
  _TIG_FN_gBAw_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___bswap_32_next) {
    case 1UL: ;
...
#line 52
    ...
    {
    _TIG_FN_gBAw_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int i ;
  unsigned long _TIG_FN_gBAw_1_display_next ;

  {
  {
  _TIG_FN_gBAw_1_display_next = 5UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1_display_next) {
    case 4UL: ;
    return;
    break;
    case 1UL: ;
    if (i >= 0) {
      {
      _TIG_FN_gBAw_1_display_next = 3UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_display_next = 4UL;
      }
    }
    break;
    case 3UL: 
#line 24 "madhus2003r_SSCD-18CSL66_3.c"
    printf((char const   */* __restrict  */)"%c", (int )stack[i]);
#line 23
    i --;
    {
    _TIG_FN_gBAw_1_display_next = 1UL;
    }
    break;
    case 5UL: 
#line 23
...
void pop(void) 
{ 
  unsigned long _TIG_FN_gBAw_1_pop_next ;

  {
  {
  _TIG_FN_gBAw_1_pop_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1_pop_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
...
int numr(char c ) 
{ 
  unsigned long _TIG_FN_gBAw_1_numr_next ;

  {
  {
  _TIG_FN_gBAw_1_numr_next = 6UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1_numr_next) {
    case 4UL: ;
    return (2);
    break;
    case 1UL: ;
    ...
    case 64: 
    {
    _TIG_FN_gBAw_1_numr_next = 5UL;
    }
    break;
    case 98: 
    {
    _TIG_FN_gBAw_1_numr_next = 2UL;
    }
    break;
    case 97: 
    {
    _TIG_FN_gBAw_1_numr_next = 0UL;
    }
    break;
    case 66: 
    {
    _TIG_FN_gBAw_1_numr_next = 4UL;
    }
    break;
    case 65: 
    {
    _TIG_FN_gBAw_1_numr_next = 7UL;
    }
    break;
    default: 
    {
    _TIG_FN_gBAw_1_numr_next = 3UL;
    }
    break;
    }
    break;
...
{ 
  ...
  size_t tmp___5 ;
  int tmp___6 ;
  unsigned long _TIG_FN_gBAw_1_main_next ;
  ...
  {
  {
  _TIG_IZ_gBAw_envp = (char **)0;
  goto _TIG_IZ_gBAw_envp__INITINLINE__TIG_IZ_gBAw_envp__INIT;
  }
  _TIG_IZ_gBAw_envp__INITINLINE__TIG_IZ_gBAw_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_gBAw_argv = (char **)0;
  goto _TIG_IZ_gBAw_argv__INITINLINE__TIG_IZ_gBAw_argv__INIT;
  }
  _TIG_IZ_gBAw_argv__INITINLINE__TIG_IZ_gBAw_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_gBAw_argc = 0;
  goto _TIG_IZ_gBAw_argc__INITINLINE__TIG_IZ_gBAw_argc__INIT;
  }
  _TIG_IZ_gBAw_argc__INITINLINE__TIG_IZ_gBAw_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-gBAw--0":);
    _TIG_IZ_gBAw_argc = _TIG_IZ_gBAw_formal_argc;
    _TIG_IZ_gBAw_argv = _TIG_IZ_gBAw_formal_argv;
    _TIG_IZ_gBAw_envp = _TIG_IZ_gBAw_formal_envp;
    break;
  }
  {
  _TIG_FN_gBAw_1_main_next = 71UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1_main_next) {
    case 18UL: 
#line 67
    i ++;
    {
    _TIG_FN_gBAw_1_main_next = 77UL;
    }
    break;
    case 80UL: 
#line 109
...
#line 77
    i = 0;
    {
    _TIG_FN_gBAw_1_main_next = 51UL;
    }
    break;
    case 49UL: ;
    if (i < 3) {
      {
      _TIG_FN_gBAw_1_main_next = 37UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 19UL;
      }
    }
    break;
    case 52UL: 
...
#line 81
    ...
    if ((int )input[i] == 36) {
      {
      _TIG_FN_gBAw_1_main_next = 58UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 63UL;
      }
    }
    break;
    case 14UL: ;
    if ((int )input[i] != 97) {
      {
      _TIG_FN_gBAw_1_main_next = 61UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 17UL;
      }
    }
    break;
    case 15UL: 
#line 140
    ...
    {
    _TIG_FN_gBAw_1_main_next = 2UL;
    }
    break;
    case 56UL: ;
    if ((int )stack[top] == 36) {
      {
      _TIG_FN_gBAw_1_main_next = 30UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 15UL;
      }
    }
    break;
    case 79UL: ;
    if (j >= 3) {
      {
      _TIG_FN_gBAw_1_main_next = 6UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 53UL;
      }
    }
    break;
    case 31UL: ;
    if (j < 4) {
      {
      _TIG_FN_gBAw_1_main_next = 7UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 21UL;
      }
    }
    break;
    case 12UL: 
#line 72
    ...
    {
    _TIG_FN_gBAw_1_main_next = 60UL;
    }
    break;
    case 69UL: ;
    if ((int )stack[top] == (int )input[i]) {
      {
      _TIG_FN_gBAw_1_main_next = 86UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 68UL;
      }
    }
    break;
    case 8UL: 
...
#line 59
    i ++;
    {
    _TIG_FN_gBAw_1_main_next = 55UL;
    }
    break;
    case 81UL: ;
    if ((int )curp[3] == 64) {
      {
      _TIG_FN_gBAw_1_main_next = 11UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 9UL;
      }
    }
    break;
    case 23UL: ;
    ...
    if (i < 3) {
      {
      _TIG_FN_gBAw_1_main_next = 83UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 25UL;
      }
    }
    break;
    case 3UL: 
...
#line 62
    ...
    {
    _TIG_FN_gBAw_1_main_next = 54UL;
    }
    break;
    case 16UL: ;
    if (tmp___6) {
      {
      _TIG_FN_gBAw_1_main_next = 90UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 13UL;
      }
    }
    break;
    case 24UL: ;
...
#line 42
    i ++;
    {
    _TIG_FN_gBAw_1_main_next = 49UL;
    }
    break;
    case 68UL: ;
    if ((int )stack[top] >= 65) {
      {
      _TIG_FN_gBAw_1_main_next = 87UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 53UL;
...
#line 140
    ...
    if ((int )input[i] != 0) {
      {
      _TIG_FN_gBAw_1_main_next = 14UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 39UL;
      }
    }
    break;
    case 19UL: 
...
#line 117
    ...
    {
    _TIG_FN_gBAw_1_main_next = 81UL;
    }
    break;
    case 55UL: ;
    if (i < 3) {
      {
      _TIG_FN_gBAw_1_main_next = 42UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 27UL;
      }
    }
    break;
    case 60UL: 
...
#line 136
    ...
    if (i < 3) {
      {
      _TIG_FN_gBAw_1_main_next = 8UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 38UL;
      }
    }
    break;
    case 75UL: 
...
#line 42
    ...
    if ((int )input[i] != 36) {
      {
      _TIG_FN_gBAw_1_main_next = 10UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 75UL;
      }
    }
    break;
    case 47UL: 
...
#line 98
    printf((char const   */* __restrict  */)"\t\t%s\t", input + i);
    {
    _TIG_FN_gBAw_1_main_next = 69UL;
    }
    break;
    case 91UL: ;
    if (j < 4) {
      {
      _TIG_FN_gBAw_1_main_next = 46UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 18UL;
      }
    }
    break;
    case 37UL: 
...
#line 64
    ...
    if ((int )first[i][0] != 64) {
      {
      _TIG_FN_gBAw_1_main_next = 3UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 41UL;
      }
    }
    break;
    case 46UL: 
#line 70
    ...
    {
    _TIG_FN_gBAw_1_main_next = 23UL;
    }
    break;
    case 39UL: ;
    if ((int )input[i - 1] != 36) {
      {
      _TIG_FN_gBAw_1_main_next = 47UL;
      }
    } else {
      {
      _TIG_FN_gBAw_1_main_next = 26UL;
      }
    }
    break;
    case 83UL: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_gBAw_1___uint16_identity_next ;

  {
  {
  _TIG_FN_gBAw_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_gBAw_1___bswap_64_next ;

  {
  {
  _TIG_FN_gBAw_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_gBAw_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
void push(char item ) 
{ 
  unsigned long _TIG_FN_gBAw_1_push_next ;

  {
  {
  _TIG_FN_gBAw_1_push_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_gBAw_1_push_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: ;
    {
    _TIG_FN_gBAw_1_push_next = 2UL;
    }
    break;
    case 2UL: 
#line 14 "madhus2003r_SSCD-18CSL66_3.c"
    top ++;
#line 14
    stack[top] = item;
    {
    _TIG_FN_gBAw_1_push_next = 1UL;
    }
    break;
    default: 
    break;
