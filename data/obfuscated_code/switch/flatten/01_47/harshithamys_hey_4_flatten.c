    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_93cQ_envp": "FUN: '_TIG_IZ_93cQ_envp__INIT'",
          "_TIG_IZ_93cQ_argv": "FUN: '_TIG_IZ_93cQ_argv__INIT'",
          "_TIG_IZ_93cQ_argc": "FUN: '_TIG_IZ_93cQ_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_93cQ_envp LOC=UNKNOWN */
char **_TIG_IZ_93cQ_envp  ;
/* END VARIABLE-DEF _TIG_IZ_93cQ_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_93cQ_argc LOC=UNKNOWN */
int _TIG_IZ_93cQ_argc  ;
/* END VARIABLE-DEF _TIG_IZ_93cQ_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_93cQ_argv LOC=UNKNOWN */
char **_TIG_IZ_93cQ_argv  ;
/* END VARIABLE-DEF _TIG_IZ_93cQ_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_93cQ_argc LOC=UNKNOWN */
int _TIG_IZ_93cQ_argc ;
/* END VARIABLE-DECL _TIG_IZ_93cQ_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_93cQ_argv LOC=UNKNOWN */
char **_TIG_IZ_93cQ_argv ;
/* END VARIABLE-DECL _TIG_IZ_93cQ_argv LOC=UNKNOWN */
...
void main(int _TIG_IZ_93cQ_formal_argc , char **_TIG_IZ_93cQ_formal_argv , char **_TIG_IZ_93cQ_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_93cQ_envp LOC=UNKNOWN */
char **_TIG_IZ_93cQ_envp ;
/* END VARIABLE-DECL _TIG_IZ_93cQ_envp LOC=UNKNOWN */
...
{ 
  int i ;
  unsigned long _TIG_FN_93cQ_1_display_next ;

  {
  {
  _TIG_FN_93cQ_1_display_next = 6UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1_display_next) {
    case 4UL: ;
    if (i <= rear) {
      {
      _TIG_FN_93cQ_1_display_next = 8UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_display_next = 1UL;
      }
    }
    break;
    case 8UL: 
#line 61 "harshithamys_hey_4.c"
...
#line 60
    i ++;
    {
    _TIG_FN_93cQ_1_display_next = 4UL;
    }
    break;
    case 1UL: ;
    return;
...
#line 58
    ...
    if (front == -1) {
      {
      _TIG_FN_93cQ_1_display_next = 3UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_display_next = 5UL;
      }
    }
    break;
    case 5UL: 
...
{ 
  int info ;
  int pr ;
  unsigned long _TIG_FN_93cQ_1_insert_next ;

  {
  {
  _TIG_FN_93cQ_1_insert_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1_insert_next) {
    case 8UL: 
#line 25
    rear ++;
    {
    _TIG_FN_93cQ_1_insert_next = 10UL;
    }
    break;
    case 1UL: ;
    if (rear == 4) {
      {
      _TIG_FN_93cQ_1_insert_next = 5UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_insert_next = 0UL;
      }
    }
    break;
    case 9UL: ;
    if (rear == -1) {
      {
      _TIG_FN_93cQ_1_insert_next = 2UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_insert_next = 8UL;
      }
    }
    break;
    case 6UL: ;
...
#line 17
    ...
    {
    _TIG_FN_93cQ_1_insert_next = 6UL;
    }
    break;
    case 10UL: 
#line 27
...
#line 20
    ...
    {
    _TIG_FN_93cQ_1_insert_next = 9UL;
    }
    break;
    case 2UL: 
#line 22
...
{ 
  ...
  int pos ;
  int max ;
  unsigned long _TIG_FN_93cQ_1_delete_next ;

  {
  {
  _TIG_FN_93cQ_1_delete_next = 11UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1_delete_next) {
    case 18UL: 
#line 41
    i = front;
    {
    _TIG_FN_93cQ_1_delete_next = 1UL;
    }
    break;
    case 4UL: ;
    if (front == rear) {
      {
      _TIG_FN_93cQ_1_delete_next = 10UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_delete_next = 18UL;
      }
    }
    break;
    case 14UL: 
#line 47
    i = pos;
    {
    _TIG_FN_93cQ_1_delete_next = 8UL;
    }
    break;
    case 12UL: ;
    if (front == -1) {
      {
      _TIG_FN_93cQ_1_delete_next = 13UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_delete_next = 4UL;
      }
    }
    break;
    case 8UL: ;
    if (i <= rear) {
      {
      _TIG_FN_93cQ_1_delete_next = 20UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_delete_next = 7UL;
      }
    }
    break;
    case 1UL: ;
    if (i <= rear) {
      {
      _TIG_FN_93cQ_1_delete_next = 0UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_delete_next = 14UL;
      }
    }
    break;
    case 16UL: 
#line 41
    ...
    case 11UL: ;
    {
    _TIG_FN_93cQ_1_delete_next = 6UL;
    }
    break;
    case 13UL: 
#line 35
    ...
    {
    _TIG_FN_93cQ_1_delete_next = 21UL;
    }
    break;
    case 6UL: 
#line 33
...
#line 33
    max = 0;
    {
    _TIG_FN_93cQ_1_delete_next = 12UL;
    }
    break;
    case 10UL: 
#line 38
...
#line 39
    ...
    if (pjob[i].pr > max) {
      {
      _TIG_FN_93cQ_1_delete_next = 2UL;
      }
    } else {
      {
      _TIG_FN_93cQ_1_delete_next = 16UL;
      }
    }
    break;
    case 7UL: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_93cQ_1___bswap_32_next ;

  {
  {
  _TIG_FN_93cQ_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_93cQ_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int ch ;
  unsigned long _TIG_FN_93cQ_1_main_next ;
  ...
  {
  {
  _TIG_IZ_93cQ_envp = (char **)0;
  goto _TIG_IZ_93cQ_envp__INITINLINE__TIG_IZ_93cQ_envp__INIT;
  }
  _TIG_IZ_93cQ_envp__INITINLINE__TIG_IZ_93cQ_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_93cQ_argv = (char **)0;
  goto _TIG_IZ_93cQ_argv__INITINLINE__TIG_IZ_93cQ_argv__INIT;
  }
  _TIG_IZ_93cQ_argv__INITINLINE__TIG_IZ_93cQ_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_93cQ_argc = 0;
  goto _TIG_IZ_93cQ_argc__INITINLINE__TIG_IZ_93cQ_argc__INIT;
  }
  _TIG_IZ_93cQ_argc__INITINLINE__TIG_IZ_93cQ_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-93cQ--0":);
    _TIG_IZ_93cQ_argc = _TIG_IZ_93cQ_formal_argc;
    _TIG_IZ_93cQ_argv = _TIG_IZ_93cQ_formal_argv;
    _TIG_IZ_93cQ_envp = _TIG_IZ_93cQ_formal_envp;
    break;
  }
  {
  _TIG_FN_93cQ_1_main_next = 13UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1_main_next) {
    case 4UL: 
#line 78 "harshithamys_hey_4.c"
    display();
    {
    _TIG_FN_93cQ_1_main_next = 10UL;
    }
    break;
    case 3UL: 
#line 87
...
#line 81
    ...
    case 4: 
    {
    _TIG_FN_93cQ_1_main_next = 0UL;
    }
    break;
    case 3: 
    {
    _TIG_FN_93cQ_1_main_next = 11UL;
    }
    break;
    case 2: 
    {
    _TIG_FN_93cQ_1_main_next = 4UL;
    }
    break;
    case 1: 
    {
    _TIG_FN_93cQ_1_main_next = 7UL;
    }
    break;
    default: 
    {
    _TIG_FN_93cQ_1_main_next = 3UL;
    }
    break;
    }
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_93cQ_1___uint64_identity_next ;

  {
  {
  _TIG_FN_93cQ_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_93cQ_1___uint16_identity_next ;

  {
  {
  _TIG_FN_93cQ_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_93cQ_1___bswap_16_next ;

  {
  {
  _TIG_FN_93cQ_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_93cQ_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_93cQ_1___bswap_64_next ;

  {
  {
  _TIG_FN_93cQ_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___bswap_64_next) {
    case 1UL: 
#line 73
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_93cQ_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_93cQ_1___uint32_identity_next ;

  {
  {
  _TIG_FN_93cQ_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_93cQ_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
