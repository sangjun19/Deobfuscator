    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_if8Q_envp": "FUN: '_TIG_IZ_if8Q_envp__INIT'",
          "_TIG_IZ_if8Q_argv": "FUN: '_TIG_IZ_if8Q_argv__INIT'",
          "_TIG_IZ_if8Q_argc": "FUN: '_TIG_IZ_if8Q_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_if8Q_argv LOC=UNKNOWN */
char **_TIG_IZ_if8Q_argv  ;
/* END VARIABLE-DEF _TIG_IZ_if8Q_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_if8Q_envp LOC=UNKNOWN */
char **_TIG_IZ_if8Q_envp  ;
/* END VARIABLE-DEF _TIG_IZ_if8Q_envp LOC=UNKNOWN */
...
int main(int _TIG_IZ_if8Q_formal_argc , char **_TIG_IZ_if8Q_formal_argv , char **_TIG_IZ_if8Q_formal_envp ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_if8Q_argc LOC=UNKNOWN */
int _TIG_IZ_if8Q_argc  ;
/* END VARIABLE-DEF _TIG_IZ_if8Q_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_if8Q_argv LOC=UNKNOWN */
char **_TIG_IZ_if8Q_argv ;
/* END VARIABLE-DECL _TIG_IZ_if8Q_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_if8Q_envp LOC=UNKNOWN */
char **_TIG_IZ_if8Q_envp ;
/* END VARIABLE-DECL _TIG_IZ_if8Q_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_if8Q_argc LOC=UNKNOWN */
int _TIG_IZ_if8Q_argc ;
/* END VARIABLE-DECL _TIG_IZ_if8Q_argc LOC=UNKNOWN */
...
{ 
  ...
  __pid_t tmp ;
  int status ;
  unsigned long _TIG_FN_if8Q_1_execute_command_next ;

  {
  {
  _TIG_FN_if8Q_1_execute_command_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1_execute_command_next) {
    case 4UL: ;
    if ((int )((signed char )((status & 0x7f) + 1)) >> 1 > 0) {
      {
      _TIG_FN_if8Q_1_execute_command_next = 3UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_execute_command_next = 9UL;
      }
    }
    break;
    case 12UL: 
#line 33 "hwu-42_minishell_tr2.c"
...
#line 14
    pid = tmp;
    {
    _TIG_FN_if8Q_1_execute_command_next = 6UL;
    }
    break;
    case 3UL: 
#line 35
    ...
    if ((status & 0x7f) == 0) {
      {
      _TIG_FN_if8Q_1_execute_command_next = 12UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_execute_command_next = 4UL;
      }
    }
    break;
    case 9UL: ;
...
#line 26
    ...
    if (pid == -1) {
      {
      _TIG_FN_if8Q_1_execute_command_next = 2UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_execute_command_next = 5UL;
      }
    }
    break;
    case 5UL: ;
    if (pid == 0) {
      {
      _TIG_FN_if8Q_1_execute_command_next = 13UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_execute_command_next = 10UL;
      }
    }
    break;
    case 10UL: 
#line 30
    ...
    {
    _TIG_FN_if8Q_1_execute_command_next = 11UL;
    }
    break;
    case 0UL: ;
    {
    _TIG_FN_if8Q_1_execute_command_next = 1UL;
    }
    break;
    case 2UL: 
#line 17
...
{ 
  int tmp ;
  unsigned long _TIG_FN_if8Q_1___bswap_32_next ;

  {
  {
  _TIG_FN_if8Q_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_if8Q_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_if8Q_1___uint16_identity_next ;

  {
  {
  _TIG_FN_if8Q_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_if8Q_1___uint32_identity_next ;

  {
  {
  _TIG_FN_if8Q_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  ...
  char *tmp___0 ;
  char *tmp___1 ;
  unsigned long _TIG_FN_if8Q_1_expand_dollar_question_next ;

  {
  {
  _TIG_FN_if8Q_1_expand_dollar_question_next = 3UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1_expand_dollar_question_next) {
    case 4UL: ;
    return;
    break;
    case 14UL: 
#line 48 "hwu-42_minishell_tr2.c"
...
#line 50
    pos += 2;
    {
    _TIG_FN_if8Q_1_expand_dollar_question_next = 0UL;
    }
    break;
    case 8UL: 
#line 52
...
#line 52
    *tmp___0 = *tmp___1;
    ...
    if ((int )*(pos + 0) == 36) {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 11UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 8UL;
      }
    }
    break;
    case 3UL: ;
    {
    _TIG_FN_if8Q_1_expand_dollar_question_next = 2UL;
    }
    break;
    case 11UL: ;
    if ((int )*(pos + 1) == 63) {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 14UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 9UL;
      }
    }
    break;
    case 9UL: 
...
#line 57
    ...
    {
    _TIG_FN_if8Q_1_expand_dollar_question_next = 4UL;
    }
    break;
    case 0UL: ;
    if (*pos) {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 1UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_expand_dollar_question_next = 13UL;
      }
    }
    break;
    case 2UL: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_if8Q_1___bswap_64_next ;

  {
  {
  _TIG_FN_if8Q_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_if8Q_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  ...
  size_t tmp___0 ;
  size_t tmp___1 ;
  unsigned long _TIG_FN_if8Q_1_main_next ;
  ...
  {
  {
  _TIG_IZ_if8Q_envp = (char **)0;
  goto _TIG_IZ_if8Q_envp__INITINLINE__TIG_IZ_if8Q_envp__INIT;
  }
  _TIG_IZ_if8Q_envp__INITINLINE__TIG_IZ_if8Q_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_if8Q_argv = (char **)0;
  goto _TIG_IZ_if8Q_argv__INITINLINE__TIG_IZ_if8Q_argv__INIT;
  }
  _TIG_IZ_if8Q_argv__INITINLINE__TIG_IZ_if8Q_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_if8Q_argc = 0;
  goto _TIG_IZ_if8Q_argc__INITINLINE__TIG_IZ_if8Q_argc__INIT;
  }
  _TIG_IZ_if8Q_argc__INITINLINE__TIG_IZ_if8Q_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-if8Q--0":);
    _TIG_IZ_if8Q_argc = _TIG_IZ_if8Q_formal_argc;
    _TIG_IZ_if8Q_argv = _TIG_IZ_if8Q_formal_argv;
    _TIG_IZ_if8Q_envp = _TIG_IZ_if8Q_formal_envp;
    break;
  }
  {
  _TIG_FN_if8Q_1_main_next = 10UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1_main_next) {
    case 8UL: 
#line 72 "hwu-42_minishell_tr2.c"
...
#line 78
    ...
    {
    _TIG_FN_if8Q_1_main_next = 1UL;
    }
    break;
    case 1UL: ;
    if (tmp___1 > 0UL) {
      {
      _TIG_FN_if8Q_1_main_next = 2UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_main_next = 7UL;
      }
    }
    break;
    case 9UL: 
...
#line 68
    ...
    if ((unsigned long )tmp == (unsigned long )((void *)0)) {
      {
      _TIG_FN_if8Q_1_main_next = 9UL;
      }
    } else {
      {
      _TIG_FN_if8Q_1_main_next = 8UL;
      }
    }
    break;
    case 10UL: ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_if8Q_1___uint64_identity_next ;

  {
  {
  _TIG_FN_if8Q_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_if8Q_1___bswap_16_next ;

  {
  {
  _TIG_FN_if8Q_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_if8Q_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_if8Q_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
