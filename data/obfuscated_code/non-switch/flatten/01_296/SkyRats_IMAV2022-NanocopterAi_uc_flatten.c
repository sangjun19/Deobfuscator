    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_mo9M_envp": "FUN: '_TIG_IZ_mo9M_envp__INIT'",
          "_TIG_IZ_mo9M_argv": "FUN: '_TIG_IZ_mo9M_argv__INIT'",
          "_TIG_IZ_mo9M_argc": "FUN: '_TIG_IZ_mo9M_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_mo9M_argv LOC=UNKNOWN */
char **_TIG_IZ_mo9M_argv ;
/* END VARIABLE-DECL _TIG_IZ_mo9M_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_mo9M_argc LOC=UNKNOWN */
int _TIG_IZ_mo9M_argc  ;
/* END VARIABLE-DEF _TIG_IZ_mo9M_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_mo9M_argc LOC=UNKNOWN */
int _TIG_IZ_mo9M_argc ;
/* END VARIABLE-DECL _TIG_IZ_mo9M_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_mo9M_argv LOC=UNKNOWN */
char **_TIG_IZ_mo9M_argv  ;
/* END VARIABLE-DEF _TIG_IZ_mo9M_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_mo9M_envp LOC=UNKNOWN */
char **_TIG_IZ_mo9M_envp  ;
/* END VARIABLE-DEF _TIG_IZ_mo9M_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_mo9M_envp LOC=UNKNOWN */
char **_TIG_IZ_mo9M_envp ;
/* END VARIABLE-DECL _TIG_IZ_mo9M_envp LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_mo9M_formal_envp ) ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_mo9M_1___uint64_identity_next ;

  {
  {
  _TIG_FN_mo9M_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int result ;
  unsigned long _TIG_FN_mo9M_1_is_empty_next ;

  {
  {
  _TIG_FN_mo9M_1_is_empty_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_is_empty_next) {
    case 1UL: 
#line 250 "SkyRats_IMAV2022-NanocopterAi_uc.c"
    result = 1;
    {
    _TIG_FN_mo9M_1_is_empty_next = 3UL;
    }
    break;
    case 3UL: ;
    return (result);
    ...
    if ((unsigned long )head == (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_is_empty_next = 1UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_is_empty_next = 3UL;
...
#line 248
    result = 0;
    {
    _TIG_FN_mo9M_1_is_empty_next = 0UL;
    }
    break;
    default: 
    break;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_mo9M_1___bswap_64_next ;

  {
  {
  _TIG_FN_mo9M_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_mo9M_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_mo9M_1___bswap_32_next ;

  {
  {
  _TIG_FN_mo9M_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___bswap_32_next) {
    case 1UL: ;
...
#line 52
    ...
    {
    _TIG_FN_mo9M_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  struct node *temp ;
  unsigned long _TIG_FN_mo9M_1_free_nodes_in_list_next ;

  {
  {
  _TIG_FN_mo9M_1_free_nodes_in_list_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_free_nodes_in_list_next) {
    case 4UL: 
#line 235 "SkyRats_IMAV2022-NanocopterAi_uc.c"
    printf((char const   */* __restrict  */)"\n\nFreeing nodes in a list");
    {
    _TIG_FN_mo9M_1_free_nodes_in_list_next = 5UL;
    }
    break;
    case 1UL: 
#line 237
...
#line 240
    ...
    if ((unsigned long )head != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_free_nodes_in_list_next = 1UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_free_nodes_in_list_next = 3UL;
      }
    }
    break;
    default: 
...
void print_usage(void) 
{ 
  unsigned long _TIG_FN_mo9M_1_print_usage_next ;

  {
  {
  _TIG_FN_mo9M_1_print_usage_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_print_usage_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
#line 442
    printf((char const   */* __restrict  */)"\nusage: uc goal-node\n");
    {
    _TIG_FN_mo9M_1_print_usage_next = 1UL;
    }
    break;
    default: 
    break;
...
int no_solution_exists(int *searching ) 
{ 
  unsigned long _TIG_FN_mo9M_1_no_solution_exists_next ;

  {
  {
  _TIG_FN_mo9M_1_no_solution_exists_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_no_solution_exists_next) {
    case 1UL: 
#line 258
    *searching = 0;
#line 259
    ...
    {
    _TIG_FN_mo9M_1_no_solution_exists_next = 0UL;
    }
    break;
    case 0UL: ;
    return (1);
    ...
    case 2UL: ;
    {
    _TIG_FN_mo9M_1_no_solution_exists_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  struct node *temp ;
  unsigned long _TIG_FN_mo9M_1_traverse_list_next ;

  {
  {
  _TIG_FN_mo9M_1_traverse_list_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_traverse_list_next) {
    case 4UL: 
#line 457
    printf((char const   */* __restrict  */)"\n\n");
    {
    _TIG_FN_mo9M_1_traverse_list_next = 5UL;
    }
    break;
    case 1UL: 
#line 453
...
#line 455
    head = temp->next;
    {
    _TIG_FN_mo9M_1_traverse_list_next = 3UL;
    }
    break;
    case 3UL: ;
    if ((unsigned long )head != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_traverse_list_next = 1UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_traverse_list_next = 4UL;
      }
    }
    break;
    case 5UL: ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_mo9M_1___uint32_identity_next ;

  {
  {
  _TIG_FN_mo9M_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  ...
  int tmp ;
  int tmp___0 ;
  unsigned long _TIG_FN_mo9M_1_main_next ;
  ...
  {
  {
  _TIG_IZ_mo9M_envp = (char **)0;
  goto _TIG_IZ_mo9M_envp__INITINLINE__TIG_IZ_mo9M_envp__INIT;
  }
  _TIG_IZ_mo9M_envp__INITINLINE__TIG_IZ_mo9M_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_mo9M_argv = (char **)0;
  goto _TIG_IZ_mo9M_argv__INITINLINE__TIG_IZ_mo9M_argv__INIT;
  }
  _TIG_IZ_mo9M_argv__INITINLINE__TIG_IZ_mo9M_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_mo9M_argc = 0;
  goto _TIG_IZ_mo9M_argc__INITINLINE__TIG_IZ_mo9M_argc__INIT;
  }
  _TIG_IZ_mo9M_argc__INITINLINE__TIG_IZ_mo9M_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-mo9M--0":);
    _TIG_IZ_mo9M_argc = argc;
    _TIG_IZ_mo9M_argv = argv;
    _TIG_IZ_mo9M_envp = _TIG_IZ_mo9M_formal_envp;
    break;
  }
  {
  _TIG_FN_mo9M_1_main_next = 32UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_main_next) {
    case 18UL: ;
    if (cost != -1) {
      {
      _TIG_FN_mo9M_1_main_next = 15UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 1UL;
      }
    }
    break;
    case 25UL: ;
    if (searching) {
      {
      _TIG_FN_mo9M_1_main_next = 29UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 7UL;
      }
    }
    break;
    case 30UL: ;
...
#line 144
    i = 0;
    {
    _TIG_FN_mo9M_1_main_next = 31UL;
    }
    break;
    case 15UL: ;
    if ((unsigned long )n->parent == (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_main_next = 28UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 30UL;
      }
    }
    break;
    case 31UL: ;
    if (i < 10) {
      {
      _TIG_FN_mo9M_1_main_next = 12UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 25UL;
      }
    }
    break;
    case 12UL: 
...
#line 134
    ...
    if (tmp) {
      {
      _TIG_FN_mo9M_1_main_next = 6UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 14UL;
      }
    }
    break;
    case 22UL: 
...
#line 159
    ...
    if (tmp___0) {
      {
      _TIG_FN_mo9M_1_main_next = 23UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 17UL;
      }
    }
    break;
    case 7UL: 
...
#line 112
    ...
    {
    _TIG_FN_mo9M_1_main_next = 0UL;
    }
    break;
    case 2UL: ;
    if (argc < 2) {
      {
      _TIG_FN_mo9M_1_main_next = 16UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_main_next = 22UL;
      }
    }
    break;
    default: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_mo9M_1___uint16_identity_next ;

  {
  {
  _TIG_FN_mo9M_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int result ;
  unsigned long _TIG_FN_mo9M_1_is_a_goal_node_next ;

  {
  {
  _TIG_FN_mo9M_1_is_a_goal_node_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_is_a_goal_node_next) {
    case 1UL: 
#line 382
    result = 0;
    {
    _TIG_FN_mo9M_1_is_a_goal_node_next = 3UL;
    }
    break;
    case 3UL: ;
    if (n->number == goal) {
      {
      _TIG_FN_mo9M_1_is_a_goal_node_next = 0UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_is_a_goal_node_next = 2UL;
      }
    }
    break;
    case 0UL: 
...
{ 
  struct node *temp ;
  unsigned long _TIG_FN_mo9M_1_solution_found_next ;

  {
  {
  _TIG_FN_mo9M_1_solution_found_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_solution_found_next) {
    case 4UL: ;
    {
    _TIG_FN_mo9M_1_solution_found_next = 0UL;
    }
    break;
    case 1UL: ;
    if ((unsigned long )temp != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_solution_found_next = 2UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_solution_found_next = 6UL;
      }
    }
    break;
    case 6UL: ;
...
#line 399
    ...
    {
    _TIG_FN_mo9M_1_solution_found_next = 1UL;
    }
    break;
    case 2UL: 
#line 401
...
{ 
  struct node *new ;
  void *tmp ;
  unsigned long _TIG_FN_mo9M_1_create_new_node_next ;

  {
  {
  _TIG_FN_mo9M_1_create_new_node_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_create_new_node_next) {
    case 1UL: 
#line 426
...
#line 431
    ...
    {
    _TIG_FN_mo9M_1_create_new_node_next = 0UL;
    }
    break;
    case 0UL: ;
    return (new);
    ...
    case 2UL: ;
    {
    _TIG_FN_mo9M_1_create_new_node_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_mo9M_1___bswap_16_next ;

  {
  {
  _TIG_FN_mo9M_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_mo9M_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
void print_node(struct node *a ) 
{ 
  unsigned long _TIG_FN_mo9M_1_print_node_next ;

  {
  {
  _TIG_FN_mo9M_1_print_node_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_print_node_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
#line 268 "SkyRats_IMAV2022-NanocopterAi_uc.c"
    printf((char const   */* __restrict  */)"\nNode number=%d cost=%d", a->number,
           a->cost);
    {
    _TIG_FN_mo9M_1_print_node_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  ...
  struct node *result ;
  int tmp ;
  unsigned long _TIG_FN_mo9M_1_remove_from_list_next ;

  {
  {
  _TIG_FN_mo9M_1_remove_from_list_next = 22UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_remove_from_list_next) {
    case 25UL: ;
    if (temp->cost < min) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 23UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 12UL;
      }
    }
    break;
    case 30UL: 
...
#line 290
    min_number = 0;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 36UL;
    }
    break;
    case 14UL: 
#line 358
...
#line 361
    ...
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 11UL;
    }
    break;
    case 31UL: ;
    if ((unsigned long )temp == (unsigned long )result) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 32UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 34UL;
      }
    }
    break;
    case 12UL: 
#line 318
    temp = temp->next;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 5UL;
    }
    break;
    case 8UL: 
#line 310
    ...
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 21UL;
    }
    break;
    case 1UL: ;
    if ((unsigned long )temp != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 7UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 29UL;
      }
    }
    break;
    case 23UL: 
...
#line 315
    ...
    if ((unsigned long )temp->next == (unsigned long )result) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 14UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 11UL;
...
#line 330
    temp = *head;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 1UL;
    }
    break;
    case 21UL: ;
    if (tmp) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 6UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 12UL;
    ...
    if ((unsigned long )*head == (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 2UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 16UL;
      }
    }
    break;
    case 11UL: ;
    if (done != 1) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 20UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 34UL;
...
#line 335
    result = temp;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 17UL;
    }
    break;
    case 32UL: 
#line 354
    *head = result->next;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 33UL;
    }
    break;
    case 17UL: 
#line 337
...
#line 311
    goal_found = 1;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 25UL;
    }
    break;
    case 34UL: ;
    if ((unsigned long )temp != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 3UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 33UL;
    ...
    case 22UL: ;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 30UL;
    }
    break;
    case 28UL: ;
    if (goal_found == 0) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 24UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 29UL;
    ...
    if ((unsigned long )temp != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 8UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 28UL;
      }
    }
    break;
    case 33UL: ;
    ...
    if (temp->cost < min) {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 13UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_remove_from_list_next = 17UL;
...
#line 351
    temp = *head;
    {
    _TIG_FN_mo9M_1_remove_from_list_next = 31UL;
    }
    break;
    case 2UL: 
#line 294
...
{ 
  struct node *temp ;
  unsigned long _TIG_FN_mo9M_1_add_to_list_next ;

  {
  {
  _TIG_FN_mo9M_1_add_to_list_next = 3UL;
  }
  while (1) {
    switch (_TIG_FN_mo9M_1_add_to_list_next) {
    case 8UL: 
#line 222
    temp->next = *new;
    {
    _TIG_FN_mo9M_1_add_to_list_next = 1UL;
    }
    break;
    case 1UL: 
#line 225
    (*new)->next = (struct node *)((void *)0);
    {
    _TIG_FN_mo9M_1_add_to_list_next = 7UL;
    }
    break;
    case 3UL: ;
    if ((unsigned long )*head == (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_add_to_list_next = 6UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_add_to_list_next = 5UL;
      }
    }
    break;
    case 9UL: 
#line 221
    temp = temp->next;
    {
    _TIG_FN_mo9M_1_add_to_list_next = 2UL;
    }
    break;
    case 6UL: 
#line 217
...
#line 219
    ...
    if ((unsigned long )temp->next != (unsigned long )((void *)0)) {
      {
      _TIG_FN_mo9M_1_add_to_list_next = 9UL;
      }
    } else {
      {
      _TIG_FN_mo9M_1_add_to_list_next = 8UL;
      }
    }
    break;
    default: 
