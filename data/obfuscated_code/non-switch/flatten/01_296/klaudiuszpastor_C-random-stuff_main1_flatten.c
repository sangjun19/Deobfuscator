    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_w0Jl_envp": "FUN: '_TIG_IZ_w0Jl_envp__INIT'",
          "_TIG_IZ_w0Jl_argv": "FUN: '_TIG_IZ_w0Jl_argv__INIT'",
          "_TIG_IZ_w0Jl_argc": "FUN: '_TIG_IZ_w0Jl_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_w0Jl_argc LOC=UNKNOWN */
int _TIG_IZ_w0Jl_argc  ;
/* END VARIABLE-DEF _TIG_IZ_w0Jl_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_w0Jl_envp LOC=UNKNOWN */
char **_TIG_IZ_w0Jl_envp ;
/* END VARIABLE-DECL _TIG_IZ_w0Jl_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_w0Jl_argv LOC=UNKNOWN */
char **_TIG_IZ_w0Jl_argv ;
/* END VARIABLE-DECL _TIG_IZ_w0Jl_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_w0Jl_argv LOC=UNKNOWN */
char **_TIG_IZ_w0Jl_argv  ;
/* END VARIABLE-DEF _TIG_IZ_w0Jl_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_w0Jl_envp LOC=UNKNOWN */
char **_TIG_IZ_w0Jl_envp  ;
/* END VARIABLE-DEF _TIG_IZ_w0Jl_envp LOC=UNKNOWN */
...
int main(int _TIG_IZ_w0Jl_formal_argc , char **_TIG_IZ_w0Jl_formal_argv , char **_TIG_IZ_w0Jl_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_w0Jl_argc LOC=UNKNOWN */
int _TIG_IZ_w0Jl_argc ;
/* END VARIABLE-DECL _TIG_IZ_w0Jl_argc LOC=UNKNOWN */
...
{ 
  short tmp ;
  unsigned long _TIG_FN_w0Jl_1___bswap_16_next ;

  {
  {
  _TIG_FN_w0Jl_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_w0Jl_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_w0Jl_1___uint64_identity_next ;

  {
  {
  _TIG_FN_w0Jl_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_w0Jl_1___uint16_identity_next ;

  {
  {
  _TIG_FN_w0Jl_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
void fun(int a ) 
{ 
  unsigned long _TIG_FN_w0Jl_1_fun_next ;

  {
  {
  _TIG_FN_w0Jl_1_fun_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1_fun_next) {
    case 1UL: ;
    return;
    break;
    case 0UL: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_w0Jl_1___uint32_identity_next ;

  {
  {
  _TIG_FN_w0Jl_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_w0Jl_1___bswap_32_next ;

  {
  {
  _TIG_FN_w0Jl_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_w0Jl_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  void (*fun_ptr)(int  ) ;
  unsigned long _TIG_FN_w0Jl_1_main_next ;
  ...
  {
  {
  _TIG_IZ_w0Jl_envp = (char **)0;
  goto _TIG_IZ_w0Jl_envp__INITINLINE__TIG_IZ_w0Jl_envp__INIT;
  }
  _TIG_IZ_w0Jl_envp__INITINLINE__TIG_IZ_w0Jl_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_w0Jl_argv = (char **)0;
  goto _TIG_IZ_w0Jl_argv__INITINLINE__TIG_IZ_w0Jl_argv__INIT;
  }
  _TIG_IZ_w0Jl_argv__INITINLINE__TIG_IZ_w0Jl_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_w0Jl_argc = 0;
  goto _TIG_IZ_w0Jl_argc__INITINLINE__TIG_IZ_w0Jl_argc__INIT;
  }
  _TIG_IZ_w0Jl_argc__INITINLINE__TIG_IZ_w0Jl_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-w0Jl--0":);
    _TIG_IZ_w0Jl_argc = _TIG_IZ_w0Jl_formal_argc;
    _TIG_IZ_w0Jl_argv = _TIG_IZ_w0Jl_formal_argv;
    _TIG_IZ_w0Jl_envp = _TIG_IZ_w0Jl_formal_envp;
    break;
  }
  {
  _TIG_FN_w0Jl_1_main_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1_main_next) {
    case 1UL: ;
    {
    _TIG_FN_w0Jl_1_main_next = 0UL;
    }
    break;
    case 0UL: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_w0Jl_1___bswap_64_next ;

  {
  {
  _TIG_FN_w0Jl_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_w0Jl_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_w0Jl_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
