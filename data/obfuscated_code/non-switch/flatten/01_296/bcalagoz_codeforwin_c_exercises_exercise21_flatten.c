    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_CM1N_envp": "FUN: '_TIG_IZ_CM1N_envp__INIT'",
          "_TIG_IZ_CM1N_argv": "FUN: '_TIG_IZ_CM1N_argv__INIT'",
          "_TIG_IZ_CM1N_argc": "FUN: '_TIG_IZ_CM1N_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_CM1N_argc LOC=UNKNOWN */
int _TIG_IZ_CM1N_argc ;
/* END VARIABLE-DECL _TIG_IZ_CM1N_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_CM1N_envp LOC=UNKNOWN */
char **_TIG_IZ_CM1N_envp ;
/* END VARIABLE-DECL _TIG_IZ_CM1N_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_CM1N_envp LOC=UNKNOWN */
char **_TIG_IZ_CM1N_envp  ;
/* END VARIABLE-DEF _TIG_IZ_CM1N_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_CM1N_argv LOC=UNKNOWN */
char **_TIG_IZ_CM1N_argv ;
/* END VARIABLE-DECL _TIG_IZ_CM1N_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_CM1N_argv LOC=UNKNOWN */
char **_TIG_IZ_CM1N_argv  ;
/* END VARIABLE-DEF _TIG_IZ_CM1N_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_CM1N_argc LOC=UNKNOWN */
int _TIG_IZ_CM1N_argc  ;
/* END VARIABLE-DEF _TIG_IZ_CM1N_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_CM1N_formal_argc , char **_TIG_IZ_CM1N_formal_argv , char **_TIG_IZ_CM1N_formal_envp ) ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_CM1N_1___uint64_identity_next ;

  {
  {
  _TIG_FN_CM1N_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_CM1N_1___bswap_16_next ;

  {
  {
  _TIG_FN_CM1N_1___bswap_16_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___bswap_16_next) {
    case 1UL: ;
...
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_CM1N_1___bswap_16_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_CM1N_1___bswap_32_next ;

  {
  {
  _TIG_FN_CM1N_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___bswap_32_next) {
    case 1UL: 
#line 52
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_CM1N_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int j ;
  int k ;
  unsigned long _TIG_FN_CM1N_1_main_next ;
  ...
  {
  {
  _TIG_IZ_CM1N_envp = (char **)0;
  goto _TIG_IZ_CM1N_envp__INITINLINE__TIG_IZ_CM1N_envp__INIT;
  }
  _TIG_IZ_CM1N_envp__INITINLINE__TIG_IZ_CM1N_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_CM1N_argv = (char **)0;
  goto _TIG_IZ_CM1N_argv__INITINLINE__TIG_IZ_CM1N_argv__INIT;
  }
  _TIG_IZ_CM1N_argv__INITINLINE__TIG_IZ_CM1N_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_CM1N_argc = 0;
  goto _TIG_IZ_CM1N_argc__INITINLINE__TIG_IZ_CM1N_argc__INIT;
  }
  _TIG_IZ_CM1N_argc__INITINLINE__TIG_IZ_CM1N_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-CM1N--0":);
    _TIG_IZ_CM1N_argc = _TIG_IZ_CM1N_formal_argc;
    _TIG_IZ_CM1N_argv = _TIG_IZ_CM1N_formal_argv;
    _TIG_IZ_CM1N_envp = _TIG_IZ_CM1N_formal_envp;
    break;
  }
  {
  _TIG_FN_CM1N_1_main_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1_main_next) {
    case 18UL: 
#line 30 "bcalagoz_codeforwin_c_exercises_exercise21.c"
    i ++;
    {
    _TIG_FN_CM1N_1_main_next = 9UL;
    }
    break;
    case 4UL: ;
    if (k <= star) {
      {
      _TIG_FN_CM1N_1_main_next = 16UL;
      }
    } else {
      {
      _TIG_FN_CM1N_1_main_next = 2UL;
      }
    }
    break;
    case 14UL: 
...
#line 37
    k ++;
    {
    _TIG_FN_CM1N_1_main_next = 4UL;
    }
    break;
    case 11UL: ;
    if (i < n) {
      {
      _TIG_FN_CM1N_1_main_next = 22UL;
      }
    } else {
      {
      _TIG_FN_CM1N_1_main_next = 14UL;
      }
    }
    break;
    case 9UL: ;
    if (i < n * 2) {
      {
      _TIG_FN_CM1N_1_main_next = 3UL;
      }
    } else {
      {
      _TIG_FN_CM1N_1_main_next = 5UL;
      }
    }
    break;
    case 19UL: 
...
#line 47
    ...
    if (j <= spaces) {
      {
      _TIG_FN_CM1N_1_main_next = 19UL;
      }
    } else {
      {
      _TIG_FN_CM1N_1_main_next = 20UL;
      }
    }
    break;
    case 0UL: 
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_CM1N_1___uint16_identity_next ;

  {
  {
  _TIG_FN_CM1N_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_CM1N_1___bswap_64_next ;

  {
  {
  _TIG_FN_CM1N_1___bswap_64_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___bswap_64_next) {
    case 1UL: 
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap64((long )__bsx);
    {
    _TIG_FN_CM1N_1___bswap_64_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_CM1N_1___uint32_identity_next ;

  {
  {
  _TIG_FN_CM1N_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_CM1N_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
