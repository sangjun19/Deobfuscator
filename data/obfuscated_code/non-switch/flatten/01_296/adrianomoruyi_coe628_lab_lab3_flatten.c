    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_igTf_envp": "FUN: '_TIG_IZ_igTf_envp__INIT'",
          "_TIG_IZ_igTf_argv": "FUN: '_TIG_IZ_igTf_argv__INIT'",
          "_TIG_IZ_igTf_argc": "FUN: '_TIG_IZ_igTf_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_igTf_envp LOC=UNKNOWN */
char **_TIG_IZ_igTf_envp ;
/* END VARIABLE-DECL _TIG_IZ_igTf_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_igTf_envp LOC=UNKNOWN */
char **_TIG_IZ_igTf_envp  ;
/* END VARIABLE-DEF _TIG_IZ_igTf_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_igTf_argc LOC=UNKNOWN */
int _TIG_IZ_igTf_argc ;
/* END VARIABLE-DECL _TIG_IZ_igTf_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_igTf_formal_argc , char **_TIG_IZ_igTf_formal_argv , char **_TIG_IZ_igTf_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_igTf_argv LOC=UNKNOWN */
char **_TIG_IZ_igTf_argv ;
/* END VARIABLE-DECL _TIG_IZ_igTf_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_igTf_argv LOC=UNKNOWN */
char **_TIG_IZ_igTf_argv  ;
/* END VARIABLE-DEF _TIG_IZ_igTf_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_igTf_argc LOC=UNKNOWN */
int _TIG_IZ_igTf_argc  ;
/* END VARIABLE-DEF _TIG_IZ_igTf_argc LOC=UNKNOWN */
...
{ 
  short tmp ;
  unsigned long _TIG_FN_igTf_1___bswap_16_next ;

  {
  {
  _TIG_FN_igTf_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_igTf_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_igTf_1___uint64_identity_next ;

  {
  {
  _TIG_FN_igTf_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_igTf_1___uint32_identity_next ;

  {
  {
  _TIG_FN_igTf_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int tmp ;
  unsigned long _TIG_FN_igTf_1___bswap_32_next ;

  {
  {
  _TIG_FN_igTf_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___bswap_32_next) {
    case 1UL: 
#line 52
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_igTf_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  __pid_t tmp ;
  int tmp___0 ;
  unsigned long _TIG_FN_igTf_1_execute_command_next ;

  {
  {
  _TIG_FN_igTf_1_execute_command_next = 3UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1_execute_command_next) {
    case 4UL: 
    _L: /* CIL Label */ ;
    if (! background) {
      {
      _TIG_FN_igTf_1_execute_command_next = 11UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_execute_command_next = 12UL;
      }
    }
    break;
    case 12UL: ;
    ...
    if (pid < 0) {
      {
      _TIG_FN_igTf_1_execute_command_next = 10UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_execute_command_next = 2UL;
      }
    }
    break;
    case 1UL: 
#line 46 "adrianomoruyi_coe628_lab_lab3.c"
    ...
    {
    _TIG_FN_igTf_1_execute_command_next = 6UL;
    }
    break;
    case 3UL: ;
    {
    _TIG_FN_igTf_1_execute_command_next = 13UL;
    }
    break;
    case 11UL: 
#line 55
...
#line 38
    pid = tmp;
    {
    _TIG_FN_igTf_1_execute_command_next = 8UL;
    }
    break;
    case 6UL: ;
    if (tmp___0 < 0) {
      {
      _TIG_FN_igTf_1_execute_command_next = 7UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_execute_command_next = 4UL;
      }
    }
    break;
    case 10UL: 
...
#line 49
    ...
    if (pid == 0) {
      {
      _TIG_FN_igTf_1_execute_command_next = 1UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_execute_command_next = 4UL;
...
{ 
  ...
  int tmp___0 ;
  int tmp___1 ;
  unsigned long _TIG_FN_igTf_1_parse_input_next ;

  {
  {
  _TIG_FN_igTf_1_parse_input_next = 6UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1_parse_input_next) {
    case 12UL: 
#line 12
    i = 0;
#line 13
...
#line 16
    token = tmp;
    {
    _TIG_FN_igTf_1_parse_input_next = 1UL;
    }
    break;
    case 8UL: 
#line 31
    *(args + i) = (char *)((void *)0);
    {
    _TIG_FN_igTf_1_parse_input_next = 10UL;
    }
    break;
    case 1UL: ;
    if ((unsigned long )token != (unsigned long )((void *)0)) {
      {
      _TIG_FN_igTf_1_parse_input_next = 3UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_parse_input_next = 5UL;
      }
    }
    break;
    case 3UL: 
...
#line 20
    ...
    if (tmp___1 == 0) {
      {
      _TIG_FN_igTf_1_parse_input_next = 2UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_parse_input_next = 13UL;
      }
    }
    break;
    case 13UL: 
#line 31
    *(args + i) = (char *)((void *)0);
    ...
    case 6UL: ;
    {
    _TIG_FN_igTf_1_parse_input_next = 12UL;
    }
    break;
    case 5UL: ;
    if (i > 0) {
      {
      _TIG_FN_igTf_1_parse_input_next = 7UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_parse_input_next = 8UL;
      }
    }
    break;
    case 10UL: ;
...
#line 24
    ...
    {
    _TIG_FN_igTf_1_parse_input_next = 11UL;
    }
    break;
    case 2UL: 
#line 26
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_igTf_1___uint16_identity_next ;

  {
  {
  _TIG_FN_igTf_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  long tmp ;
  unsigned long _TIG_FN_igTf_1___bswap_64_next ;

  {
  {
  _TIG_FN_igTf_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_igTf_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  ...
  char *tmp ;
  int tmp___0 ;
  unsigned long _TIG_FN_igTf_1_main_next ;
  ...
  {
  {
  _TIG_IZ_igTf_envp = (char **)0;
  goto _TIG_IZ_igTf_envp__INITINLINE__TIG_IZ_igTf_envp__INIT;
  }
  _TIG_IZ_igTf_envp__INITINLINE__TIG_IZ_igTf_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_igTf_argv = (char **)0;
  goto _TIG_IZ_igTf_argv__INITINLINE__TIG_IZ_igTf_argv__INIT;
  }
  _TIG_IZ_igTf_argv__INITINLINE__TIG_IZ_igTf_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_igTf_argc = 0;
  goto _TIG_IZ_igTf_argc__INITINLINE__TIG_IZ_igTf_argc__INIT;
  }
  _TIG_IZ_igTf_argc__INITINLINE__TIG_IZ_igTf_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-igTf--0":);
    _TIG_IZ_igTf_argc = _TIG_IZ_igTf_formal_argc;
    _TIG_IZ_igTf_argv = _TIG_IZ_igTf_formal_argv;
    _TIG_IZ_igTf_envp = _TIG_IZ_igTf_formal_envp;
    break;
  }
  {
  _TIG_FN_igTf_1_main_next = 3UL;
  }
  while (1) {
    switch (_TIG_FN_igTf_1_main_next) {
    case 8UL: 
...
#line 96
    ...
    {
    _TIG_FN_igTf_1_main_next = 10UL;
    }
    break;
    case 13UL: ;
    if (tmp___0 == 0) {
      {
      _TIG_FN_igTf_1_main_next = 11UL;
      }
    } else {
      {
      _TIG_FN_igTf_1_main_next = 1UL;
      }
    }
    break;
    case 6UL: ;
