    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_3XIs_envp": "FUN: '_TIG_IZ_3XIs_envp__INIT'",
          "_TIG_IZ_3XIs_argv": "FUN: '_TIG_IZ_3XIs_argv__INIT'",
          "_TIG_IZ_3XIs_argc": "FUN: '_TIG_IZ_3XIs_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN STRUCT-DECL tree LOC=AsishGokarakonda_dsaProject_3.c:4 */
#line 4 "AsishGokarakonda_dsaProject_3.c"
struct tree ;
/* END STRUCT-DECL tree LOC=AsishGokarakonda_dsaProject_3.c:4 */
...
/* BEGIN TYPEDEF grid LOC=AsishGokarakonda_dsaProject_3.c:4 */
#line 4 "AsishGokarakonda_dsaProject_3.c"
typedef struct tree grid;
/* END TYPEDEF grid LOC=AsishGokarakonda_dsaProject_3.c:4 */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_3XIs_argc LOC=UNKNOWN */
int _TIG_IZ_3XIs_argc  ;
/* END VARIABLE-DEF _TIG_IZ_3XIs_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_3XIs_argv LOC=UNKNOWN */
char **_TIG_IZ_3XIs_argv ;
/* END VARIABLE-DECL _TIG_IZ_3XIs_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_3XIs_envp LOC=UNKNOWN */
char **_TIG_IZ_3XIs_envp  ;
/* END VARIABLE-DEF _TIG_IZ_3XIs_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_3XIs_argv LOC=UNKNOWN */
char **_TIG_IZ_3XIs_argv  ;
/* END VARIABLE-DEF _TIG_IZ_3XIs_argv LOC=UNKNOWN */
...
/* BEGIN STRUCT tree LOC=AsishGokarakonda_dsaProject_3.c:4 */
#line 4 "AsishGokarakonda_dsaProject_3.c"
struct tree {
   int x ;
   int y ;
...
/* END STRUCT tree LOC=AsishGokarakonda_dsaProject_3.c:4 */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_3XIs_argc LOC=UNKNOWN */
int _TIG_IZ_3XIs_argc ;
/* END VARIABLE-DECL _TIG_IZ_3XIs_argc LOC=UNKNOWN */
...
int main(int _TIG_IZ_3XIs_formal_argc , char **_TIG_IZ_3XIs_formal_argv , char **_TIG_IZ_3XIs_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_3XIs_envp LOC=UNKNOWN */
char **_TIG_IZ_3XIs_envp ;
/* END VARIABLE-DECL _TIG_IZ_3XIs_envp LOC=UNKNOWN */
...
{ 
  ...
  int j ;
  int min ;
  unsigned long _TIG_FN_3XIs_1_distance_next ;

  {
  {
  _TIG_FN_3XIs_1_distance_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1_distance_next) {
    case 25UL: ;
    if (j < n) {
      {
      _TIG_FN_3XIs_1_distance_next = 16UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 12UL;
      }
    }
    break;
    case 4UL: ;
    {
    _TIG_FN_3XIs_1_distance_next = 15UL;
    }
    break;
    case 14UL: 
#line 37 "AsishGokarakonda_dsaProject_3.c"
    j = 0;
    {
    _TIG_FN_3XIs_1_distance_next = 25UL;
    }
    break;
    case 15UL: 
#line 22
...
#line 25
    i = 0;
    {
    _TIG_FN_3XIs_1_distance_next = 17UL;
    }
    break;
    case 12UL: 
#line 35
    i ++;
    {
    _TIG_FN_3XIs_1_distance_next = 13UL;
    }
    break;
    case 1UL: ;
    if ((*(g + i) + j)->distance > 0) {
      {
      _TIG_FN_3XIs_1_distance_next = 19UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 7UL;
      }
    }
    break;
    case 23UL: 
#line 31
    ...
    {
    _TIG_FN_3XIs_1_distance_next = 26UL;
    }
    break;
    case 16UL: ;
    if ((*(g + i) + j)->distance <= min) {
      {
      _TIG_FN_3XIs_1_distance_next = 1UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 7UL;
...
#line 27
    j ++;
    {
    _TIG_FN_3XIs_1_distance_next = 22UL;
    }
    break;
    case 13UL: ;
    if (i < n) {
      {
      _TIG_FN_3XIs_1_distance_next = 14UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 0UL;
      }
    }
    break;
    case 19UL: 
...
#line 43
    *J = j;
    ...
    if (i < n) {
      {
      _TIG_FN_3XIs_1_distance_next = 2UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 6UL;
      }
    }
    break;
    case 6UL: 
#line 35
    ...
    if (j < n) {
      {
      _TIG_FN_3XIs_1_distance_next = 5UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 10UL;
      }
    }
    break;
    case 5UL: ;
    if ((*(g + i) + j)->distance > 0) {
      {
      _TIG_FN_3XIs_1_distance_next = 23UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_distance_next = 26UL;
...
void print(int i , int j , int x , int y ) 
{ 
  unsigned long _TIG_FN_3XIs_1_print_next ;

  {
  {
  _TIG_FN_3XIs_1_print_next = 24UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1_print_next) {
    case 18UL: 
#line 68
...
#line 70
    j ++;
    {
    _TIG_FN_3XIs_1_print_next = 27UL;
    }
    break;
    case 15UL: ;
    if (time > 0) {
      {
      _TIG_FN_3XIs_1_print_next = 18UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 13UL;
      }
    }
    break;
    case 12UL: 
...
#line 96
    j --;
    {
    _TIG_FN_3XIs_1_print_next = 19UL;
    }
    break;
    case 1UL: ;
    return;
    ...
    case 24UL: ;
    {
    _TIG_FN_3XIs_1_print_next = 17UL;
    }
    break;
    case 21UL: 
#line 81
...
#line 83
    ...
    if (j > y) {
      {
      _TIG_FN_3XIs_1_print_next = 2UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 1UL;
      }
    }
    break;
    case 17UL: ;
    if (i < x) {
      {
      _TIG_FN_3XIs_1_print_next = 26UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 27UL;
    ...
    if (j < y) {
      {
      _TIG_FN_3XIs_1_print_next = 15UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 13UL;
    ...
    if (time > 0) {
      {
      _TIG_FN_3XIs_1_print_next = 21UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 19UL;
...
#line 57
    ...
    if (time > 0) {
      {
      _TIG_FN_3XIs_1_print_next = 12UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_print_next = 1UL;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_3XIs_1___bswap_16_next ;

  {
  {
  _TIG_FN_3XIs_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_3XIs_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int X ;
  int Y ;
  unsigned long _TIG_FN_3XIs_1_main_next ;
  ...
  {
  {
  _TIG_IZ_3XIs_envp = (char **)0;
  goto _TIG_IZ_3XIs_envp__INITINLINE__TIG_IZ_3XIs_envp__INIT;
  }
  _TIG_IZ_3XIs_envp__INITINLINE__TIG_IZ_3XIs_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_3XIs_argv = (char **)0;
  goto _TIG_IZ_3XIs_argv__INITINLINE__TIG_IZ_3XIs_argv__INIT;
  }
  _TIG_IZ_3XIs_argv__INITINLINE__TIG_IZ_3XIs_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_3XIs_argc = 0;
  goto _TIG_IZ_3XIs_argc__INITINLINE__TIG_IZ_3XIs_argc__INIT;
  }
  _TIG_IZ_3XIs_argc__INITINLINE__TIG_IZ_3XIs_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-3XIs--0":);
    _TIG_IZ_3XIs_argc = _TIG_IZ_3XIs_formal_argc;
    _TIG_IZ_3XIs_argv = _TIG_IZ_3XIs_formal_argv;
    _TIG_IZ_3XIs_envp = _TIG_IZ_3XIs_formal_envp;
    break;
  }
  {
  _TIG_FN_3XIs_1_main_next = 20UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1_main_next) {
    case 18UL: ;
    if (i < n) {
      {
      _TIG_FN_3XIs_1_main_next = 25UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 28UL;
      }
    }
    break;
    case 25UL: 
#line 297 "AsishGokarakonda_dsaProject_3.c"
    j = 0;
    {
    _TIG_FN_3XIs_1_main_next = 37UL;
    }
    break;
    case 14UL: ;
    if (time > 0) {
      {
      _TIG_FN_3XIs_1_main_next = 13UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 35UL;
      }
    }
    break;
    case 12UL: 
...
#line 331
    l --;
    {
    _TIG_FN_3XIs_1_main_next = 11UL;
    }
    break;
    case 1UL: ;
    if (i < n) {
      {
      _TIG_FN_3XIs_1_main_next = 36UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 0UL;
      }
    }
    break;
    case 16UL: ;
...
#line 340
    ...
    {
    _TIG_FN_3XIs_1_main_next = 5UL;
    }
    break;
    case 19UL: ;
    if (l > 0) {
      {
      _TIG_FN_3XIs_1_main_next = 14UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 35UL;
...
#line 311
    ...
    if (i < k) {
      {
      _TIG_FN_3XIs_1_main_next = 22UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 2UL;
      }
    }
    break;
    case 37UL: ;
    if (j < n) {
      {
      _TIG_FN_3XIs_1_main_next = 7UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_main_next = 34UL;
      }
    }
    break;
    case 10UL: ;
...
{ 
  int j ;
  unsigned long _TIG_FN_3XIs_1_calculation_next ;

  {
  {
  _TIG_FN_3XIs_1_calculation_next = 16UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1_calculation_next) {
    case 25UL: ;
    if ((*(g + x) + (y + j))->tp == 1) {
      {
      _TIG_FN_3XIs_1_calculation_next = 31UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 10UL;
      }
    }
    break;
    case 4UL: 
#line 263
    j ++;
    {
    _TIG_FN_3XIs_1_calculation_next = 26UL;
    }
    break;
    case 30UL: ;
    return;
    ...
    if ((*(g + x) + y)->weight > (*(g + x) + (y - j))->weight) {
      {
      _TIG_FN_3XIs_1_calculation_next = 8UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 4UL;
      }
    }
    break;
    case 15UL: ;
    if ((*(g + x) + (y - j))->tp == 1) {
      {
      _TIG_FN_3XIs_1_calculation_next = 14UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 4UL;
    ...
    if ((*(g + x) + y)->weight > (*(g + x) + (y + j))->weight) {
      {
      _TIG_FN_3XIs_1_calculation_next = 34UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 10UL;
    ...
    if (time >= (*(g + x) + y)->d) {
      {
      _TIG_FN_3XIs_1_calculation_next = 38UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 6UL;
      }
    }
    break;
    case 8UL: ;
    if (time >= (*(g + x) + y)->d) {
      {
      _TIG_FN_3XIs_1_calculation_next = 13UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 28UL;
      }
    }
    break;
    case 1UL: ;
    if ((*(g + x) + y)->weight > (*(g + (x + j)) + y)->weight) {
      {
      _TIG_FN_3XIs_1_calculation_next = 0UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 32UL;
      }
    }
    break;
    case 23UL: ;
...
#line 232
    calc(g, x - j, y, 3, n);
    {
    _TIG_FN_3XIs_1_calculation_next = 9UL;
    }
    break;
    case 36UL: ;
    if ((*(g + (x - j)) + y)->tp == 1) {
      {
      _TIG_FN_3XIs_1_calculation_next = 2UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 11UL;
      }
    }
    break;
    case 26UL: ;
    if ((*(g + x) + y)->h >= j) {
      {
      _TIG_FN_3XIs_1_calculation_next = 29UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 12UL;
      }
    }
    break;
    case 11UL: ;
    if (y - j >= 0) {
      {
      _TIG_FN_3XIs_1_calculation_next = 15UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 4UL;
...
#line 254
    calc(g, x, y - j, 4, n);
    {
    _TIG_FN_3XIs_1_calculation_next = 7UL;
    }
    break;
    case 32UL: ;
    if (y + j < n) {
      {
      _TIG_FN_3XIs_1_calculation_next = 25UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 10UL;
...
#line 271
    ...
    if (time >= (*(g + x) + y)->d) {
      {
      _TIG_FN_3XIs_1_calculation_next = 20UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 17UL;
      }
    }
    break;
    case 22UL: ;
    if ((*(g + (x + j)) + y)->tp == 1) {
      {
      _TIG_FN_3XIs_1_calculation_next = 1UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 32UL;
    ...
    if (x - j >= 0) {
      {
      _TIG_FN_3XIs_1_calculation_next = 36UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 11UL;
    ...
    if (time >= (*(g + x) + y)->d) {
      {
      _TIG_FN_3XIs_1_calculation_next = 39UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 33UL;
      }
    }
    break;
    case 39UL: 
...
#line 188
    calc(g, x + j, y, 1, n);
    {
    _TIG_FN_3XIs_1_calculation_next = 24UL;
    }
    break;
    case 7UL: ;
    return;
    ...
    if (time >= (*(g + x) + y)->d) {
      {
      _TIG_FN_3XIs_1_calculation_next = 21UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 23UL;
      }
    }
    break;
    case 29UL: ;
    if (x + j < n) {
      {
      _TIG_FN_3XIs_1_calculation_next = 22UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 32UL;
    ...
    if ((*(g + x) + y)->weight > (*(g + (x - j)) + y)->weight) {
      {
      _TIG_FN_3XIs_1_calculation_next = 35UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calculation_next = 11UL;
...
#line 210
    calc(g, x, y + j, 2, n);
    {
    _TIG_FN_3XIs_1_calculation_next = 30UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_3XIs_1___bswap_32_next ;

  {
  {
  _TIG_FN_3XIs_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_3XIs_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_3XIs_1___uint16_identity_next ;

  {
  {
  _TIG_FN_3XIs_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  int j ;
  unsigned long _TIG_FN_3XIs_1_calc_next ;

  {
  {
  _TIG_FN_3XIs_1_calc_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1_calc_next) {
    case 18UL: ;
    if ((*(g + (x - j)) + y)->tp == 1) {
      {
      _TIG_FN_3XIs_1_calc_next = 27UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 11UL;
      }
    }
    break;
    case 4UL: ;
    if ((*(g + x) + (y + j))->tp == 1) {
      {
      _TIG_FN_3XIs_1_calc_next = 36UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 24UL;
      }
    }
    break;
    case 30UL: ;
    if ((*(g + (x + j)) + y)->tp == 1) {
      {
      _TIG_FN_3XIs_1_calc_next = 2UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 8UL;
      }
    }
    break;
    case 14UL: ;
    if ((*(g + x) + y)->h >= j) {
      {
      _TIG_FN_3XIs_1_calc_next = 35UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 38UL;
      }
    }
    break;
    case 31UL: ;
    if ((*(g + x) + y)->weight > (*(g + x) + (y - j))->weight) {
      {
      _TIG_FN_3XIs_1_calc_next = 42UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 10UL;
      }
    }
    break;
    case 12UL: 
#line 118 "AsishGokarakonda_dsaProject_3.c"
    (*(g + (x + j)) + y)->tp = 0;
#line 119
    (*(g + (x + j)) + y)->distance = 0;
#line 120
...
#line 121
    ...
    if (i == 3) {
      {
      _TIG_FN_3XIs_1_calc_next = 32UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 26UL;
      }
    }
    break;
    case 23UL: ;
    ...
    if (x + j < n) {
      {
      _TIG_FN_3XIs_1_calc_next = 30UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 29UL;
      }
    }
    break;
    case 19UL: 
...
#line 135
    ...
    if (y + j < n) {
      {
      _TIG_FN_3XIs_1_calc_next = 4UL;
      }
    } else {
      {
      _TIG_FN_3XIs_1_calc_next = 1UL;
      }
    }
    break;
    case 27UL: ;
...
{ 
  long tmp ;
  unsigned long _TIG_FN_3XIs_1___bswap_64_next ;

  {
  {
  _TIG_FN_3XIs_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_3XIs_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_3XIs_1___uint64_identity_next ;

  {
  {
  _TIG_FN_3XIs_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_3XIs_1___uint32_identity_next ;

  {
  {
  _TIG_FN_3XIs_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_3XIs_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
