    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_YM32_envp": "FUN: '_TIG_IZ_YM32_envp__INIT'",
          "_TIG_IZ_YM32_argv": "FUN: '_TIG_IZ_YM32_argv__INIT'",
          "_TIG_IZ_YM32_argc": "FUN: '_TIG_IZ_YM32_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DEF _TIG_IZ_YM32_argc LOC=UNKNOWN */
int _TIG_IZ_YM32_argc  ;
/* END VARIABLE-DEF _TIG_IZ_YM32_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_YM32_envp LOC=UNKNOWN */
char **_TIG_IZ_YM32_envp  ;
/* END VARIABLE-DEF _TIG_IZ_YM32_envp LOC=UNKNOWN */
...
int main(int argc , char **argv , char **_TIG_IZ_YM32_formal_envp ) ;
...
/* BEGIN VARIABLE-DECL _TIG_IZ_YM32_argc LOC=UNKNOWN */
int _TIG_IZ_YM32_argc ;
/* END VARIABLE-DECL _TIG_IZ_YM32_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_YM32_envp LOC=UNKNOWN */
char **_TIG_IZ_YM32_envp ;
/* END VARIABLE-DECL _TIG_IZ_YM32_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_YM32_argv LOC=UNKNOWN */
char **_TIG_IZ_YM32_argv ;
/* END VARIABLE-DECL _TIG_IZ_YM32_argv LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_YM32_argv LOC=UNKNOWN */
char **_TIG_IZ_YM32_argv  ;
/* END VARIABLE-DEF _TIG_IZ_YM32_argv LOC=UNKNOWN */
...
static void print_help(char const   *prog , FILE *fp , int status ) 
{ 
  unsigned long _TIG_FN_YM32_1_print_help_next ;

  {
  {
  _TIG_FN_YM32_1_print_help_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_print_help_next) {
    case 1UL: ;
    {
    _TIG_FN_YM32_1_print_help_next = 0UL;
    }
    break;
    case 0UL: 
#line 99 "d4wae89d498_super-vim-for-c_badinput.c"
...
{ 
  long tmp ;
  unsigned long _TIG_FN_YM32_1___bswap_64_next ;

  {
  {
  _TIG_FN_YM32_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_YM32_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  ...
  int tmp ;
  int tmp___0 ;
  unsigned long _TIG_FN_YM32_1_bisect_next ;

  {
  {
  _TIG_FN_YM32_1_bisect_next = 12UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_bisect_next) {
    case 18UL: 
#line 244 "d4wae89d498_super-vim-for-c_badinput.c"
    start += (off_t )delta;
    {
    _TIG_FN_YM32_1_bisect_next = 2UL;
    }
    break;
    case 25UL: 
#line 229
    successful = start;
    {
    _TIG_FN_YM32_1_bisect_next = 9UL;
    }
    break;
    case 4UL: 
#line 191
...
#line 192
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 31UL;
    }
    break;
    case 30UL: ;
    if (tmp___0 == 0) {
      {
      _TIG_FN_YM32_1_bisect_next = 25UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 7UL;
      }
    }
    break;
    case 14UL: 
...
#line 189
    step = 0U;
    {
    _TIG_FN_YM32_1_bisect_next = 4UL;
    }
    break;
    case 31UL: ;
    if (delta == 0) {
      {
      _TIG_FN_YM32_1_bisect_next = 1UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 17UL;
      }
    }
    break;
    case 12UL: ;
    {
    _TIG_FN_YM32_1_bisect_next = 14UL;
    }
    break;
    case 8UL: 
#line 223
...
#line 224
    delta = (int )(len >> (step + 1U));
    {
    _TIG_FN_YM32_1_bisect_next = 13UL;
    }
    break;
    case 1UL: 
#line 194
    ...
    if (end + 1L == failed) {
      {
      _TIG_FN_YM32_1_bisect_next = 38UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 21UL;
      }
    }
    break;
    case 3UL: ;
    if (tmp == 0) {
      {
      _TIG_FN_YM32_1_bisect_next = 28UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 19UL;
      }
    }
    break;
    case 16UL: ;
    if (successful - 1L == start) {
      {
      _TIG_FN_YM32_1_bisect_next = 33UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 18UL;
      }
    }
    break;
    case 24UL: 
...
#line 205
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 10UL;
    }
    break;
    case 11UL: 
#line 236
    ...
    if (start - 1L == failed) {
      {
      _TIG_FN_YM32_1_bisect_next = 24UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 11UL;
      }
    }
    break;
    case 13UL: ;
    if (delta == 0) {
      {
      _TIG_FN_YM32_1_bisect_next = 40UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_bisect_next = 0UL;
      }
    }
    break;
    case 19UL: 
#line 209
    failed = end;
    {
    _TIG_FN_YM32_1_bisect_next = 20UL;
    }
    break;
    case 32UL: 
#line 213
...
#line 196
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 3UL;
    }
    break;
    case 40UL: 
#line 226
...
#line 201
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 35UL;
    }
    break;
    case 28UL: 
#line 198
    successful = end;
    {
    _TIG_FN_YM32_1_bisect_next = 23UL;
    }
    break;
    case 33UL: 
#line 249
...
#line 253
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 37UL;
    }
    break;
    case 37UL: ;
    return (0);
...
#line 227
    ...
    {
    _TIG_FN_YM32_1_bisect_next = 30UL;
    }
    break;
    case 7UL: 
#line 240
    failed = start;
    {
    _TIG_FN_YM32_1_bisect_next = 16UL;
    }
    break;
    case 35UL: 
#line 217
...
#line 221
    step = 0U;
    {
    _TIG_FN_YM32_1_bisect_next = 8UL;
    }
    break;
    case 2UL: 
#line 221
    ...
    if (successful + 1L == end) {
      ...
      {
      _TIG_FN_YM32_1_bisect_next = 32UL;
      }
    }
    break;
    default: 
...
{ 
  int r ;
  unsigned long _TIG_FN_YM32_1_test_next ;

  {
  {
  _TIG_FN_YM32_1_test_next = 2UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_test_next) {
    case 1UL: ;
    return (r);
    break;
    case 0UL: 
...
#line 169
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"%d\n",
            r);
    {
    _TIG_FN_YM32_1_test_next = 1UL;
    }
    break;
    case 2UL: ;
    {
    _TIG_FN_YM32_1_test_next = 0UL;
    }
    break;
    default: 
    break;
...
{ 
  int tmp ;
  unsigned long _TIG_FN_YM32_1___bswap_32_next ;

  {
  {
  _TIG_FN_YM32_1___bswap_32_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___bswap_32_next) {
    case 1UL: 
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap32((int )__bsx);
    {
    _TIG_FN_YM32_1___bswap_32_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  int tmp___0 ;
  ssize_t tmp___1 ;
  unsigned long _TIG_FN_YM32_1_prepare_next ;

  {
  {
  _TIG_FN_YM32_1_prepare_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_prepare_next) {
    case 4UL: ;
    if ((size_t )tmp___1 != len) {
      {
      _TIG_FN_YM32_1_prepare_next = 11UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_prepare_next = 12UL;
      }
    }
    break;
    case 12UL: ;
    ...
    break;
    case 8UL: 
#line 150 "d4wae89d498_super-vim-for-c_badinput.c"
...
#line 151
    ...
    if (tmp___0 == -1) {
      {
      _TIG_FN_YM32_1_prepare_next = 8UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_prepare_next = 5UL;
      }
    }
    break;
    case 11UL: 
...
#line 148
    ...
    {
    _TIG_FN_YM32_1_prepare_next = 1UL;
    }
    break;
    case 5UL: 
#line 154
    ...
    {
    _TIG_FN_YM32_1_prepare_next = 4UL;
    }
    break;
    case 0UL: ;
    if (tmp) {
      {
      _TIG_FN_YM32_1_prepare_next = 9UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_prepare_next = 6UL;
      }
    }
    break;
    case 7UL: 
#line 142
    ...
    {
    _TIG_FN_YM32_1_prepare_next = 0UL;
    }
    break;
    default: 
    break;
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_YM32_1___uint16_identity_next ;

  {
  {
  _TIG_FN_YM32_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  ...
  int tmp___4 ;
  int tmp___5 ;
  unsigned long _TIG_FN_YM32_1_main_next ;
  ...
  {
  {
  _TIG_IZ_YM32_envp = (char **)0;
  goto _TIG_IZ_YM32_envp__INITINLINE__TIG_IZ_YM32_envp__INIT;
  }
  _TIG_IZ_YM32_envp__INITINLINE__TIG_IZ_YM32_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_YM32_argv = (char **)0;
  goto _TIG_IZ_YM32_argv__INITINLINE__TIG_IZ_YM32_argv__INIT;
  }
  _TIG_IZ_YM32_argv__INITINLINE__TIG_IZ_YM32_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_YM32_argc = 0;
  goto _TIG_IZ_YM32_argc__INITINLINE__TIG_IZ_YM32_argc__INIT;
  }
  _TIG_IZ_YM32_argc__INITINLINE__TIG_IZ_YM32_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-YM32--0":);
    _TIG_IZ_YM32_argc = argc;
    _TIG_IZ_YM32_argv = argv;
    _TIG_IZ_YM32_envp = _TIG_IZ_YM32_formal_envp;
    break;
  }
  {
  _TIG_FN_YM32_1_main_next = 7UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_main_next) {
    case 25UL: ;
    if (tmp) {
      {
      _TIG_FN_YM32_1_main_next = 26UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 16UL;
      }
    }
    break;
    case 14UL: 
...
#line 309
    ...
    if (tmp___3 == 0) {
      {
      _TIG_FN_YM32_1_main_next = 12UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 0UL;
      }
    }
    break;
    case 1UL: ;
    if (tmp___0) {
      {
      _TIG_FN_YM32_1_main_next = 29UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 6UL;
      }
    }
    break;
    case 23UL: ;
    if (tmp___2 == -1) {
      {
      _TIG_FN_YM32_1_main_next = 17UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 11UL;
      }
    }
    break;
    case 16UL: 
...
#line 297
    ...
    if (tmp___1) {
      {
      _TIG_FN_YM32_1_main_next = 21UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 14UL;
      }
    }
    break;
    case 19UL: 
...
#line 274
    ...
    if (tmp___4 != 0) {
      {
      _TIG_FN_YM32_1_main_next = 10UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 19UL;
      }
    }
    break;
    case 34UL: 
...
#line 285
    ...
    {
    _TIG_FN_YM32_1_main_next = 13UL;
    }
    break;
    case 22UL: ;
    if (output_fd < 0) {
      {
      _TIG_FN_YM32_1_main_next = 9UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 24UL;
      }
    }
    break;
    case 28UL: ;
...
#line 312
    ...
    {
    _TIG_FN_YM32_1_main_next = 27UL;
    }
    break;
    case 7UL: ;
    if (argc == 2) {
      {
      _TIG_FN_YM32_1_main_next = 15UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_main_next = 29UL;
...
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_YM32_1___uint64_identity_next ;

  {
  {
  _TIG_FN_YM32_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  short tmp ;
  unsigned long _TIG_FN_YM32_1___bswap_16_next ;

  {
  {
  _TIG_FN_YM32_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___bswap_16_next) {
    case 1UL: 
#line 37 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_YM32_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  ...
  void *tmp___0 ;
  ssize_t tmp___1 ;
  unsigned long _TIG_FN_YM32_1_load_next ;

  {
  {
  _TIG_FN_YM32_1_load_next = 8UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1_load_next) {
    case 15UL: 
#line 132 "d4wae89d498_super-vim-for-c_badinput.c"
    tmp___1 = read(input_fd, (void *)*input, *len);
    {
    _TIG_FN_YM32_1_load_next = 12UL;
    }
    break;
    case 12UL: ;
    if ((size_t )tmp___1 != *len) {
      {
      _TIG_FN_YM32_1_load_next = 10UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_load_next = 1UL;
      }
    }
    break;
    case 8UL: 
...
#line 118
    ...
    {
    _TIG_FN_YM32_1_load_next = 17UL;
    }
    break;
    case 11UL: ;
    if (input_fd < 0) {
      {
      _TIG_FN_YM32_1_load_next = 2UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_load_next = 16UL;
      }
    }
    break;
    case 17UL: ;
    if (tmp < 0) {
      {
      _TIG_FN_YM32_1_load_next = 6UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_load_next = 3UL;
      }
    }
    break;
    case 6UL: 
...
#line 121
    ...
    if (! *input) {
      {
      _TIG_FN_YM32_1_load_next = 7UL;
      }
    } else {
      {
      _TIG_FN_YM32_1_load_next = 15UL;
      }
    }
    break;
    case 10UL: 
...
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_YM32_1___uint32_identity_next ;

  {
  {
  _TIG_FN_YM32_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_YM32_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
