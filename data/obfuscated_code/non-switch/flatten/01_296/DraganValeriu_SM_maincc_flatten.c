...
[
  {
    ...
    "funs": [
      ...
      "__uint32_identity", "__uint64_identity", "histogram", "interclasare",
      "main", "printArray", "print_hist"
    ],
    "options": {
      "common": {
        "prefix": "",
...
BEGIN-UNIVERSE
{
  ...
  "Transformations": [
    ...
    },
    {
      ...
      "TransformationUpdates": {
        "Modified Function Implementations": [ "print_hist" ]
      }
    },
    {
      "TransformationNumber": 1,
    ...
    },
    {
      ...
      "TransformationKind": "Flatten",
      "TransformationUpdates": {
        "Modified Function Implementations": [ "interclasare" ]
      }
    },
    {
      "TransformationNumber": 1,
      "TransformationKind": "Flatten",
      "TransformationUpdates": {
        "Modified Function Implementations": [ "histogram" ]
      }
    },
    {
      "TransformationNumber": 1,
    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_MA9Y_envp": "FUN: '_TIG_IZ_MA9Y_envp__INIT'",
          "_TIG_IZ_MA9Y_argv": "FUN: '_TIG_IZ_MA9Y_argv__INIT'",
          "_TIG_IZ_MA9Y_argc": "FUN: '_TIG_IZ_MA9Y_argc__INIT'"
        }
      }
    },
    {
...
void printArray(int *a , int n___0 ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MA9Y_envp LOC=UNKNOWN */
char **_TIG_IZ_MA9Y_envp  ;
/* END VARIABLE-DEF _TIG_IZ_MA9Y_envp LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MA9Y_envp LOC=UNKNOWN */
char **_TIG_IZ_MA9Y_envp ;
/* END VARIABLE-DECL _TIG_IZ_MA9Y_envp LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL histogram LOC=UNKNOWN */
void histogram(int *hist , int *arr , int nr ) ;
/* END FUNCTION-DECL histogram LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MA9Y_argc LOC=UNKNOWN */
int _TIG_IZ_MA9Y_argc  ;
/* END VARIABLE-DEF _TIG_IZ_MA9Y_argc LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MA9Y_argc LOC=UNKNOWN */
int _TIG_IZ_MA9Y_argc ;
/* END VARIABLE-DECL _TIG_IZ_MA9Y_argc LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL print_hist LOC=UNKNOWN */
void print_hist(int *a , int nr ) ;
/* END FUNCTION-DECL print_hist LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_MA9Y_argv LOC=UNKNOWN */
char **_TIG_IZ_MA9Y_argv ;
/* END VARIABLE-DECL _TIG_IZ_MA9Y_argv LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL interclasare LOC=UNKNOWN */
int *interclasare(int *a , int const   nr1 , int *b , int const   nr2 ) ;
/* END FUNCTION-DECL interclasare LOC=UNKNOWN */
...
int main(int _TIG_IZ_MA9Y_formal_argc , char **_TIG_IZ_MA9Y_formal_argv , char **_TIG_IZ_MA9Y_formal_envp ) ;
...
/* BEGIN VARIABLE-DEF _TIG_IZ_MA9Y_argv LOC=UNKNOWN */
char **_TIG_IZ_MA9Y_argv  ;
/* END VARIABLE-DEF _TIG_IZ_MA9Y_argv LOC=UNKNOWN */
...
{ 
  long tmp ;
  unsigned long _TIG_FN_MA9Y_1___bswap_64_next ;

  {
  {
  _TIG_FN_MA9Y_1___bswap_64_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___bswap_64_next) {
    case 1UL: ;
...
#line 73 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_MA9Y_1___bswap_64_next = 1UL;
    }
    break;
    default: 
    break;
...
/* BEGIN FUNCTION-DEF interclasare LOC=UNKNOWN */
int *interclasare(int *a , int const   nr1 , int *b , int const   nr2 ) 
{ 
  int nr3 ;
  int *z ;
  ...
  int ib ;
  int iz ;
  unsigned long _TIG_FN_MA9Y_1_interclasare_next ;

  {
  {
  _TIG_FN_MA9Y_1_interclasare_next = 16UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1_interclasare_next) {
    case 18UL: 
#line 84 "DraganValeriu_SM_maincc.c"
    *(z + iz) = *(b + ib);
#line 85
    ib ++;
#line 86
    iz ++;
    {
    _TIG_FN_MA9Y_1_interclasare_next = 6UL;
    }
    break;
    case 14UL: ;
    if (*(a + ia) < *(b + ib)) {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 10UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 7UL;
      }
    }
    break;
    case 23UL: ;
    if (ia < (int )nr1) {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 9UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 13UL;
      }
    }
    break;
    case 16UL: ;
    {
    _TIG_FN_MA9Y_1_interclasare_next = 19UL;
    }
    break;
    case 9UL: ;
    if (ib < (int )nr2) {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 14UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 13UL;
    ...
    if (ia < (int )nr1) {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 2UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 6UL;
...
#line 63
    nr3 = (int )(nr1 + nr2);
#line 64
    tmp = malloc((size_t )(sizeof(int ) * (unsigned long long )nr3));
#line 64
    z = (int *)tmp;
#line 65
    ia = 0;
...
#line 65
    iz = 0;
    {
    _TIG_FN_MA9Y_1_interclasare_next = 23UL;
    }
    break;
    case 6UL: ;
    if (ib < (int )nr2) {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 18UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_interclasare_next = 22UL;
      }
    }
    break;
    case 22UL: ;
...
#line 69
    ia ++;
    {
    _TIG_FN_MA9Y_1_interclasare_next = 0UL;
    }
    break;
    case 0UL: 
#line 74
...
/* END FUNCTION-DEF interclasare LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF __bswap_32 LOC=UNKNOWN */
__inline static __uint32_t __bswap_32(__uint32_t __bsx ) 
{ 
  int tmp ;
  unsigned long _TIG_FN_MA9Y_1___bswap_32_next ;

  {
  {
  _TIG_FN_MA9Y_1___bswap_32_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___bswap_32_next) {
    case 1UL: ;
...
#line 52 "/usr/include/x86_64-linux-gnu/bits/byteswap.h"
    ...
    {
    _TIG_FN_MA9Y_1___bswap_32_next = 1UL;
    }
    break;
    default: 
    break;
...
{ 
  short tmp ;
  unsigned long _TIG_FN_MA9Y_1___bswap_16_next ;

  {
  {
  _TIG_FN_MA9Y_1___bswap_16_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___bswap_16_next) {
    case 1UL: 
#line 37
    tmp = __builtin_bswap16((short )__bsx);
    {
    _TIG_FN_MA9Y_1___bswap_16_next = 0UL;
    }
    break;
    case 0UL: ;
...
{ 
  int i ;
  unsigned long _TIG_FN_MA9Y_1_printArray_next ;

  {
  {
  _TIG_FN_MA9Y_1_printArray_next = 4UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1_printArray_next) {
    case 4UL: 
#line 95 "DraganValeriu_SM_maincc.c"
    i = 0;
    {
    _TIG_FN_MA9Y_1_printArray_next = 1UL;
    }
    break;
    case 1UL: ;
    if (i < n___0) {
      {
      _TIG_FN_MA9Y_1_printArray_next = 6UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_printArray_next = 3UL;
      }
    }
    break;
    case 3UL: 
#line 98
    ...
    {
    _TIG_FN_MA9Y_1_printArray_next = 7UL;
    }
    break;
    case 6UL: 
#line 96
...
__inline static __uint16_t __uint16_identity(__uint16_t __x ) 
{ 
  unsigned long _TIG_FN_MA9Y_1___uint16_identity_next ;

  {
  {
  _TIG_FN_MA9Y_1___uint16_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___uint16_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
/* BEGIN FUNCTION-DEF print_hist LOC=UNKNOWN */
void print_hist(int *a , int nr ) 
{ 
  int i ;
  int j ;
  int tmp ;
  unsigned long _TIG_FN_MA9Y_1_print_hist_next ;

  {
  {
  _TIG_FN_MA9Y_1_print_hist_next = 26UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1_print_hist_next) {
    case 25UL: 
#line 31
    printf((char const   */* __restrict  */)"+");
#line 32
    j = 0;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 31UL;
    }
    break;
    case 30UL: 
#line 24
    printf((char const   */* __restrict  */)" #");
    {
    _TIG_FN_MA9Y_1_print_hist_next = 8UL;
    }
    break;
    case 15UL: 
#line 13
    tmp = 0;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 16UL;
    }
    break;
    case 31UL: ;
    if (j < nr) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 28UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 1UL;
      }
    }
    break;
    case 12UL: ;
    if (*(a + j) >= (10 - i) - 1) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 30UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 35UL;
      }
    }
    break;
    case 8UL: 
#line 22
    j ++;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 40UL;
    }
    break;
    case 1UL: ;
    return;
...
#line 15
    i = 0;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 6UL;
    }
    break;
    case 16UL: 
#line 13
...
#line 12
    j ++;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 11UL;
    }
    break;
    case 24UL: 
#line 20
    printf((char const   */* __restrict  */)"%d", (10 - i) - 1);
#line 22
    j = 0;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 40UL;
...
#line 12
    ...
    if (j < nr) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 27UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 3UL;
      }
    }
    break;
    case 9UL: ;
    if (*(a + j) > 1) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 12UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 0UL;
      }
    }
    break;
    case 19UL: ;
    if (i < 10) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 24UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 25UL;
      }
    }
    break;
    case 40UL: ;
    if (j < 16) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 9UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 34UL;
      }
    }
    break;
    case 6UL: ;
    if (i < 16) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 33UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 37UL;
      }
    }
    break;
    case 27UL: ;
    if (*(a + j) % 10 > 0) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 5UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 10UL;
      }
    }
    break;
    case 34UL: 
...
#line 19
    i ++;
    {
    _TIG_FN_MA9Y_1_print_hist_next = 19UL;
    }
    break;
    case 28UL: 
#line 33
...
#line 32
    ...
    if (*(a + j) / 10 > 0) {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 21UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_print_hist_next = 15UL;
      }
    }
    break;
    case 33UL: 
...
/* END FUNCTION-DEF print_hist LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF __uint64_identity LOC=UNKNOWN */
__inline static __uint64_t __uint64_identity(__uint64_t __x ) 
{ 
  unsigned long _TIG_FN_MA9Y_1___uint64_identity_next ;

  {
  {
  _TIG_FN_MA9Y_1___uint64_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___uint64_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
/* BEGIN FUNCTION-DEF histogram LOC=UNKNOWN */
void histogram(int *hist , int *arr , int nr ) 
{ 
  int i ;
  int tmp ;
  ...
  int s ;
  int i___0 ;
  unsigned long _TIG_FN_MA9Y_1_histogram_next ;

  {
  {
  _TIG_FN_MA9Y_1_histogram_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1_histogram_next) {
    case 12UL: ;
    if (i < (int )n) {
      {
      _TIG_FN_MA9Y_1_histogram_next = 11UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_histogram_next = 10UL;
      }
    }
    break;
    case 1UL: 
#line 44
    i = 0;
    {
    _TIG_FN_MA9Y_1_histogram_next = 12UL;
    }
    break;
    case 11UL: 
#line 45
...
#line 44
    ...
    if (i___0 < 16) {
      {
      _TIG_FN_MA9Y_1_histogram_next = 2UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_histogram_next = 6UL;
      }
    }
    break;
    case 6UL: ;
...
#line 55
    i___0 = 0;
    {
    _TIG_FN_MA9Y_1_histogram_next = 13UL;
    }
    break;
    case 2UL: 
#line 56
    *(hist + i___0) = ((*(hist + i___0) * 1000) / (int )(n + 400)) / 10;
#line 57
    s += *(hist + i___0);
#line 55
    i___0 ++;
...
/* END FUNCTION-DEF histogram LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF __uint32_identity LOC=UNKNOWN */
__inline static __uint32_t __uint32_identity(__uint32_t __x ) 
{ 
  unsigned long _TIG_FN_MA9Y_1___uint32_identity_next ;

  {
  {
  _TIG_FN_MA9Y_1___uint32_identity_next = 0UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1___uint32_identity_next) {
    case 0UL: ;
    return (__x);
    break;
    default: 
...
{ 
  ...
  int i___0 ;
  unsigned long long arr_$size_$dimension_0 ;
  unsigned long _TIG_FN_MA9Y_1_main_next ;
  ...
  {
  {
  _TIG_IZ_MA9Y_envp = (char **)0;
  goto _TIG_IZ_MA9Y_envp__INITINLINE__TIG_IZ_MA9Y_envp__INIT;
  }
  _TIG_IZ_MA9Y_envp__INITINLINE__TIG_IZ_MA9Y_envp__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MA9Y_argv = (char **)0;
  goto _TIG_IZ_MA9Y_argv__INITINLINE__TIG_IZ_MA9Y_argv__INIT;
  }
  _TIG_IZ_MA9Y_argv__INITINLINE__TIG_IZ_MA9Y_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_MA9Y_argc = 0;
  goto _TIG_IZ_MA9Y_argc__INITINLINE__TIG_IZ_MA9Y_argc__INIT;
  }
  _TIG_IZ_MA9Y_argc__INITINLINE__TIG_IZ_MA9Y_argc__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-MA9Y--0":);
    _TIG_IZ_MA9Y_argc = _TIG_IZ_MA9Y_formal_argc;
    _TIG_IZ_MA9Y_argv = _TIG_IZ_MA9Y_formal_argv;
    _TIG_IZ_MA9Y_envp = _TIG_IZ_MA9Y_formal_envp;
    break;
  }
  {
  _TIG_FN_MA9Y_1_main_next = 20UL;
  }
  while (1) {
    switch (_TIG_FN_MA9Y_1_main_next) {
    case 18UL: 
#line 114
    printf((char const   */* __restrict  */)"%d ", hist[i___0]);
#line 113
    i___0 ++;
    {
    _TIG_FN_MA9Y_1_main_next = 11UL;
    }
    break;
    case 4UL: ;
    if (tmp___1 >= 16U) {
      {
      _TIG_FN_MA9Y_1_main_next = 10UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_main_next = 13UL;
      }
    }
    break;
    case 14UL: 
#line 107
    tmp___0 = rand();
#line 107
    *((int *)(arr + i * 4ULL)) = tmp___0 % 255;
#line 106
    i ++;
    {
    _TIG_FN_MA9Y_1_main_next = 3UL;
    }
    break;
    case 15UL: 
#line 110
...
#line 102
    ...
    {
    _TIG_FN_MA9Y_1_main_next = 9UL;
    }
    break;
    case 3UL: ;
    if (i < (int )n) {
      {
      _TIG_FN_MA9Y_1_main_next = 14UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_main_next = 15UL;
      }
    }
    break;
    case 26UL: ;
    ...
    if (i___0 < 16) {
      {
      _TIG_FN_MA9Y_1_main_next = 18UL;
      }
    } else {
      {
      _TIG_FN_MA9Y_1_main_next = 1UL;
      }
    }
    break;
    case 9UL: 
#line 104
    arr_$size_$dimension_0 = ((n * 32ULL + 31ULL) & ~ 31ULL) >> 3ULL;
    arr = (char *)alloca(arr_$size_$dimension_0);
    {
    _TIG_FN_MA9Y_1_main_next = 2UL;
    }
    break;
    case 13UL: 
#line 110
