// Repository: AndreaCicca/Consegne-HPC
// File: gpu/gpuheat/heat_gpu.cu
...
// per poter determinare i blocksize tramite uno script
#ifndef BLOCK_SIZE_X
...
///////////////////////////////
   ...
   for(iter=0; iter<MAX_ITER; iter=iter+1)
    ...
    fprintf (stderr,"# Tempo di esecuzione= %.3f \n", t2-t1);
