// Repository: 2AiBAIT/SmartHealthPhoneScanner
// File: InstantNGP/src/main.cu
	...
	try {
		...
		if (snapshot_flag) {
			...
			if (network_config_flag) {
                ...
                network_config_path = "/home/hcorreia/PycharmProjects/instant-ngp/configs/nerf/base.json";
			}
		...
		if (gui) {
            testbed.init_window(width_flag ? get(width_flag) : 1920, height_flag ? get(height_flag) : 1080, false, true);
		}
