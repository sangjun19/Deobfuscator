// Repository: EGO4D/hands-and-objects
// File: state-change-localization-classification/bmn/temporal-segment-networks/lib/caffe-action/src/caffe/layers/lrn_layer.cu
