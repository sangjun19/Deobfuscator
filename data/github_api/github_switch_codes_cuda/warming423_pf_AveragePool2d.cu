// Repository: warming423/pf
// File: pytorch-1.9.0/aten/src/ATen/native/cuda/AveragePool2d.cu
...
Tensor& avg_pool2d_out_cuda(const Tensor& input,
  IntArrayRef kernel_size,
  IntArrayRef stride,
  IntArrayRef padding,
  bool ceil_mode,
...
Tensor& avg_pool2d_backward_out_cuda(const Tensor& gradOutput_,
  const Tensor& input,
  IntArrayRef kernel_size,
  IntArrayRef stride,
  IntArrayRef padding,
