// Repository: jdoerfert/PACT-22-Artifact---Breaking-the-Vendor-Lock---Performance-Portable-Programming-Through-OpenMP
// File: benchmarks/HeCBench/grep-cuda/putil.cu
