// Repository: OrniNoor/in5050-cuda-optimization
// File: c63enc.cu
...
// defining gpu function for encoders
...
static void c63_encode_image(struct c63_common *cm, yuv_t *image)
{
  ...
  //gpu function call for motion estimate, motion compensate, dct, idct.
    
  enc_gpu<<<1,1>>>(cm, image);
  ...
  /* Function dump_image(), found in common.cu, can be used here to check if the
...
struct c63_common* init_c63_enc(int width, int height)
{
  ...
  //allocating cm to global memory
