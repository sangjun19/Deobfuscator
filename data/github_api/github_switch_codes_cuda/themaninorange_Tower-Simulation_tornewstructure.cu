// Repository: themaninorange/Tower-Simulation
// File: simulation_code/tornewstructure.cu
...
__global__ void calcForces(Connection *cnx, int *numcon, int *beami, double *beamk, double *beaml, bool *fail){ 
			//   int *juncpair1_GPU, int *juncpair2_GPU, double *juncangle_GPU, double *junck_GPU){
