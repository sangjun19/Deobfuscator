// Repository: xtuml/masl
// File: examples/petrol/masl/src/PSC_OOA/PSC.mod
...
domain PSC is
  ...
  //! ATTENDANT Enables Pump 2
  private service ATTENDANT_Enables_Pump_2_2 (); pragma external (2);
