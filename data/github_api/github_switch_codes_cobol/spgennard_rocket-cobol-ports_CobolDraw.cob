// Repository: spgennard/rocket-cobol-ports
// File: raylib_painer/CobolDraw.cob
      ...
      *>    ***********************************************************
       ...
       special-names.
           call-convention 4 is no-return-code.
       repository.
      ...
      *>    Circle position
       01   posizione-cerchio   redefines posizione-mouse.
            05   x              usage float-short.
            05   y              usage float-short.
      ...
      *>    ***********************************************************
       ...
       procedure division.
           move 300 to x of posizione-cerchio
           move 200 to y of posizione-cerchio

      *>    Initialize a 600x400 pixel Graphic Window
            call "InitWindow" using
                by value 600,
                by value 400,
                by reference z"COBOL Raylib Paint"
                returning ritorno
                on exception
      ...
      *>    Close Graphic Window
            call no-return-code "CloseWindow"
            end-call
      ...
      *>    ***********************************************************
       ...
       disegna.
      *>    Open Write Mode
            call no-return-code "BeginDrawing"
            end-call

                if  fine = 0
                    move nero to colore
                    call no-return-code "ClearBackground" using
                        by value colore
                    end-call
                    move 1 to fine
                end-if
      ...
      *>        Write some text
                call "DrawText" using
                    by reference z"Gravity speed in BLENDING mode Activate:F1 F2 F3 F4 - Deactivate:F10",
                    by value 122,
                    by value 315,
                    by value 10,
                    by value colore
                ...
                call "DrawText" using
                    by reference z"Big Brush:  Up Arrow Key --- Small Brush:  Down Arrow Key",
                    by value 150,
                    by value 325,
                    by value 10,
                    by value colore
                ...
                call "DrawText" using
                    by reference z"Lx Mouse click to draw in color",
                    by value 150,
                    by value 340,
                    by value 20,
                    by value colore
                ...
                call "DrawText" using
                    by reference z" Rx Mouse click delete",
                    by value 195,
                    by value 360,
                    by value 20,
                    by value colore
                ...
                call "TextFormat" using
                    by reference z"x_pos: %08d  y_pos: %08d",
                    by value x-pos,
                    by value y-pos,
                    returning formato-testo
                end-call
                ...
                call "DrawText" using
                    by reference z"Left CTRL switches to COBOL_RayLib Paint          Right CTRL switches to COBOL_C_RayLib BLENDING mode",
                    by value 10,
                    by value 40,
                    by value 8,
                    by value colore
                ...
                if  risposta = 1
                    ...
                    move bianco to colore
                    call "DrawText" using
                        by reference z"Press the space bar to clear the screen",
                        by value 105,
                        by value 380,
                        by value 20,
                        by value colore
      ...
      *>    Close Write Mode
            call no-return-code "EndDrawing"
            end-call
            .
