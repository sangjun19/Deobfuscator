// Repository: Wings-Lab/kaa-app-spectrum-data-collection-old
// File: SpecSenseMain.ccp
...
static std::string processNotification(const KaaNotification &notification, const kaa_notification::power_iq_change_choice powiqChange)
{
...
public:
    ...
    void onNotification(const int64_t topicId, const KaaNotification &notification) override
    {
        ...
        std::cout << (boost::format("Alert type: %1%") %
                processNotification(notification, notification.power_iq_change)) << std::endl;
