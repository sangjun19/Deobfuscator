// Repository: goccy/go-zetasql
// File: internal/ccall/go-absl/flags/commandlineflag/bind_darwin.go

package commandlineflag
...
#define GO_EXPORT(API) export_absl_flags_commandlineflag_ ## API
#include "bridge.h"
*/
import "C"
import ()
