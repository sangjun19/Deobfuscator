// Repository: CouponOne/Coupon.One
// File: build/ci.go
...
import (
	...
	"github.com/CouponOne/Coupon.One/internal/build"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 7 {
			...
			log.Println("go-conponone requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:conponone/conponone")`)
...
type debMetadata struct {
	...
	// go-conponone version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Ethereum Builds <fjl@conponone.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.conponone", "-v", "github.com/CouponOne/Coupon.One/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/CouponOne/Coupon.One/mobile")
