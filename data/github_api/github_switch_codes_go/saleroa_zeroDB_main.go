...
var host = flag.String("h", "127.0.0.1", "the zerokv server host, default 127.0.0.1")
var port = flag.Int("p", 5200, "the zerokv server port, default 5200")

const cmdHistoryPath = "/tmp/zerokv-cli"
