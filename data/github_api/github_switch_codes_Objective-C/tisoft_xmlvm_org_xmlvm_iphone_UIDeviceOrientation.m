// Repository: tisoft/xmlvm
// File: src/xmlvm2c/compat-lib/iphone/org_xmlvm_iphone_UIDeviceOrientation.m
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UIDeviceOrientation);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UIDeviceOrientation.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UIDeviceOrientation.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UIDeviceOrientation);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UIDeviceOrientation.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UIDeviceOrientation.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_UIDeviceOrientation.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.UIDeviceOrientation")
        __INIT_IMPL_org_xmlvm_iphone_UIDeviceOrientation();
    }
}

void __INIT_IMPL_org_xmlvm_iphone_UIDeviceOrientation()
{
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    __INIT_INSTANCE_MEMBERS_java_lang_Object(me, 0 || derivedClassWillRegisterFinalizer);
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_UIDeviceOrientation()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UIDeviceOrientation)
org_xmlvm_iphone_UIDeviceOrientation* me = (org_xmlvm_iphone_UIDeviceOrientation*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_UIDeviceOrientation));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation(me, 0);
