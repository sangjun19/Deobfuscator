// Repository: codyd51/Hermes
// File: hermes/Hermes.mm
...
@implementation HermesGiantMakerCell4
-(id)initWithStyle:(long long)style reuseIdentifier:(NSString *)reuseIdentifier {
	if((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])){
		UIImage *bkIm = [UIImage imageWithContentsOfFile:@"/Library/Application Support/hermesAdit.png"];
		CGSize imageSize = bkIm.size;
		CGRect imageRect = CGRectMake(0, 0, imageSize.width, imageSize.height);
		UIGraphicsBeginImageContextWithOptions(imageSize, NO, 0.0);
		CGContextRef ctx = UIGraphicsGetCurrentContext();
