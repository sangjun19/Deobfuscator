// Repository: polyv/polyv-rn-vod-sdk-demo
// File: ios/PolyvVodRnModule/PolyvOpenSourceModule/Skin/PLVVodSkinPlayerController.m
...
- (void)setWrapperView:(PolyvVodPlayerWrapperView *)wrapperView {
...
- (void)playInFullscreen:(BOOL)full {
    ...
    [self updatePlayerConstraints];
    [self.wrapperView switchToFullScreen:full];
}
