// Repository: shaeberling/xmlvm
// File: xmlvm/src/xmlvm2c/compat-lib/iphone/org_xmlvm_iphone_MFMailComposeResult.m

#include "xmlvm.h"

#include "org_xmlvm_iphone_MFMailComposeResult.h"

#define XMLVM_CURRENT_CLASS_NAME MFMailComposeResult
#define XMLVM_CURRENT_PKG_CLASS_NAME org_xmlvm_iphone_MFMailComposeResult
...
__TIB_DEFINITION_org_xmlvm_iphone_MFMailComposeResult __TIB_org_xmlvm_iphone_MFMailComposeResult = {
    ...
    sizeof(org_xmlvm_iphone_MFMailComposeResult), // sizeInstance
    XMLVM_TYPE_CLASS};

JAVA_OBJECT __CLASS_org_xmlvm_iphone_MFMailComposeResult;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_MFMailComposeResult_1ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_MFMailComposeResult_2ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_MFMailComposeResult_3ARRAY;
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_MFMailComposeResult);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_MFMailComposeResult.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_MFMailComposeResult.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_MFMailComposeResult);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_MFMailComposeResult.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_MFMailComposeResult.classInitialized) {
                // do nothing
            }
        }
    } else {
...
void __INIT_IMPL_org_xmlvm_iphone_MFMailComposeResult()
{
    ...
    __TIB_org_xmlvm_iphone_MFMailComposeResult.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_MFMailComposeResult_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult);
    __CLASS_org_xmlvm_iphone_MFMailComposeResult_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult_1ARRAY);
    __CLASS_org_xmlvm_iphone_MFMailComposeResult_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult]
    //XMLVM_END_WRAPPER
}
