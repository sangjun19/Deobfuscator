// Repository: sunyuping/SYPProject
// File: SYPProject/RRAttributedLabel.m
...
#define RRAttributedLabel_WarnAboutKnownIssues 1
...
@interface RRAttributedLabel(/* Private */)
...
@implementation RRAttributedLabel
	...
	[customLinks enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop)
	 {
		 ...
		 @catch (NSException * e) {
			 ...
			 if ([[e name] isEqualToString:NSRangeException]) {
				 RRLOGI("[OHAttributedLabel] exception: %@",e);
			 } else {
				 @throw;
			 }
		 }
...
-(void)warnAboutKnownIssues_CheckLineBreakMode {
	...
	if (truncationMode) {
		RRLOGI("[OHAttributedLabel] Warning: \"UILineBreakMode...Truncation\" lineBreakModes not yet fully supported by CoreText and OHAttributedLabel");
		RRLOGI("                    (truncation will appear on each paragraph instead of the whole text)");
		RRLOGI("                    This is a known issue (Help to solve this would be greatly appreciated).");
		RRLOGI("                    See https://github.com/AliSoftware/OHAttributedLabel/issues/3");
	}
}
-(void)warnAboutKnownIssues_CheckAdjustsFontSizeToFitWidth {
	if (self.adjustsFontSizeToFitWidth) {
		RRLOGI("[OHAttributedLabel] Warning: \"adjustsFontSizeToFitWidth\" property not supported by CoreText and OHAttributedLabel! This property will be ignored.");
	}	
}
...
-(void)setNumberOfLines:(NSInteger)nbLines {
	RRLOGI("[OHAttributedLabel] Warning: the numberOfLines property is not yet supported by CoreText and OHAttributedLabel. (this property is ignored right now)");
	RRLOGI("                    This is a known issue (Help to solve this would be greatly appreciated).");
	RRLOGI("                    See https://github.com/AliSoftware/OHAttributedLabel/issues/34");
