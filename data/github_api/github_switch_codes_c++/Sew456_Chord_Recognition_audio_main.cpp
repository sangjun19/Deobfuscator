...
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_deleteSLEngine(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
        Java_ece420_chord_1recognition_MIC_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass);
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_ece420_chord_1recognition_MIC_createAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_deleteAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_startPlay(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_ece420_chord_1recognition_MIC_stopPlay(JNIEnv *env, jclass type);
}

JNIEXPORT void JNICALL
Java_ece420_chord_1recognition_MIC_createSLEngine(
...
JNIEXPORT jboolean JNICALL
Java_ece420_chord_1recognition_MIC_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
