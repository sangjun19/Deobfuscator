// Repository: ve3wwg/teensylc_fibers
// File: fiberslc.h

//////////////////////////////////////////////////////////////////////
// fiberslc.h -- Fibers Class Support
// Date: Fri Feb 13 20:40:36 2015   (C) Warren Gay VE3WWG
///////////////////////////////////////////////////////////////////////
// DESCRIPTION:
// 
...
struct fiber_t {
	...
	uint32_t	r5;
	uint32_t	r6;
	uint32_t	r7;		// fiber ptr at start
	//
	uint32_t	r8;
	uint32_t	r9;
	uint32_t	sl;		// alias r11
	uint32_t	fp;
	uint32_t	sp;		// alias r13
...
// 
// where <root_dir> varies by platform. Using my teensylc_lib
// structure, the root_dir is likely /opt/teensylc_lib.
// 
...
// ----------
// 
// When using the teensylc_lib structure, the class header should be
...
// --------
// 
// When using the teensylc_lib structure, the fibers library just needs
