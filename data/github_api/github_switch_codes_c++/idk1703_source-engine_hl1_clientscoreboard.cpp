...
void CHL1MPClientScoreBoardDialog::AddHeader()
{
	...
	//SectionedListPanel::HEADER_TEXT| SectionedListPanel::COLUMN_CENTER, scheme()->GetProportionalScaledValue(
	//CSTRIKE_VOICE_WIDTH ) ); 	m_pPlayerList->AddColumnToSection(0, "tracker", "#PlayerTracker",
	//SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::HEADER_TEXT, scheme()->GetProportionalScaledValue(
