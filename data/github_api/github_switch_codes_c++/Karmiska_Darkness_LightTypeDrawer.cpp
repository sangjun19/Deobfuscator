// Repository: Karmiska/Darkness
// File: darkness-editor/src/drawers/LightTypeDrawer.cpp
...
namespace engine
{
    ...
    void LightTypeDrawer::setParent(void* parent)
    {
        if (parent)
        {
            ...
            m_widget = engine::make_shared<LightTypeWidget>(m_value, m_parent);
    ...
    {
        return engine::make_shared<LightTypeDrawer>(value);
    }
}
