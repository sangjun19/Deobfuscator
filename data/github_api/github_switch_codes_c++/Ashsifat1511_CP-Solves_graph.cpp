// Repository: Ashsifat1511/CP-Solves
// File: graph.cpp
...
void input(int cnt, int cno)
{
    ...
    {
    case 1:
        strcpy(i.destination, "ITALY");
        break;
    case 2:
        strcpy(i.destination, "FRANCE");
        break;
    case 3:
    ...
    case 7:
        ...
        break;
    case 8:
        strcpy(i.destination, "BANGLADESH");
        break;
    }
    int x = 0, id;
    while (x < cnt)
...
void hotels()
{
    ...
    system("cls");
    printf("\n\t\t HOTELS :");
    printf("\n\n\t1. EMIRATES PALACE\t PRICE : BDT 20,000 PER DAY");
    printf("\n\n\t2. BURJ AL ARAB\t       PRICE : BDT 19,500 PER DAY");
    printf("\n\n\t3. TOWN HOUSE GALLERIA\t PRICE : BDT 17,000 PER DAY");
    printf("\n\n\t4. ROYAL MALWANE\t PRICE : BDT 20,500 PER DAY");
    printf("\n\n\t5. AMANZOE\t    PRICE : BDT 18,000 PER DAY");
    printf("\n\n\t ENTER CHOICE :  ");
    scanf("%d", &n);
    printf("\n\n\t ENTER NO OF DAYS : ");
    scanf("%d", &i.days);
    ...
    case 1:
        i.cost += i.days * 20000;
        strcpy(i.hname, "EMIRATES");
        break;
    case 2:
        i.cost += i.days * 19500;
        strcpy(i.hname, "BURJ_AL_ARAB");
        break;
    case 3:
        i.cost += i.days * 17000;
        strcpy(i.hname, "TOWN_HOUSE_GALLERIA");
        break;
    case 4:
        i.cost += i.days * 20500;
        strcpy(i.hname, "ROYAL_MALWANE");
        break;
    case 5:
        i.cost += i.days * 18000;
        strcpy(i.hname, "AMANZOE");
        break;
    }
...
void flights(int id)
{
    ...
    case 2:
        ...
        i.time = 9.00;
        strcpy(i.shift, "AM");
        strcpy(i.fname, "JET_AIRWAYS");
        break;
    case 3:
        i.cost += 55000;
        i.time = 1.00;
        strcpy(i.shift, "PM");
        strcpy(i.fname, "QATAR_AIRWAYS");
        break;
    case 4:
        i.cost += 75000;
        i.time = 5.00;
