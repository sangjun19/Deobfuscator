// Repository: serena-ivaldi/yarp_ros_bridge
// File: bridge/src/convertModule.cpp
...
{
    if(count%3600==0)
        cout << " YARP ROS BRIDGE GENERATOR alive" << endl;
    count++;
    return true;
}
...
bool ConvertModule::checkUpdate(yarp::os::ResourceFinder &rf, string &lastActualEdit)
{
    ...
    lastEditFile.open("Log/bridgelastedit.txt",fstream::in);
