...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x31B52561),  // LutBuilderHdr
    CustomShaderEntry(0x4DD5AD48),  // uberpost
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Children of the Sun";
