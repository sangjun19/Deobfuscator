// Repository: UPD-RTS/GNAT-for-PPC
// File: src/adabkend.ads
...
--  Generic package implementing the common parts of back_end.adb for
--  back ends written in Ada, thereby reducing code duplication.
with Types;
