// Repository: godunko/a0b-stm32h723
// File: source/svd/a0b-stm32h723-svd-opamp.ads
...
package A0B.STM32H723.SVD.OPAMP is
   pragma Preelaborate;
   ...
   subtype OPAMP1_CSR_PGA_GAIN_Field is A0B.Types.SVD.UInt4;
   ...
   type OPAMP1_CSR_Register is record
      ...
      --  unspecified
      Reserved_19_28 : A0B.Types.SVD.UInt10 := 16#0#;
   ...
   subtype OPAMP1_OTR_TRIMOFFSETN_Field is A0B.Types.SVD.UInt5;
   subtype OPAMP1_OTR_TRIMOFFSETP_Field is A0B.Types.SVD.UInt5;
   ...
   subtype OPAMP1_HSOTR_TRIMLPOFFSETN_Field is A0B.Types.SVD.UInt5;
   subtype OPAMP1_HSOTR_TRIMLPOFFSETP_Field is A0B.Types.SVD.UInt5;
   ...
   subtype OPAMP2_CSR_PGA_GAIN_Field is A0B.Types.SVD.UInt4;
   ...
   subtype OPAMP2_OTR_TRIMOFFSETN_Field is A0B.Types.SVD.UInt5;
   subtype OPAMP2_OTR_TRIMOFFSETP_Field is A0B.Types.SVD.UInt5;
   ...
   subtype OPAMP2_HSOTR_TRIMLPOFFSETN_Field is A0B.Types.SVD.UInt5;
   subtype OPAMP2_HSOTR_TRIMLPOFFSETP_Field is A0B.Types.SVD.UInt5;
