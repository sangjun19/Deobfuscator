...
Name : Munawir E
Date : 10/08/2022
Description : Implement SLL for the following:

	1.insert_at_first(&head, ndata)
	2.insert_after(head, gdata, ndata)
    3.insert_before(head, gdata, ndata)
    4.insert_Nth(head, ndata, n)
    5.delete_element(head, gdata)
    6.print_list(head)
*/
