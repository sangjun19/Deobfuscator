// Repository: madgraph5/madgraph4gpu
// File: epochX/kokkos/gg_ttg.mad/SubProcesses/P1_gg_ttxg/auto_dsig.f
...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g g > t t~ g WEIGHTED<=3 @1
C     
...
C     and update the couplings accordingly
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g g > t t~ g
C     ENDIF
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT)  ! g g > t t~ g
C     ENDIF
