...
C Initial call to F.  (LF0 points to YH(*,2).) -------------------------
      LF0 = LYH + NYH
      CALL F (NEQ, T, Y, RWORK(LF0), ff, ae, Ah, An, Nn, hr, bv)
      NFE = 1
...
C      CALL XERRWD (MSG, 50, 101, 0, 0, 0, 0, 0, 0.0D0, 0.0D0)
...
*DECK DSTODA
     ...
     1   WM, IWM, F, JAC, PJAC, SLVS, ff, ae, Ah, An, Nn, hr, bv)
