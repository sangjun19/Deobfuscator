// Repository: wavewave/pythia-pgs.iwkim
// File: src/pythia.f
...
C   Local variables
      ...
      CHARACTER*30 CGIVE0
      CHARACTER*250 pythia_card,output_file,input_file
