// Repository: teuben/nemo
// File: src/nbody/evolve/aarseth/nbody4/delay.f
...
*       Copy relevant indices for delayed KS termination.
          ...
          JCOMP = JC0
          JCLOSE = JCL0
*      Initialize KSAVE membership but preserve during chain regularization.
          IF (NCH.EQ.0) THEN
              KSAVE(1) = 0
              KSAVE(3) = 0
          END IF
...
*       Specify JCOMP < 0 to prevent spurious prediction second KSTERM call.
          ...
          END IF
*
*       Save KSTAR and sum of component names (for chain termination).
      IF (KCHAIN.GT.0) THEN
