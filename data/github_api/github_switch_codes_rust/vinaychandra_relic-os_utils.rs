// Repository: vinaychandra/relic-os
// File: crates/supervisor/kernel/src/arch/x86_64/paging/utils.rs

use crate::addr::{PAddr, VAddr};

/// Contains page-table root pointer.
#[inline]
pub unsafe fn cr3() -> PAddr {
    let ret: u64;
...
/// level is not 0.
#[inline]
pub fn flush(vaddr: VAddr) {
    unsafe { asm!("invlpg [{0}]", in(reg) vaddr.into(): u64, options(nostack)) }
}
