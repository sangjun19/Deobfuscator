// Repository: mundisnetwork/axis
// File: programs/vote/src/vote_instruction.rs
...
use {
    ...
    mundis_metrics::inc_new_counter_info,
...
/// as `mundis_sdk::keyed_account::from_keyed_account` despite dynamically
...
mod tests {
    ...
    fn process_instruction_as_one_arg(instruction: &Instruction) -> Result<(), InstructionError> {
        ...
        mundis_program_runtime::invoke_context::mock_process_instruction_with_sysvars(
            &id(),
            Vec::new(),
            &instruction.data,
            &keyed_accounts,
