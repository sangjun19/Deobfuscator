// Repository: ryanmrestivo/windows-tools-portable
// File: Security-&-Network/hashcat-6.2.4-portable/OpenCL/m24300_a3-optimized.cl
...
DECLSPEC void m24300m (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC (), LOCAL_AS u32 *l_bin2asc)
{
  /**
   * modifier
   */
  ...
  w0[ 0] |= hc_swap32_S (salt_buf0_t[0]);
  w0[ 1] |= hc_swap32_S (salt_buf0_t[1]);
  w0[ 2] |= hc_swap32_S (salt_buf0_t[2]);
  w0[ 3] |= hc_swap32_S (salt_buf0_t[3]);
  w1[ 0] |= hc_swap32_S (salt_buf1_t[0]);
  w1[ 1] |= hc_swap32_S (salt_buf1_t[1]);
  w1[ 2] |= hc_swap32_S (salt_buf1_t[2]);
  w1[ 3] |= hc_swap32_S (salt_buf1_t[3]);
  w2[ 0] |= hc_swap32_S (salt_buf2_t[0]);
  w2[ 1] |= hc_swap32_S (salt_buf2_t[1]);
  w2[ 2] |= hc_swap32_S (salt_buf2_t[2]);
  w2[ 3] |= hc_swap32_S (salt_buf2_t[3]);
  w3[ 0] |= hc_swap32_S (salt_buf3_t[0]);
  w3[ 1] |= hc_swap32_S (salt_buf3_t[1]);
  w3[ 2] |= hc_swap32_S (salt_buf3_t[2]);
  w3[ 3] |= hc_swap32_S (salt_buf3_t[3]);
...
DECLSPEC void m24300s (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC (), LOCAL_AS u32 *l_bin2asc)
{
  /**
   * modifier
   */
