...
// File: data/dev_mapping_task/c/https-api-github-com-repos-Rich5-oclHashcat-git-blobs-9094a962afa68e90a658a41575e2c53aaf6c5ad0.cl
...
__constant u32 Ga[8] = {0x5e4ebf28, 0x418a754e, 0x564e0064, 0x0801faff, 0xb6002e2e, 0x803e68d0, 0xfea90c2f, 0x7a695364};
...
u8 EA(__local RC4_KEY* a, u8 b, u8 c, __constant u32* d, u32 e[4]) {
  for (u32 f = 0; f < 4; f++) {
    u32 g = 0;
...
void EB(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
for (u32 ar = 0; ar < ab; ar += 1) {
  ...
  {
    if (((bc[0]) == aq[0]) && ((bc[1]) == aq[1]) && ((bc[2]) == aq[2]) && ((bc[3]) == aq[3])) {
      const u32 bd = ad + 0;
