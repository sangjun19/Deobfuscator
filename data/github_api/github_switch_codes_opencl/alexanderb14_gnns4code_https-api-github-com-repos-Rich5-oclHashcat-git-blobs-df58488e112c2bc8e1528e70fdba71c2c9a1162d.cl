...
// File: data/dev_mapping_task/c/https-api-github-com-repos-Rich5-oclHashcat-git-blobs-df58488e112c2bc8e1528e70fdba71c2c9a1162d.cl
...
u8 BZ(__local RC4_KEY* a, u8 b, u8 c, __constant u32* d, u32 e[4]) {
  for (u32 f = 0; f < 4; f++) {
    u32 g = 0;
...
for (u32 ar = 0; ar < ab; ar += 1) {
  ...
  {
    if (((bl[0]) == aq[0]) && ((bl[1]) == aq[1]) && ((bl[2]) == aq[2]) && ((bl[3]) == aq[3])) {
      const u32 bm = ad + 0;
