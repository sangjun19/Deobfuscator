// Repository: alexanderb14/gnns4code
// File: data/dev_mapping_task/c/https-api-github-com-repos-Rich5-oclHashcat-git-blobs-dd57cce3245992a30eff0633095c3cf8a190d8a7.cl
...
int CA(__local RC4_KEY* a, u32 b[4], u32 c[8]) {
  BY(a, b);
  ...
  if ((d[3] & 0xffff0000) != 0x30320000)
    return 0;

  e = BZ(a, 16, e, c + 4, d);

  if (((d[0] & 0xff) < '0') || ((d[0] & 0xff) > '9'))
    return 0;
  d[0] >>= 8;
  if (((d[0] & 0xff) < '0') || ((d[0] & 0xff) > '9'))
    return 0;
...
void CB(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
void CC(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
void CD(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4]) {
  a[0] = a[0] ^ 0x36363636;
  a[1] = a[1] ^ 0x36363636;
  a[2] = a[2] ^ 0x36363636;
  a[3] = a[3] ^ 0x36363636;
...
void CE(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4], u32 g[4]) {
  g[0] = e[0];
  g[1] = e[1];
  g[2] = e[2];
  g[3] = e[3];
...
void CF(const u32 a[4], const u32 b[4], const u32 c, const u32 d[4], u32 e[4]) {
  u32 f[4];
  u32 g[4];
  u32 h[4];
  u32 i[4];
...
void CG(__local RC4_KEY* a, u32 b[4], u32 c[4], u32 d[4], u32 e[4], const u32 f, __global pw_t* g, __global kernel_rule_t* h, __global comb_t* i, __global bf_t* j, __global void* k, __global void* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global u32* q, __global u32* r, __global u32* s, __global u32* t, __global plain_t* u, __global digest_t* v, __global u32* w, __global salt_t* x, __global krb5pa_t* y, __global u32* z, __global u32* aa, const u32 ab, const u32 ac,
        const u32 ad, const u32 ae, const u32 af, const u32 ag, const u32 ah, const u32 ai, const u32 aj) {
  const u32 ak = get_global_id(0);
  const u32 al = get_local_id(0);

  u32 am[4];

  am[0] = y[ae].checksum[0];
  am[1] = y[ae].checksum[1];
  am[2] = y[ae].checksum[2];
  am[3] = y[ae].checksum[3];

  u32 an[8];

  an[0] = y[ae].timestamp[0];
  an[1] = y[ae].timestamp[1];
  an[2] = y[ae].timestamp[2];
  an[3] = y[ae].timestamp[3];
  an[4] = y[ae].timestamp[4];
  an[5] = y[ae].timestamp[5];
  an[6] = y[ae].timestamp[6];
  an[7] = y[ae].timestamp[7];

  u32 ao = b[0];

  for (u32 ap = 0; ap < ah; ap += 1) {
    const u32x aq = BU(j, ap);
...
__kernel void CH(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5pa_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  const u32 am = a[ag].pw_len;

  __local RC4_KEY an[64];

  CG(an, ai, aj, ak, al, am, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad);
}
...
__kernel void CM(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5pa_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
}