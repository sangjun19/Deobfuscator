...
// File: data/dev_mapping_task/c/https-api-github-com-repos-Rich5-oclHashcat-git-blobs-91546bba310eccaaf389e52d2d8ac64b27fe1a5b.cl
...
void BY(u32x a[4], u32x b[4], __local u32* c) {
  u32x d = b[3] >> 24;
...
void CA(u32x a[4], u32x b[4], __local u32* c) {
  u32x d[12];
...
void CB(u32x a[4], u32x b[4], u32x c[4], __local u32* d) {
  CA(a, c, d);

  BY(c, b, d);
}

void CC(const u32x a[4], const u32 b, u32x c[4], __local u32* d) {
  u32x e[4];
...
__kernel void CD(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 ao = 0; ao < ab; ao += 1) {
    ...
    {
      const u32 bb[4] = {ba, ba, ba, ba};
      if (Z(bb, g, h, i, j, k, l, m, n, v, w, x)) {
        int bc = X(bb, ac, &p[ad]);
        if (bc != -1) {
          const u32 bd = ad + bc;
          if (atomic_add(&q[bd], 1) == 0) {
            AA(o, t, y, bc, bd, ag, ao);
          }
        }
      }
    };
...
for (u32 ap = 0; ap < ab; ap += 1) {
  ...
  {
    if (((bb[0]) == ao[0]) && ((bb[1]) == ao[1]) && ((bb[2]) == ao[2]) && ((bb[3]) == ao[3])) {
      const u32 bc = ad + 0;
