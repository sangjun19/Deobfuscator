// Repository: sonofmom/ton_mining_framework
// File: Libraries/mining/opencl/includes/inc_hash_sha256_debug.cl
...
DECLSPEC void sha256_update_64 (sha256_ctx_t *ctx, u32 *w0, u32 *w1, u32 *w2, u32 *w3, const int len)
{
  ...
  printf("END OF sha256_update_64\n");
  printf("---------------------\n");
}
