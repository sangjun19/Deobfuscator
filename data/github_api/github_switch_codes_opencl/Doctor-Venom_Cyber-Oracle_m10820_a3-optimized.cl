// Repository: Doctor-Venom/Cyber-Oracle
// File: source_code/central_monitor/static/app_utilities/hashcat/OpenCL/m10820_a3-optimized.cl
...
DECLSPEC void m10820m (u32 *w, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
...
DECLSPEC void m10820s (u32 *w, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
