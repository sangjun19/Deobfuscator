// Repository: KhronosGroup/OpenCL-CTS-Kernel-Dumps
// File: test_conformance/device_execution/test_device_execution/enqueue_mix_wg_size_.946914b7.b467a359.cl
...
void block_fn(int level, int maxGlobalWorkSize, __global int* rnd, __global int* res)
{
  ...
  if(tidX == 0 && (tidY == 0 || get_global_size(1) == 1) && (tidZ == 0 || get_global_size(2) == 1))
  {
...
kernel void enqueue_mix_wg_size_single(__global int* res, int level, int maxGlobalWorkSize, __global int* rnd)
{
