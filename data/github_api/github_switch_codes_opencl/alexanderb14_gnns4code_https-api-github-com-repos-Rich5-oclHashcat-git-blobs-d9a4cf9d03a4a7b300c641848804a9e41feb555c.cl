...
// File: data/dev_mapping_task/c/https-api-github-com-repos-Rich5-oclHashcat-git-blobs-d9a4cf9d03a4a7b300c641848804a9e41feb555c.cl
...
void CA(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
void CB(__local RC4_KEY* a, u32 b[4], u32 c[4], u32 d[4], u32 e[4], const u32 f, __global pw_t* g, __global kernel_rule_t* h, __global comb_t* i, __global bf_t* j, __global void* k, __global void* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global u32* q, __global u32* r, __global u32* s, __global u32* t, __global plain_t* u, __global digest_t* v, __global u32* w, __global salt_t* x, __global oldoffice01_t* y, __global u32* z, __global u32* aa, const u32 ab,
        const u32 ac, const u32 ad, const u32 ae, const u32 af, const u32 ag, const u32 ah, const u32 ai, const u32 aj) {
  const u32 ak = get_global_id(0);
  const u32 al = get_local_id(0);

  __local RC4_KEY* am = &a[al];

  u32 an[4];

  an[0] = x[ae].salt_buf[0];
  an[1] = x[ae].salt_buf[1];
  an[2] = x[ae].salt_buf[2];
  an[3] = x[ae].salt_buf[3];
  ...
  ap[0] = an[0] << 16;
  ap[1] = an[0] >> 16 | an[1] << 16;
  ap[2] = an[1] >> 16 | an[2] << 16;
  ap[3] = an[2] >> 16 | an[3] << 16;
  ap[4] = an[3] >> 16;
  ...
  const u32 as = y[ae].version;

  u32 at[4];

  at[0] = y[ae].encryptedVerifier[0];
  at[1] = y[ae].encryptedVerifier[1];
  at[2] = y[ae].encryptedVerifier[2];
  at[3] = y[ae].encryptedVerifier[3];

  u32 au = b[0];

  for (u32 av = 0; av < ah; av += 1) {
    const u32 aw = BU(j, av);
    ...
    { const u32 bj[4] = { bh0], bh1], bh2], bh3] };
      if (Z(bj, m, n, o, p, q, r, s, t, ab, ac, ad)) {
        int bk = X(bj, ai, &v[aj]);
        if (bk != -1) {
          const u32 bl = aj + bk;
          if (atomic_add(&w[bl], 1) == 0) {
            AA(u, z, ae, bk, bl, ak, av);
          }
        }
      }
    };
...
void CC(__local RC4_KEY* a, u32 b[4], u32 c[4], u32 d[4], u32 e[4], const u32 f, __global pw_t* g, __global kernel_rule_t* h, __global comb_t* i, __global bf_t* j, __global void* k, __global void* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global u32* q, __global u32* r, __global u32* s, __global u32* t, __global plain_t* u, __global digest_t* v, __global u32* w, __global salt_t* x, __global oldoffice01_t* y, __global u32* z, __global u32* aa, const u32 ab,
        const u32 ac, const u32 ad, const u32 ae, const u32 af, const u32 ag, const u32 ah, const u32 ai, const u32 aj) {
  const u32 ak = get_global_id(0);
  const u32 al = get_local_id(0);
...
for (u32 aw = 0; aw < ah; aw += 1) {
  const u32 ax = BU(j, aw);
  ...
  {
    if (((bi[0]) == au[0]) && ((bi[1]) == au[1]) && ((bi[2]) == au[2]) && ((bi[3]) == au[3])) {
      const u32 bk = aj + 0;
      if (atomic_add(&w[bk], 1) == 0) {
        AA(u, z, ae, 0, bk, ak, aw);
      }
    }
  };
}
...
__kernel void CD(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global oldoffice01_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  __local RC4_KEY am[64];

  CB(am, ah, ai, aj, ak, al, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad);
}
...
__kernel void CG(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global oldoffice01_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  CC(am, ah, ai, aj, ak, al, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad);
}
